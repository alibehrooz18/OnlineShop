                        ...
                        <div class="bg-white rounded10 shadow-lg">
                            ...
                            <div class="p-40">
                                <form action="index.html" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-info mt-10" style="direction:rtl;">ورود</button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                </form>
                                ...
                                <div class="text-center">
                                    <p class="mt-20">- یا -</p>
                                    <p class="mb-5" style="direction:rtl;">رمز عبور خود را برای بازیابی جلسه خود وارد کنید</p>
                                </div>
