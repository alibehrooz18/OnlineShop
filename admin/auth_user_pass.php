...
<head>
    ...
    <title>CRMi - بازیابی رمز عبور</title>
                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="bg-white rounded10 shadow-lg">
                            <div class="content-top-agile p-20 pb-0">
                                <h3 class="mb-0 text-primary">بازیابی رمز عبور</h3>
                            </div>
                            <div class="p-40">
                                <form action="index.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-info margin-top-10" style="direction:rtl;">بازیابی</button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                </form>
