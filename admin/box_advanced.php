            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">باکس های پیشرفته</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">باکس کارد</li>
                                        <li class="breadcrumb-item active" aria-current="page">باکس کاردهای پیشرفته</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس با نوار پیشرفته</h4>
                                ...
                                <div class="box-body">
                                    <p>توضیحات لازم رابرای باکس در در این قسمت برای کاربران قرار دهید .</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">باکس سوئیچ</h4>
                                    <div class="box-controls pull-right">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس با جستجو</h4>
                                    <div class="box-controls pull-right">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box box-slided-up">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس <strong>اسلایدری</strong></h4>
                                ...
                                <div class="box-body">
                                    <div class="callout callout-warning mb-0" role="alert">
                                        فقط این کلاس را به باکس اضافه کنید <code>.box-body</code>.
                                    </div>
                                    <div class="box-body">
                                        <p>توضیحات لازم را برای نمایش به کاربرانتان در این قسمت قرار دهید.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-12">
                            <div class="box box-solid box-inverse box-info">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس <strong> با امکانات</strong></h4>
                                    <ul class="box-controls pull-right">
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#"><i class="ti-more-alt rotate-90 text-white"></i></a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#"><i class="ti-import"></i> ایمپورد</a>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">باکس با دکمه</h4>
                                    <div class="box-controls pull-right">
                                        <button class="btn btn-xs btn-info">کلیک کنید</button>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس با صفحه بندی</h4>
                                    <div class="box-controls pull-right">
                                        <nav>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">چند بخشی</h4>
                                    <div class="box-controls pull-right">
                                        <div class="box-header-actions">
                                            ...
                                            <button class="btn btn-xs btn-primary">دکمه</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">قابل اسکرول</h4>
                                </div>

                                <div class="box-body">
                                    <div class="inner-content-div">
                                        <p>کارت با متن <code>.box-body .inner-content-div</code> و انداز مشخص 200px.</p>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">با <strong>هشدار</strong></h4>
                                </div>

                                <div class="box-body">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        <strong>کارت اعلان</strong><br> شما درخواست را باموفقیت ارسال کردید بزودی بررسی می شود
                                    </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">با<strong>جدول</strong></h4>
                                </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس <strong>کنترل </strong></h4>
                                    <ul class="box-controls pull-right">
                                        <li><a class="box-btn-close" href="#"></a></li>
                                        <li><a class="box-btn-slide" href="#"></a></li>
                                        <li><a class="box-btn-fullscreen" href="#"></a></li>
                                ...
                                <div class="box-body">
                                    <div class="callout callout-warning mb-0" role="alert">
                                        این کلاس را به کارد اضافه کنید <code>.box-body</code>.
                                    </div>
                                    <div class="box-body">
                                        <p>توضیحات لازم را برای نمایش به کاربرانتان در این قسمت قرار دهید.</p>
                                    </div>
