            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">باکس ساده</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">باکس ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">باکس ساده</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <p>باکس ساده بدون هدر</p>
                                    <p>طراحان سایت هنگام طراحی قالب سایت م عمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست. در نتیجه طرح کلی دید درستی به کار فرما نمیدهد. .</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">عنوان باکس</h4>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">هدر<strong>عنوان باکس</strong></h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header without-border">
                                    <h4 class="box-title">هدر باکس بدون<strong> جداساز</strong></h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title box-title-bold">عنوان بولد</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">زیر عنوان و<strong>عنوان</strong> <small class="subtitle">توضیحات بیشتر</small></h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box box-bordered border-primary">
                                <div class="box-header with-border">
                                    <h4 class="box-title"><strong>باکس </strong> نواری</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box box-shadowed">
                                <div class="box-header with-border">
                                    <h4 class="box-title"><strong>باکس</strong> شادو</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box box-hover-shadow no-shadow">
                                <div class="box-header with-border">
                                    <h4 class="box-title"><strong>در هاور</strong>باکس شادو</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box box-transparent no-shadow">
                                <div class="box-header with-border">
                                    <h4 class="box-title"><strong>باکس</strong> بدون استایل</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">باکس <strong>فوتر</strong></h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                ...
                                <div class="box-footer flexbox">
                                    ...
                                    <label for="basic_checkbox_1">ذخیره</label>
