            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">کارد کاربر</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کارد</li>
                                        <li class="breadcrumb-item active" aria-current="page">کارد کاربران</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">استایل کارد</h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">عنوان کارد</h4>
                                    <p class="card-text">توضیحات لازم در این قسمت ذکر شود.</p>
                                </div>
                                <div class="card-footer justify-content-between d-flex">
                                    <span class="text-muted">اخرین بازدید 3 دقیقه پیش</span>
                                    <span>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    <span class="fs-14 text-muted">12 بهمن ماه</span>
                                    <span class="fs-14  text-muted"> 12 روز</span>
                                </div>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-between align-items-center">
                                    <div class="text-muted"><i class="fa fa-spinner me-2"></i> در حال پردازش...</div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">هدر زیرین کارد</h4>
                                    <div class="header-elements">
                                        <span class="badge bg-danger badge-pill">پرداخت شده</span>
                                    </div>
                                </div>
                                <img class="card-img-top bter-0 btsr-0" src="images\gallery\landscape12.jpg" alt="Card image cap">
                                ...
                                <div class="card-footer">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="کامنت بنویسید...">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <span><i class="fa fa-user me-2"></i> <a href="#">مختار مینائی</a></span>
                                    <span class="text-muted">4 دقیق پیش</span>
                                </div>
                                <img class="card-img-top bter-0 btsr-0" src="images\gallery\landscape12.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title">چند عنوان</h4>
                                    <p class="card-text">توضیحات لازم در این قسمت ذکر شود.</p>
                                </div>
                                <div class="card-footer justify-content-between d-flex">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-footer d-flex justify-content-between bt-0 pb-0">
                                    <span class="text-muted">412548 فالور</span>
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">چند فوتر</h4>
                                    <p class="card-text">توضیحات لازم در این قسمت ذکر شود.</p>
                                </div>
                                <div class="card-footer d-flex justify-content-between">
                                    <a href="#" class="text-default"><i class="fa fa-commenting-o"></i> کامنت</a>
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card bg-dark text-white">
                                <img class="card-img" src="images\gallery\thumb\10.jpg" alt="Card image">
                                <div class="card-img-overlay">
                                    <h4 class="card-title">عنوان کارد</h4>
                                    <p class="card-text">توضیحات لازم در این قسمت ذکر شود.</p>
                                    <p class="card-text">اخرین بازدید 3 دقیقه پیش</p>
                                </div>
                            </div>
                        </div>
                        <!-- /.col -->
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <strong>
                                        <p>توضیحات تست</p>
                                        <footer class="blockquote-footer">بعضی افراد مشهور <p title="منبع">منبع</p>
                                        </footer>
                                        <p>اگر شما یک طراح هستین و یا با طراحی های گرافیکی سروکا ر دارید به متن های برخورده اید که با نام لورم ایپسوم شناخته می‌شو
                                            ند. لورم ایپسوم یا طرح‌ن ما (به انگلیسی: Lorem ipsum) متنی ساختگی و بدون معنی است که برای امتحان فونت و یا پر کردن ضا در یک طراحی گرافیکی و
                                            یا صنعت چاپ استفاده میشود. طراحان وب و گرافیک از این متن برای پرکردن صفحه و ارائه شکل کلی طرح استفاده می‌کنند.
                                        </p>
                                        <p>اگر شما یک طراح هستین و یا با طراحی های گرافیکی سروکا ر دارید به متن های برخورده اید که با نام لورم ایپسوم شناخته می‌شو
                                            ند. لورم ایپسوم یا طرح‌ن ما (به انگلیسی: Lorem ipsum) متنی ساختگی و بدون معنی است که برای امتحان فونت و یا پر کردن ضا در یک طراحی گرافیکی و
                                            یا صنعت چاپ استفاده میشود. طراحان وب و گرافیک از این متن برای پرکردن صفحه و ارائه شکل کلی طرح استفاده می‌کنند.
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">عنوان کارد</h4>
                                    <p class="card-text">توضیحات تست در این قسمت.</p>
                                    <p>اگر شما یک طراح هستین و یا با طراحی های گرافیکی سروکا ر دارید به متن های برخورده اید که با نام لورم ایپسوم شناخته می‌شو
                                        ند. لورم ایپسوم یا طرح‌ن ما (به انگلیسی: Lorem ipsum) متنی ساختگی و بدون معنی است که برای امتحان فونت و یا پر کردن ضا در یک طراحی گرافیکی و
                                        یا صنعت چاپ استفاده میشود. طراحان وب و گرافیک از این متن برای پرکردن صفحه و ارائه شکل کلی طرح استفاده می‌کنند.
                                    </p>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">مختار مینائی</li>
                                    <li class="list-group-item">رامین محمدی</li>
                                    <li class="list-group-item">سعدی همتی</li>
                                    <li class="list-group-item">امید ناصری</li>
                                    <li class="list-group-item">کامیاب رحیمی</li>
                                    <li class="list-group-item">مختار مینائی</li>
                                    <li class="list-group-item">رامین محمدی</li>
                                    <li class="list-group-item">سعدی همتی</li>
                                    <li class="list-group-item">امید ناصری</li>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <img class="card-img-top" src="images\gallery\thumb-sm\1.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title">عنوان کارد</h4>
                                    <p class="card-text">متن تست برای توضیحات.</p>
                                ...
                                <div class="card-body">
                                    <a href="#" class="card-link">لینک کارد</a><br>
                                    <a href="#" class="card-link">سایر لینک ها</a>
                                </div>
                            </div>
                            <!-- /.card -->
                        </div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">عنوان ویژه</h4>
                                    <p class="card-text">توضیحات تستی ایجاد شده است.</p>
                                    <a href="#" class="btn btn-primary">ادامه ...</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row fx-element-overlay">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">افکت</h4>
                                    <h6 class="card-subtitle">از این حالت پیشفرض استفاده کنید<code>fx-overlay</code></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="fx-card-item">
                                    ...
                                    <div class="fx-card-content">
                                        <h3 class="box-title">مختار مینائی</h3> <small>فول استک دولوپر</small>
                                        <br>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row fx-element-overlay">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">اسکرول</h4>
                                    <h6 class="card-subtitle">از این حالت پیشفرض استفاده کنید <code>fx-overlay scrl-dwn</code></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-4">
                    ...
                    <div class="row fx-element-overlay">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">اسکرول</h4>
                                    <h6 class="card-subtitle">از حالت پیشفرض استفاده کنید <code>fx-overlay scrl-up</code></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-4">
