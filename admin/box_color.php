            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title"> باکس رنگی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page"> باکس کارد</li>
                                        <li class="breadcrumb-item active" aria-current="page">رنگی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4>رنگ پس زمینه</h4>
                                    <p>هر باکس میتواند داشته باشد <code>.box-*</code> یک کلاس <b>*</b>داشته باشد <a href="ui/general.html" target="_blank">نام رنگ</a>. با ایجاد یک متن رنگی <code>.box-inverse</code> در باکس <em>.box</em> tag.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="box box-inverse box-primary">
                                ...
                                <div class="box-body">
                                    <p>کافیه این کلاس را به باکس مورد نظرتون اضافه کنید </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="box box-inverse box-secondary">
                                ...
                                <div class="box-body">
                                    کافیه این کلاس را به باکس مورد نظرتون اضافه کنید
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4>هدر رنگی </h4>
                                    <p>هر باکسی را با این <code>.box-solid .bg-*</code> کلاس <b>*</b> رنگی کنید </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4>باکس توخالی</h4>
                                    <p>هر باکس را با این <code>.box-outline-*</code> کلاس <b>*</b> بی رنگ نشان دهید</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4>باکس های نواری</h4>
                                    <p>شما می توانید حاشیه هایی را به هر طرف جعبه اضافه کنید. در برخی موارد، ممکن است بخواهید یک حاشیه 3 پیکسلی در یک طرف جعبه داشته باشید.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box bs-3 border-primary">
                                <div class="box-header">
                                    <h4 class="box-title"> نوار<strong> راست</strong></h4>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="box bt-3 border-info">
                                <div class="box-header">
                                    <h4 class="box-title">نوار <strong> بالا</strong></h4>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="box bb-3 border-warning">
                                <div class="box-header">
                                    <h4 class="box-title">نوار <strong> پائین</strong></h4>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="box be-3 border-danger">
                                <div class="box-header">
                                    <h4 class="box-title">نوار <strong> چپ</strong></h4>
                                </div>
