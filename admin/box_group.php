            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">باکس گروه</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کارت های باکس</li>
                                        <li class="breadcrumb-item active" aria-current="page">باکس گروه</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">کارت های شبکه</h4>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row row-cols-1 row-cols-lg-3 g-4">
                                <div class="col">
                                    <div class="card h-p100">
                                        <img class="card-img-top" src="images\gallery\thumb\4.jpg" alt="card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                            <p>این یک کارت طولانی‌تر با متن پشتیبان در زیر به‌عنوان ورودی طبیعی به محتوای اضافی است. این محتوا کمی طولانی تر است.</p>
                                        </div>
                                        <div class="card-footer justify-content-between d-flex">
                                            <span class="text-muted">آخرین به روز رسانی ۳ دقیقه قبل</span>
                                            <span>
                                                ...
                                                <span class="text-muted ms-2">(۷۳)</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card h-p100">
                                        <img class="card-img-top" src="images\gallery\thumb\5.jpg" alt="card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                            <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                        </div>
                                        <div class="card-footer justify-content-between d-flex">
                                            <span class="text-muted">آخرین به روز رسانی ۳ دقیقه قبل</span>
                                            <span>
                                ...
                                <div class="col">
                                    <div class="card h-p100">
                                        <img class="card-img-top" src="images\gallery\thumb\6.jpg" alt="card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                            <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">گروه
                                        <span class="subtitle fs-14 mb-0">از گروه های کارت برای رندر کردن کارت ها به عنوان یک عنصر منفرد و متصل با ستون های عرض و ارتفاع یکسان استفاده کنید.</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card-group">
                                <div class="card">
                                    <img class="card-img-top" src="images\gallery\thumb\1.jpg" alt="card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                        <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                    </div>
                                ...
                                <div class="card">
                                    <img class="card-img-top" src="images\gallery\thumb\2.jpg" alt="card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                        <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                    </div>
                                ...
                                <div class="card">
                                    <img class="card-img-top" src="images\gallery\thumb\3.jpg" alt="card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title b-0 px-0">عنوان کارد</h4>
                                        <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">ستون ها
                                        <span class="subtitle fs-14 mb-0">کارت‌ها را می‌توان در ستون‌های ماسونی‌مانند فقط با CSS با قرار دادن آن‌ها در آن سازمان‌دهی کرد <code>.card-columns</code>. کارت ها از بالا به پایین و از چپ به راست هنگام بسته بندی مرتب می شوند<code>.card-columns</code>.</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card-columns">
                                <div class="card">
                                    <img class="card-img-top" src="images\gallery\thumb\7.jpg" alt="card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title b-0 px-0">عنوان کارت که به یک خط جدید می‌پیچد، اما نه در صفحه‌های بزرگ</h4>
                                        <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                    </div>
                                    <div class="card-footer justify-content-between d-flex">
                                        <span class="text-muted">آخرین به روز رسانی ۳ دقیقه قبل</span>
                                ...
                                <div class="card card-body">
                                    <blockquote class="card-bodyquote">
                                        ...
                                        <footer class="text-muted">
                                            یک نفر معروف در<cite title="Source Title">عنوان منبع</cite>
                                        </footer>
                                    </blockquote>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <img class="card-img" src="images\gallery\thumb\8.jpg" alt="card image cap">
                                    <div class="card-footer d-flex justify-content-between">
                                        <span class="fs-14 text-muted">12 بهمن 1402</span>
                                        <span class="fs-14  text-muted">سررسید ۱۲ روزه</span>
                                    </div>
                                </div>
                                ...
                                <div class="card card-body card-inverse card-primary text-center">
                                    <blockquote class="card-bodyquote">
                                        ...
                                        <footer>
                                            <small>
                                                یک نفر معروف در <cite title="منبع">عنوان منبع</cite>
                                            </small>
                                        </footer>
                                    </blockquote>
                                </div>
                                ...
                                <div class="card">
                                    <img class="card-img" src="images\gallery\thumb\9.jpg" alt="card image">
                                    <div class="card-footer">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="نظرتان را بنویسید...">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title b-0 px-0 pt-0">عنوان کارد</h4>
                                        <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش</p>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between">
                                        <a href="#" class="text-default"><i class="fa fa-commenting-o"></i> کامنت</a>
                                        <span class="text-muted"><i class="fa fa-eye"></i>۶۷۳</span>
                                    </div>
                                </div>
                            </div>
                        </div>
