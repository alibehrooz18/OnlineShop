            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">C3 نمودار محوری</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">C3 نمودار محوری</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">X نمودار منطقه زمانی محور</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار محور چرخشی</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار محوری دسته</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">X نمودار حذف کنه محور</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">X نمودار برازش تیک محور</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">Y نمودار محوری</h4>
                                </div>
                                <div class="box-body">
                                    <div id="y-axis"></div>
                                </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">محدوده برای نمودار محور Y</h4>
                                </div>
                                <div class="box-body">
