...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نمودار میله‌ای و پایی C3</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">نمودار میله‌ای و پایی C3</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار ستونی</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار دایره ای</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار ستونی انباشته</h4>
                                </div>
                                <div class="box-body">
    ...
    <script src="src\js\pages\c3-bar-pie.js"></script>
