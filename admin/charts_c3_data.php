...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">C3 دیتا چارت</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">C3 دیتا چارت</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار داده محور ستون ها</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار داده های دسته</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">دیتا چارت رنگی</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">دیتا چارت سفارشات</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-8 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار داده های ردیف گرا</h4>
                                </div>
                                <div class="box-body">
    ...
    <script src="src\js\pages\c3-data.js"></script>
    <!-- CRMi App -->
