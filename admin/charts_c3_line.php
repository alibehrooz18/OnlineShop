...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\c3\c3.min.css">
    <!-- Style-->
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">C3 نمودار خطی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودار ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">C3 نمودار خطی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="callout bg-info">
                                <h4>توجه!</h4>
                                <span class="badge badge-lg badge-danger text-wrap text-start">برای اطلاعات بیشتر لطفاً به رسمی پلاگین مراجعه کنید <a class="m-link" href="https://c3js.org/" target="_blank">demos &amp; documentation</a></span>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار ناحیه ای</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار اس پی لاین</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار منطقه خطی</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار مرحله ای</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار خطی XY ساده</h4>
                                </div>
                                <div class="box-body">
    ...
    <script src="src\js\pages\c3-line.js"></script>
    <script src="src\js\pages\c3-stap-line.js"></script>
    <script src="src\js\pages\c3-multi-xy-line.js"></script>
