...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">چارتیست</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">چارتیست</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="callout bg-info">
                        <h4>توجه!</h4>
                        <p>Chartist.js محصول جامعه ای است که از توانایی های ارائه شده توسط سایر کتابخانه های نمودار ناامید شده است..</p>
                        <span class="badge badge-lg badge-success">برای اطلاعات بیشتر لطفاً به رسمی پلاگین مراجعه کنید <a class="m-link" href="https://gionkunz.github.io/chartist-js/" target="_blank">demos &amp; documentation</a></span>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">انیمیشن های پیشرفته SMIL</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">انیمیشن مسیر SVG</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">متحرک سازی یک دونات با Svg.animate</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار سنج</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار خطی دوقطبی فقط با مساحت</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار خطی با مساحت</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار میله ای دوقطبی</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار میله ای انباشته</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار میله ای افقی</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">پیکربندی پاسخگوی شدید</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار خطی ساده</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودارحفره ای</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار حفره ای پرشده</h4>
                                </div>
                                <div class="box-body">
                                    <div class="chart">
    ...
    <script src="src\js\pages\widget-chartist.js"></script>
    <!-- CRMi App -->
