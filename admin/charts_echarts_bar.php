...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نوار الکترونیکی نمودار</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">نوار الکترونیکی نمودار</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="callout bg-info">
                                <h4>توجه!</h4>
                                <span class="badge badge-lg badge-danger text-wrap text-start">برای اطلاعات بیشتر لطفاً به رسمی پلاگین مراجعه کنید <a class="m-link" href="https://ecomfe.github.io/echarts-examples/public/index.html" target="_blank">demos &amp; documentation</a></span>
                            </div>
                        </div>
                        <div class="col-xl-6 col-12">
                            <div class="box">
                                <div class="box-body analytics-info">
                                    <h4 class="box-title">نمودار پایه میله ای</h4>
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="box">
                                <div class="box-body analytics-info">
                                    <h4 class="box-title">نمودار میله ای پایه</h4>
    ...
    <script src="src\js\pages\echart-bar.js"></script>
