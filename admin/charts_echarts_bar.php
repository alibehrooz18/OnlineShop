                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="callout bg-info">
                                <h4>توجه!</h4>
                                <span class="badge badge-lg badge-danger text-wrap text-start">برای اطلاعات بیشتر لطفاً به رسمی پلاگین مراجعه کنید <a class="m-link" href="https://ecomfe.github.io/echarts-examples/public/index.php" target="_blank">demos &amp; documentation</a></span>
                            </div>
                        </div>
