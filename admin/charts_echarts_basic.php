...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\highcharts\css\highcharts.css">
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">eChart ساده</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">eChart ساده</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
    ...
    <script src="assets\vendor_components\highcharts\js\highcharts.js"></script>
    <script src="assets\vendor_components\highcharts\js\highcharts-more.js"></script>
    <script src="assets\vendor_components\highcharts\js\variable-pie.js"></script>
    <script src="assets\vendor_components\highcharts\js\solid-gauge.js"></script>
    <script src="assets\vendor_components\highcharts\js\highcharts-3d.js"></script>
    <script src="assets\vendor_components\highcharts\js\cylinder.js"></script>
    <script src="assets\vendor_components\highcharts\js\funnel3d.js"></script>
    <script src="assets\vendor_components\highcharts\js\exporting.js"></script>
    <script src="assets\vendor_components\highcharts\js\export-data.js"></script>
    <script src="assets\vendor_components\highcharts\js\accessibility.js"></script>
    <script src="assets\vendor_components\highcharts\js\highcharts-custom.script.js"></script>
    <!-- CRMi App -->
