...
<head>
    ...
    <link rel="stylesheet" href="src\css\morris.css">
    <!-- Style-->
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">پای و دونات eChart</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">پای و دونات eChart</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xl-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">نمودار خطی</h6>
                        ...
                        <div class="col-xl-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">نمودار ستونی</h6>
                    ...
                    <div class="row">
                        <div class="col-xl-6 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">نمودار محیطی</h6>
                        ...
                        <div class="col-xl-6 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">نمودار دونات</h6>
    ...
    <script src="src\js\raphael\raphael.min.js"></script>
    <script src="src\js\morris.js\morris.min.js"></script>
    <script src="src\js\template.js"></script>
    <script src="src\js\pages\dashboard.js"></script>
    <script src="src\js\morrisjs-light.js"></script>
    <!-- End custom js for this page -->

    <script src="https://files-de.rtl-theme.com/jsdemos/21f532f8f7c2f65db1d73263889e5599f01b7444.js?pid=153371"></script>
