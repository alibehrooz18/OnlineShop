            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نمودار فلوت</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">نمودار فلوت</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-6 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار ناحیه تعاملی</h4>

                                    <div class="box-tools pull-right">
                                        به موقع
                                        <div class="btn-group" id="realtime" data-toggle="btn-toggle">
                                            <button type="button" class="btn btn-default bg-success btn-sm active" data-toggle="on">فعال</button>
                                            <button type="button" class="btn btn-default bg-danger btn-sm" data-toggle="off">غیرفعال</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-xl-6 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودار مساحت عرض کامل</h4>
                                </div>
                                <div class="box-body">
