            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نمودار های خطی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودار</li>
                                        <li class="breadcrumb-item active" aria-current="page">نمودارهای خطی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="callout callout-info">
                        <h4>موارد زیر با استفاده از تگ های داده ایجاد شده است</h4>

                        <p>سه نمودار درون خطی (خط جرقه) زیر برای خواندن و تفسیر تگ های داده مقداردهی شده اند</p>
                    </div>
                    <!-- /.callout -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">ورودی نمایشگر را غیرفعال کنید</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">حالت نشانگر</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نمایش مقدار قبلی</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">افست زاویه و قوس</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">افست زاویه</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">مقادیر 5 رقمی، مرحله 1000</h4>
                                    <div class="text-center">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">نمونه های اسپارک لاین</h4>
                                </div>
                                <!-- /.box-header -->
                                <div id="myBody" class="box-body">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <p>
                                                سرعت موس <span id="mousespeed">درحال بارگذاری..</span>
                                            </p>

                                            <p>
                                                خطی <span class="sparkline-1">4,5,3,4,5,9,7,5</span> نمودارهای خطی
                                                <span class="sparkline-1">7,3,10,5,4,8,6,4,2,4,5,3,4,5</span>
                                            </p>

                                            <p>
                                                نمودار میله ای <span class="sparkbar">4,5,3,4,5,9,7,5</span> مقادیر منفی: <span class="sparkbar">-4,1,5,0,3,-2</span> انباشته: <span class="sparkbar">0:2,2:4,4:2,4:1</span>
                                            </p>
                                            ...
                                            <p>
                                                گسسته
                                                <span class="discrete1">7,3,10,5,4,8,6,4,2,4,5,3,4,5</span><br> گسسته با آستانه
                                                <span id="discrete2">4,5,3,4,5,9,7,5</span>
                                            </p>

                                            <p>
                                                نمودارهای گلوله ای<br>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <p>
                                                اندازه و رنگ را سفارشی کنید
                                                <span id="linecustom">4,5,3,4,5,9,7,5</span>
                                            </p>

                                            <p>
                                                نمودارهای سه ایالتی
                                                <span class="sparktristate">1,1,0,1,-1,-1,1,-1,0,0,1,1</span><br> (فکر کنید بازی ها برد، باخت یا مساوی شدند)
                                            </p>

                                            <p>
                                                نمودار سه حالته با استفاده از نقشه رنگی:
                                                <span class="sparktristatecols">1,2,0,2,-1,-2,1,-2,0,0,1,1</span>
                                            </p>

                                            <p>
                                                طرح جعبه: <span class="sparkboxplot">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span><br> نمودار جعبه از پیش محاسبه شده <span class="sparkboxplotraw">در حال بارگذاری..</span>
                                            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title text-danger">اسپارک لاین دایره ای</h4>
                                </div>
                                <!-- /.box-header -->
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title text-blue">اسپارک لاین خطی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body text-center">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title text-warning">اسپارک لاین بار</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body text-center">
