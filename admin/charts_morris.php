            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نمودار موریس</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودارها</li>
                                        <li class="breadcrumb-item active" aria-current="page">نمودار موریس</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نمودار خطی</h4>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نمودار میله ای</h4>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نمودار دونات</h4>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <ul class="list-inline text-center mt-40">
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-success"></i>داده 1</h5>
                                        </li>
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-info"></i>داده 2</h5>
                                        </li>
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-warning"></i>داده 3</h5>
                                        </li>
                                    </ul>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <ul class="list-inline text-end">
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-primary"></i>داده 1</h5>
                                        </li>
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-success"></i>داده 2</h5>
                                        </li>
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-info"></i>داده 3</h5>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <ul class="list-inline text-end">
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-warning"></i>داده 1</h5>
                                        </li>
                                        <li>
                                            <h5><i class="fa fa-circle me-5 text-danger"></i>داده 2</h5>
                                        </li>
                                    </ul>
