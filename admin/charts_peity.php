...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نمودار پتی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمودار</li>
                                        <li class="breadcrumb-item active" aria-current="page">نمودار پتی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12 col-lg-9">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">چارت بار</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمودارهای آپدیت</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">پای</h4>
                                </div>
                                <div class="box-body">
                                    <p><code>class="pie"</code> اضافه شود به <em>&lt;span&gt;</em></p>
                                    <div class="row gap-y">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title"> دونات چارت</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row gap-y">
                                        <div class="col-6 col-md-2 text-center">
    ...
    <script src="src\js\pages\peity.js"></script>
