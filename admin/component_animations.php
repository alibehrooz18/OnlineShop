...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">انیمیشن ها - انیمیشن های CSS3</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">انیمیشن ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">کسانی که در پی جلب توجه هستند</h4>
                            <span class="text-muted d-block">انیمیشن های اصلی با استفاده از <code>animate.css</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>bounce</code> انیمیشن را پرش کنید
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">تکان دادن</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>shake</code> انیمیشن را تکان دهید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن فلش با استفاده از کلاس <code>flash</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">تاب خوردن</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن نوسانی با استفاده از کلاس <code>swing</code>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن پالس با استفاده از کلاس <code>pulse</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">تادا</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن تادا با استفاده از کلاس <code>tada</code>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">نوار لاستیکی</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    لاستیک با استفاده از کلاس <code>rubberBand</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">تکان خوردن</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Wobble با استفاده از کلاس <code>wobble</code>
                                </div>
                            </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">ورودی های جهنده</h4>
                            <span class="text-muted d-block">گزینه های ورودی برای انیمیشن های <code>bounce</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce InLeft با استفاده از کلاس <code>bounceInLeft</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>bounceIn</code>، انیمیشن Bounce In
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce In Right با استفاده از کلاس <code>bounceInRight</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce In Up با استفاده از کلاس <code>bounceInUp</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce In Down با استفاده از کلاس <code>bounceInDown</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">خروج</h4>
                            <span class="text-muted d-block">گزینه های خروج برای انیمیشن های <code>bounce</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">وسط به چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>bounceOutLeft</code>، انیمیشن سمت چپ را به بیرون پرش کنید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce Out با استفاده از کلاس <code>bounceOut</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">خروج به راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce Out Right با استفاده از کلاس <code>bounceOutRight</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">خروج به بالا</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce Out Up با استفاده از کلاس <code>bounceOutUp</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">خروج به پایین</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Bounce Out Down با استفاده از کلاس <code>bounceOutDown</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">محو شدن ورودی ها</h4>
                            <span class="text-muted d-block">گزینه‌های ورودی برای انیمیشن‌های <code>fade</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    Fade In انیمیشن با استفاده از کلاس <code>fadeIn</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">ظاهرشدن از چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Left با استفاده از کلاس <code>fadeInLeft</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">ظاهرشدن از راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Right با استفاده از کلاس <code>fadeInRight</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Down با استفاده از کلاس <code>fadeInDown</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">از چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Left Big با استفاده از کلاس <code>fadeInLeftBig</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">از راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Right Big با استفاده از کلاس <code>fadeInRightBig</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Down Big با استفاده از کلاس <code>fadeInDownBig</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Up با استفاده از کلاس <code>fadeInUp</code>
                                </div>
                            </div>

                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">به سمت بالا</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade In Up Big با استفاده از کلاس <code>fadeInUpBig</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">موجود</h4>
                            <span class="text-muted d-block">گزینه‌های خروج برای انیمیشن‌های <code>fade</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    محو کردن انیمیشن با استفاده از کلاس <code>fadeOut</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    محو کردن انیمیشن سمت چپ با استفاده از کلاس <code>fadeOutLeft</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade Out Right با استفاده از کلاس <code>fadeOutRight</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade Out Down با استفاده از کلاس <code>fadeOutDown</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade Out Left Big با استفاده از کلاس <code>fadeOutLeftBig</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade Out Right Big با استفاده از کلاس <code>fadeOutRightBig</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن بزرگ Fade Out Down با استفاده از کلاس <code>fadeOutDownBig</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Fade Out Up با استفاده از کلاس <code>fadeOutUp</code>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    Fade Out Up Big انیمیشن با استفاده از کلاس <code>fadeOutUpBig</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">انیمیشن های تلنگر</h4>
                            <span class="text-muted d-block">گزینه‌هایی برای انیمیشن‌های <code>flip</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">فلیپ اینکس</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>flipInX</code>، انیمیشن X را برگردانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن را با استفاده از کلاس <code>flip</code> برگردانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">فلیپاینی</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>flipInY</code>، انیمیشن Y را برگردانید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن X را با استفاده از کلاس <code>flipOutX</code> برگردانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Y را با استفاده از کلاس <code>flipOutY</code> برگردانید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">انیمیشن های با سرعت نور</h4>
                            <span class="text-muted d-block">گزینه‌هایی برای انیمیشن‌های <code>سرعت نور</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">لایت اسپیداین</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    انیمیشن سرعت نور با استفاده از کلاس <code>lightSpeedIn</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن سرعت نور با استفاده از کلاس <code>lightSpeedOut</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">چرخش</h4>
                            <span class="text-muted d-block">گزینه‌های ورودی برای انیمیشن‌های <code>rotate</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">پایین به چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    چرخش به سمت پایین انیمیشن سمت چپ با استفاده از کلاس <code>rotateInDownLeft</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">چرخش به داخل</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    چرخش در انیمیشن با استفاده از کلاس <code>rotateIn</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">پایین به راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    چرخش به سمت راست انیمیشن با استفاده از کلاس <code>rotateInDownRight</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">داخل به چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateInUpLeft</code> انیمیشن را به سمت چپ بالا بچرخانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">داخل به راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateInUpRight</code> انیمیشن را به سمت راست بچرخانید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">خروجی های چرخشی</h4>
                            <span class="text-muted d-block">گزینه‌های خروج برای انیمیشن‌های <code>rotate</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateOutDownLeft</code> انیمیشن را به سمت پایین به سمت چپ بچرخانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateOut</code> انیمیشن را Rotate Out خارج کنید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateOutDownRight</code> انیمیشن را به سمت پایین بچرخانید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">بالا به چپ</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateOutUpLeft</code> انیمیشن را به سمت بالا به سمت چپ بچرخانید
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-header">
                                    <h6 class="box-title">بالا به راست</h6>
                                    <div class="box-controls pull-right">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rotateOutUpRight</code> انیمیشن را به سمت بالا بچرخانید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">انیمیشن های خاص</h4>
                            <span class="text-muted d-block">گزینه‌هایی برای انیمیشن‌های <code>ویژه</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Roll In با استفاده از کلاس <code>rollIn</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن لولا با استفاده از کلاس <code>hinge</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    با استفاده از کلاس <code>rollOut</code>، انیمیشن را پخش کنید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">زوم ورودی ها</h4>
                            <span class="text-muted d-block">گزینه های ورودی برای انیمیشن های <code>zoom</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    بزرگنمایی انیمیشن سمت چپ با استفاده از کلاس <code>zoomInLeft</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    بزرگنمایی انیمیشن با استفاده از کلاس <code>zoomIn</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    انیمیشن Right را با استفاده از کلاس <code>zoomInRight</code> بزرگنمایی کنید
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    بزرگنمایی انیمیشن با استفاده از کلاس <code>zoomInUp</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    بزرگنمایی انیمیشن با استفاده از کلاس <code>zoomInDown</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title mb-15">زوم خارج می شود</h4>
                            <span class="text-muted d-block">گزینه‌های خروج برای انیمیشن‌های <code>زوم</code></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    کوچکنمایی انیمیشن سمت چپ با استفاده از کلاس <code>zoomOutLeft</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    کوچکنمایی انیمیشن با استفاده از کلاس <code>zoomOut</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    بزرگنمایی انیمیشن Right با استفاده از کلاس <code>zoomOutRight</code>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    کوچکنمایی انیمیشن با استفاده از کلاس <code>zoomOutUp</code>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    کوچک کردن انیمیشن با استفاده از کلاس <code>zoomOutDown</code>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="src\js\pages\component-animations-css3.js"></script>
    <!-- CRMi App -->
