            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">بوت استرپ سویچ</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">بوت استرپ سویچ</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">کلاس رنگ</h3>
                                </div>
                                <div class="box-body res-tb-block">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-primary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-primary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                        ...
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-primary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-primary" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-secondary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-secondary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-sm btn-toggle btn-secondary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-secondary active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-secondary" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-info active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-info active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-sm btn-toggle btn-info active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-info active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-info" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-danger active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-danger active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                        ...
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-danger active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-danger" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-success active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-success active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-sm btn-toggle btn-success active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-success active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-success" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-xl-3 col-6 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-warning active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-toggle btn-warning active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                        ...
                                        <div class="col-xl-2 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle btn-warning active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-6 text-center align-self-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle btn-warning" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">کلاس اندازه </h3>
                                </div>
                                <div class="box-body res-tb-block">
                                    <div class="row">
                                        <div class="col-12 mb-20">
                                        ...
                                        <div class="col-sm-6 col-12 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle" data-bs-toggle="button" aria-pressed="false">
                                                <span class="handle"></span>
                                            </button>
                                        </div>

                                        <div class="col-sm-6 col-12 text-center mb-20">
                                            <button type="button" class="btn btn-lg btn-toggle active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-sm-6 col-12 text-center mb-20">
                                            <button type="button" class="btn btn-toggle active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-30">
                                        ...
                                        <div class="col-sm-6 col-12 text-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle" data-bs-toggle="button" aria-pressed="false">
                                                <span class="handle"></span>
                                            </button>
                                        </div>

                                        <div class="col-sm-6 col-12 text-center mb-20">
                                            <button type="button" class="btn btn-xs btn-toggle active" data-bs-toggle="button">
                                                <span class="handle"></span>
                                            </button>
                                        </div>
                                    </div>
