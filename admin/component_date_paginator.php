...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\date-paginator\bootstrap-datepaginator.min.css">
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">صفحه بندی تاریخ</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">صفحه بندی تاریخ</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body res-tb-block">
                                    <h4 class="box-title">دیت پیجینیتور</h4>
                                    <p>یک پلاگین جی کوئری که مولفه صفحه بندی عالی توییتر بوت استرپ را می گیرد و کمی جادوی مبتنی بر تاریخ را تزریق می کند. در فرآیند ایجاد یک روش بسیار ساده و مدولار شده برای صفحه بندی نتایج مبتنی بر تاریخ در برنامه شما</p>
                                </div>
                                <!-- /.box -->
                            </div>
                        </div>
    ...
    <script src="src\js\pages\date-paginator.js"></script>
