            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">رسانه های پیشرفته</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">رسانه های پیشرفته</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                <div class="media-body">
                                    <p><strong>مختار مینائی</strong></p>
                                    <p>فول استک دولوپر</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-gray-100 mb-20">
                                <span class="fa fa-phone lead text-info"></span>
                                <div class="media-body">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-img mb-20" style="background-image: url(images/gallery/landscape14.jpg);" data-overlay="5">
                                <div class="media-body">
                                    <p class="text-white"><strong>مختار مینائی</strong></p>
                                    <p class="text-white">فول استک دولوپر</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p><strong>مختار مینائی</strong> <time class="float-end" datetime="2017-07-14 20:00">24 دقیق پیش</time></p>
                                    <p>پیام تست</p>
                                    <div class="d-inline-block pull-right mt-10">
                                        <button type="button" class="btn btn-rounded btn-sm btn-success m-5">تائید شده</button>
                                        <button type="button" class="btn btn-rounded btn-sm btn-danger m-5">حذف</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="list-inline mt-10">
                                        <li><a href="#" class="link-black text-sm">کامنت (5) </a></li>
                                        <li><a href="#" class="link-black text-sm"> لایک (23)</a></li>
                                        <li class="pull-right">
                                            <button type="button" class="btn btn-box-tool btn-sm btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="ویرایش"><i class="fa fa-pencil"></i></button>
                                            <button type="button" class="btn btn-box-tool btn-sm btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="حذف"><i class="fa fa-trash"></i></button>
                                        </li>
                                    </ul>
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="list-inline mt-10">
                                        ...
                                        <li class="pull-right media-hover-show">
                                            <button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="ویرایش"><i class="fa fa-pencil"></i></button>
                                            <button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="حذف"><i class="fa fa-trash"></i></button>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20" data-provide="selectable">
                                <div class="media-left">
                                    <span class="custom-control custom-checkbox">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-gray-100 mb-20">
                                ...
                                <div class="box-tools pull-right">
                                    <button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="ویرایش"><i class="fa fa-pencil"></i></button>
                                    <button type="button" class="btn btn-box-tool btn-xs" data-bs-toggle="tooltip" title="" data-bs-original-title="حذف"><i class="fa fa-remove"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-gray-100 mb-20">
                                ...
                                <div>
                                    <a class="btn btn-primary btn-sm btn-rounded" href="#">فالو</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p>کاربر جدید عضو شد</p>
                                    <time datetime="2017-07-14 20:00">24 دقیق پیش</time>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-gray-100 mb-20">
                                ...
                                <div>
                                    <button type="button" class="btn btn-box-tool" data-bs-toggle="tooltip" title="" data-bs-original-title="اطلاعات بیشتر"><i class="fa fa-info"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-primary mb-20">
                                ...
                                <div class="media-body">
                                    <p><strong>مختار مینائی</strong></p>
                                    <p class="text-white">@مدیر</p>
                                </div>
                                <div>
                                    <a class="btn btn-outline btn-white btn-sm btn-rounded" href="#">فالو</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-success mb-20">
                                ...
                                <div class="media-body">
                                    <p>کاربر جدید عضو شد</p>
                                    <time datetime="2017-07-14 20:00" class="text-white">24 دقیق پیش</time>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media align-items-center bg-info mb-20">
                                ...
                                <div>
                                    <button type="button" class="btn btn-box-tool text-white btn-rounded" data-bs-toggle="tooltip" title="" data-bs-original-title="اطلاعات بیشتر"><i class="fa fa-info"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-danger mb-20">
                                <img class="avatar" src="images\avatar.png" alt="...">
                                <div class="media-body">
                                    <p><strong>رامین احمدی</strong> <time class="float-end text-white" datetime="2017-07-14 20:00">24 دقیق پیش</time></p>
                                    <p class="text-white">پروفایل ش را آپدیت کرد</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p><strong>امید همتی</strong> <time class="float-end" datetime="2017-07-14 20:00">24 دقیق پیش</time></p>
                                    <p>پیام تست</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p><strong>مختار مینائی</strong> <time class="float-end" datetime="2017-07-14 20:00">24 دقیق پیش</time></p>
                                    <p class="text-truncate">پیام تست</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p>
                                        <strong>ایمیل های اخیر چک شود</strong>
                                        <time class="float-end" datetime="2017-07-14 20:00">24 دقیق پیش</time>
                                    </p>
                                    <p class="fs-14 semibold">مختار مینائی</p>
                                    <p>پیام تست</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-warning mb-20">
                                ...
                                <div class="media-body">
                                    <p><strong>رضا تهرانی</strong> <time class="float-end text-white" datetime="2017-07-14 20:00">24 دقیق پیش</time></p>
                                    <p class="text-white">پیام تست</p>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 b-1 border-success mb-20">
                                <span class="avatar status-success">
                                    <img class="avatar" src="images\avatar.png" alt="...">
                                </span>
                                <div class="media-body">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-info mb-20">
                                ...
                                <div class="media-body">
                                    <p>
                                        <strong>ایمیل جدید دریافت شد</strong>
                                        <time class="float-end text-white" datetime="2017-07-14 20:00">24 دقیق پیش</time>
                                    </p>
                                    <p class="fs-14 semibold">مختار مینائی</p>
                                    <p class="text-white">پیام تست</p>
                                </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media bg-gray-100 mb-20">
                                ...
                                <div class="media-body">
                                    <p>
                                        <strong>برنامه های آخر هفته</strong>
                                        <small class="ps-1"><strong>(10)</strong></small>
                                    </p>
                                    <p>
                                        <strong class="fs-14 semibold">مختار مینائی</strong>
                                        <span class="dash"></span> پیام تست
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="media flex-column text-center p-40 bg-gray-100 mb-20">
                                ...
                                <div class="mt-20">
                                    <h6 class="text-uppercase fw-500">انجام شد!</h6>
                                    <small>تشکر همه چی اوکی</small>
                                </div>
                            </div>
                        </div>
