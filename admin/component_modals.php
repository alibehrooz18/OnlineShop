    ...
    <div class="wrapper">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">مدال ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت </li>
                                        <li class="breadcrumb-item active" aria-current="page">مدال ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="callout callout-success">
                        <h4>یادآوری!</h4>
                        برای مشاهده مستندات مراجعه کنید به
                        <a href="https://getbootstrap.com/docs/5.0/components/modal/">داکیومنت بوت استرپ</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">مدال های نمونه</h4>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال چپ</h4>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال وسط</h4>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال کامل</h4>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال راست</h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال بزرگ</h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال مدیوم</h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title d-block">مدال کوچک</h4>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">بستن</button>
                        <button type="button" class="btn btn-primary float-end">ثبت تغییرات</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <div class="modal modal-info fade" id="modal-info">
            <div class="modal-dialog">
                <div class="modal-content bg-info">
                    <div class="modal-header">
                        <h4 class="modal-title">مدال اینفو</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
        ...
        <div class="modal modal-primary fade" id="modal-primary">
            <div class="modal-dialog">
                <div class="modal-content bg-primary">
                    <div class="modal-header">
                        <h4 class="modal-title">مدال پرایمری</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
        ...
        <div class="modal modal-danger fade" id="modal-danger">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    <div class="modal-header">
                        <h4 class="modal-title">مدال دنجر</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">بستن</button>
                        <button type="button" class="btn btn-info float-end">ثبت تغییرات</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <div class="modal modal-warning fade" id="modal-warning">
            <div class="modal-dialog">
                <div class="modal-content bg-warning">
                    <div class="modal-header">
                        <h4 class="modal-title">مدال وارنینگ</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
        ...
        <div class="modal modal-success fade" id="modal-success">
            <div class="modal-dialog">
                <div class="modal-content bg-success">
                    <div class="modal-header">
                        <h4 class="modal-title">مدال ساکسس</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>بدنه مدال&hellip;</p>
        ...
        <div class="modal modal-left fade" id="modal-left" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>متن را در این قسمت قراردهید</p>
                    </div>
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">مدال بزرگ</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <h4>معرفی موضوع</h4>
                        <p>توضیحات را قرار دهیید.</p>
                        <p>و ادامه توضیحات.</p>
                    </div>
                    <div class="modal-footer">
        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">مدال متوسط</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <h4>معرفی موضوع</h4>
        ...
        <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="mySmallModalLabel">مدال کوچک</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body"> متن مدال </div>
                </div>
                <!-- /.modal-content -->
            </div>
            <!-- /.modal-dialog -->
