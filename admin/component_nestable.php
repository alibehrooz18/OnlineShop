...
<head>
 ...
 <link rel="stylesheet" href="assets\vendor_components\nestable\nestable.css">
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
 ...
 <div class="navbar-custom-menu r-side">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نستیبل</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">نستیبل</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نستیبل 1</h4>
                                </div>
                                <div class="box-body">
                                                    ...
                                                    <li class="dd-item" data-id="5">
                                                        ...
                                                        <ol class="dd-list">
                                                            ...
                                                            <li class="dd-item" data-id="7">
                                                                <div class="dd-handle">  آیتم7 </div>
                                                            </li>
                                                            <li class="dd-item" data-id="8">
                                                                <div class="dd-handle"> آیتم 8 </div>
                                                            </li>
                                                        </ol>
                                                    </li>
                                                    <li class="dd-item" data-id="9">
                                                        <div class="dd-handle"> آیتم 9 </div>
                                                    </li>
                                                    <li class="dd-item" data-id="10">
                                                        <div class="dd-handle"> آیتم 10 </div>
                                                    </li>
                                                </ol>
                                            </li>
                                        </ol>
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نستیبل 2</h4>
                                </div>
                                <div class="box-body">
                                    <div class="myadmin-dd-empty dd" id="nestable2">
                                        <ol class="dd-list">
                                            <li class="dd-item dd3-item" data-id="13">
                                                ...
                                                <div class="dd3-content"> آیتم 13 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="14">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 14 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="14">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 16 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="14">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 17 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="14">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 18 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="14">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 19 </div>
                                            </li>
                                            <li class="dd-item dd3-item" data-id="15">
                                                <div class="dd-handle dd3-handle"></div>
                                                <div class="dd3-content"> آیتم 15 </div>
                                                <ol class="dd-list">
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نستیبل 3</h4>
                                </div>
                                <div class="box-body">
                                    <div class="dd myadmin-dd" id="nestable-menu">
                                        <ol class="dd-list">
                                            <li class="dd-item" data-id="13">
                                                <div class="dd-handle">آیتم 13</div>
                                            </li>
                                            <li class="dd-item" data-id="13">
                                                <div class="dd-handle">آیتم 13</div>
                                            </li>
                                            <li class="dd-item" data-id="14">
                                                <div class="dd-handle">آیتم 14</div>
                                            </li>
                                            <li class="dd-item" data-id="15">
                                                <div class="dd-handle">آیتم 15</div>
                                                <ol class="dd-list">
                                                    <li class="dd-item" data-id="16">
                                                        <div class="dd-handle">آیتم 16</div>
                                                    </li>
                                                    <li class="dd-item" data-id="17">
                                                        <div class="dd-handle">آیتم 17</div>
                                                    </li>
                                                    <li class="dd-item" data-id="18">
                                                        <div class="dd-handle">آیتم 18</div>
                                                    </li>
                                                    <li class="dd-item" data-id="16">
                                                        <div class="dd-handle">آیتم 19</div>
                                                    </li>
                                                    <li class="dd-item" data-id="17">
                                                        <div class="dd-handle">آیتم 20</div>
                                                    </li>
                                                    <li class="dd-item" data-id="18">
                                                        <div class="dd-handle">آیتم 21</div>
                                                    </li>
                                                </ol>
                                            </li>
                                        </ol>
  ...
  <script src="src\js\vendors.min.js"></script>
    ...
    <script src="assets\vendor_components\nestable\jquery.nestable.js"></script>
