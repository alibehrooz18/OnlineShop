...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">اعلانات</h4>
                                ...
                                <div class="col">
                                    <div class="box mb-0">
                                        <div class="box-header">
                                            <h4 class="box-title">هشدار توستر ساده</h4>
                                            <p class="subtitle mb-0">شما میتوانید 4 هشدار متفاوت <code>info, warning, success, and error</code> با پیام داشته باشید.</p>
                                        </div>
                                        <div class="box-body pad res-tb-block">
                                            <div class="button-box d-grid gap-2">
                                                <button class="tst1 btn btn-info">پیام اطلاعیه</button>
                                                <button class="tst2 btn btn-warning">پیام هشدار</button>
                                                <button class="tst3 btn btn-success">پیام موفقیت</button>
                                                <button class="tst4 btn btn-danger">پیام اخطار</button>
                                            </div>
                                        </div>
                                        <!-- /.box-body -->
                                    </div>
                                ...
                                <div class="col">
                                    <div class="box mb-0">
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <h4>هشدار کامل بالا </h4>
                                                    <button class="btn btn-success btn-outline btn-sm showtop w-p100 mb-15">هشدار با عرض کامل</button>
                                                    <!-- Start an Alert -->
                                                    <div class="myadmin-alert myadmin-alert-icon myadmin-alert-click alert-success myadmin-alert-top alerttop"> <i class="ti-user"></i> این یک پیام تست <a href="#" class="closed">&times;</a> </div>
                                                </div>
                                                <div class="col-12">
                                                    <h4>هشدار پایین </h4>
                                                    <button class="btn btn-danger btn-outline btn-sm showbottom w-p100 mb-15">هشدار نوار پایین در عرض کامل</button>
                                                    <!-- Start an Alert -->
                                                    <div class="myadmin-alert myadmin-alert-icon myadmin-alert-click alert-danger myadmin-alert-bottom alertbottom"> <i class="ti-user"></i> این یک پیام تست <a href="#" class="closed">&times;</a> </div>
                                                </div>
                                                <div class="col-12">
                                                    <h4>هشدار کامل بالا </h4>
                                                    <button class="btn btn-info btn-outline btn-sm showtop2 w-p100 mb-15">هشدار در عرض کامل با عکس</button>
                                                    <!-- Start an Alert -->
                                                    <div class="myadmin-alert myadmin-alert-img myadmin-alert-click alert-info myadmin-alert-top alerttop2"> <img src="images\avatar5.png" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                                        <h4>شما یک پیام دارید!</h4> <b>مختار مینائی</b> برای شما ارسال کرد. <a href="#" class="closed">&times;</a>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <h4>هشدار پایین در عرض کامل با عکس</h4>
                                                    <button class="btn btn-warning btn-outline btn-sm showbottom2 w-p100 mb-15">هشدار پایین در عرض کامل</button>
                                                    <!-- Start an Alert -->
                                ...
                                <div class="col">
                                    <div class="box mb-0">
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <h4>هشدار بالا سمت راست </h4>
                                                    <button id="showtopright" class="btn btn-success btn-sm w-p100 mb-15">نمایش در راست</button>
                                                    <!-- Start an Alert -->
                                                    <div id="alerttopright" class="myadmin-alert myadmin-alert-img alert-success myadmin-alert-top-right"> <img src="images\avatar.png" class="img" alt="img"><a href="#" class="closed">&times;</a>
                                                        <h4>شما یک پیام دارید!</h4> <b>مختار مینایی </b> برایتان ارسال کرده است.
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <h4>هشدار بالا سمت چپ</h4>
                                                    <button id="showtopleft" class="btn btn-danger btn-sm w-p100 mb-15">نمایش در بالا سمت چپ</button>
                                                    <!-- Start an Alert -->
                                                ...
                                                <div class="col-12">
                                                    <h4>هشدار پایین سمت چپ </h4>
                                                    <button id="showbottomleft" class="btn btn-primary btn-sm w-p100 mb-15">نمایش در پایین سمت چپ</button>
                                                    <!-- Start an Alert -->
                                                ...
                                                <div class="col-12">
                                                    <h4>هشدار پایین راست </h4>
                                                    <button id="showbottomright" class="btn btn-info btn-sm w-p100 mb-15">نمایش در بالا سمت راست</button>
                                                    <!-- Start an Alert -->
                        ...
                        <div class="col-12">
                            <div class="row row-cols-lg-2 row-cols-1 g-4">
                                <div class="col-12">
                                    <div class="box mb-0">
                                        <div class="box-header">
                                            <h3 class="box-title">هشدارهای معمولی</h3>
                                        </div>
                                        <div class="box-body pad res-tb-block">
                                            <div class="alert alert-secondary"> این یک متن هشدار تست که شما بررسی کنید </div>
                                            <div class="alert alert-primary"> این یک متن هشدار تست که شما بررسی کنید </div>
                                            <div class="alert alert-success"> این یک متن هشدار تست که شما بررسی کنید </div>
                                            <div class="alert alert-info"> این یک متن هشدار تست که شما بررسی کنید </div>
                                            <div class="alert alert-warning"> این یک متن هشدار تست که شما بررسی کنید </div>
                                            <div class="alert alert-danger"> این یک متن هشدار تست که شما بررسی کنید </div>
                                        </div>
                                        <!-- /.box-body -->
                                    </div>
                                    <!-- /.box -->
                                ...
                                <div class="col-12">
                                    <div class="box mb-0">
                                        <div class="box-header">
                                            <h3 class="box-title">هشدارهای دیسیبل</h3>
                                        </div>
                                        <div class="box-body pad res-tb-block">
                                            <div class="alert alert-secondary alert-dismissible">
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button> این یک متن هشدار تست که شما بررسی کنید
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="box mb-0">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">هشدارهای دیسیبل با عنوان</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <div class="alert alert-danger alert-dismissible">
                                                ...
                                                پیام ها را با دقت بررسی کنید و متن هشدار را چک کنید
                                            </div>
                                            <div class="alert alert-info alert-dismissible">
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                                <h4><i class="icon fa fa-info"></i> هشدار!</h4>
                                                متن هشدار دیسیبل شده است.
                                            </div>
                                            <div class="alert alert-warning alert-dismissible">
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            ...
                                            <div class="alert alert-success alert-dismissible">
                                                ...
                                                <h4><i class="icon fa fa-check"></i> هشدار!</h4>
                                                متن هشدار دیسیبل شده است.
                                            </div>
                                            <div class="alert alert-secondary alert-dismissible">
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                ...
                                <div class="col-12">
                                    <div class="box mb-0">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">هشدار مستقیم</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            <div class="callout callout-secondary">
                                                <h4>یک اخطار کاملا جدی!</h4>

                                                <p>مشکلی وجود دارد که هر چه سریعتر باید رفع شود.</p>
                                            </div>
                                            ...
                                            <div class="callout callout-info">
                                                <h4>هشدار اطلاع رسانی!</h4>

                                                <p>مراحل زیر را انجام دهید.</p>
                                            </div>
                                            <div class="callout callout-warning">
                                                <h4>هشدار اخطار!</h4>

                                                <p>این یک اخطار است.</p>
                                            </div>
    ...
    <script src="src\js\pages\toastr.js"></script>
    <script src="src\js\pages\notification.js"></script>
    <!-- CRMi App -->
