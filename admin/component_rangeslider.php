...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\ion-rangeSlider\css\ion.rangeSlider.css">
    <link rel="stylesheet" href="assets\vendor_components\ion-rangeSlider\css\ion.rangeSlider.skinModern.css">
</head>
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نوار لغزنده</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">نوار لغزنده</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="callout bg-warning">
                        <h4>توجه!</h4>
                        <span class="badge badge-lg badge-danger text-wrap text-start">برای دریافت مستندات مراجعه کنید به <a class="m-link" href="http://ionden.com/a/plugins/ion.rangeSlider/en.html" target="_blank">دموها &amp; مستندات</a></span>
                    </div>
                            ...
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    <label for="range_01" class="col-sm-2 form-label">
                                        <span>پیشفرض</span>
                                        <span class="fs-12 d-block text-muted clearfix">بدون پارامتر شروع کنید</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_02" class="col-sm-2 form-label">
                                        <span>مینیموم- ماکسیموم</span>
                                        <span class="fs-12 d-block text-muted clearfix">مقدار حداقل، حداکثر مقدار و نقطه شروع را تنظیم کنید</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_03" class="col-sm-2 form-label">
                                        <span>پیشوند</span>
                                        <span class="fs-12 d-block text-muted clearfix">نمایش شبکه و اضافه کردن پیشوند "$"</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_04" class="col-sm-2 form-label">
                                        <span>رنج</span>
                                        <span class="d-block fw-normal font-13 text-muted clearfix">محدوده را با مقادیر منفی تنظیم کنید</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_05" class="col-sm-2 form-label">
                                        <span>مرحله ای</span>
                                        <span class="d-block fs-12 text-muted clearfix">با استفاده از مرحله 250</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_06" class="col-sm-2 form-label">
                                        <span>مقادیر سفارشی</span>
                                        <span class="d-block fw-normal font-13 text-muted clearfix">استفاده از هر رشته ای به عنوان مقدار</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_07" class="col-sm-2 form-label">
                                        <span>زیباسازی اعداد</span>
                                        <span class="d-block fw-normal font-13 text-muted clearfix">زیباسازی فعال است. خیلی بهتر!</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_08" class="col-sm-2 form-label">
                                        <span>دیسیبل شده</span>
                                        <span class="d-block fs-12 text-muted clearfix">با استفاده از گزینه غیر فعال کردن نوار لغزنده را قفل کنید</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_09" class="col-sm-2 form-label">
                                        <span>مثال اضافی</span>
                                        <span class="d-block fs-12 text-muted clearfix">آیا می خواهید نشان دهید که حداکثر عدد بزرگترین عدد نیست؟</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_10" class="col-sm-2 form-label">
                                        <span>از گزینه dekor_both استفاده کنید</span>
                                        <span class="d-block fs-12 text-muted clearfix">از گزینه dekor_both استفاده کنید</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_11" class="col-sm-2 form-label">
                                        <span>پسوندها</span>
                                        <span class="d-block fw-normal font-13 text-muted clearfix">استفاده کنید از پسوندها</span>
                                    </label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="range_12" class="col-sm-2 form-label">
                                        <span>مخفی کردن</span>
                                        <span class="d-block fs-12 text-muted clearfix">یا هر قسمتی را که می خواهید پنهان کنید</span>
                                    </label>
                                    <div class="col-sm-10">
