            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">امتیازات</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">کامپوننت</li>
                                        <li class="breadcrumb-item active" aria-current="page">امتیازات</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">پیشفرض</h4>
                                    <p>این ابتدایی ترین نمونه رتبه بندی است.</p>
                                    <div class="inline-block">
                                        <img src="images\rating\star-off.png">
                                        <img src="images\rating\star-half.png">
                                        <img src="images\rating\star-on.png">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">امتیاز</h4>
                                    <p>زمانی استفاده می شود که می خواهیم با رتبه ذخیره شده شروع می شود.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">تعداد ستاره ها</h4>
                                    <p>تعداد ستاره ها را عوض کنید.</p>
                                    <img src="images\rating\star-off.png">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">بیشترین تعداد</h4>
                                    <p>حداکثر ستاره هایی را که می توان ایجاد کرد تغییر دهید.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">فقط خواندنی</h4>
                                    <p>می توانید از رای دادن کاربران جلوگیری کنید. می توان آن را با یا بدون نمره اعمال کرد.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">امتیاز بدون پیام</h4>
                                    <p>اگر readOnly فعال باشد و امتیازی وجود نداشته باشد، راهنمایی "هنوز رتبه بندی نشده است!" برای همه ستاره ها نشان داده خواهد شد.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">لغو</h4>
                                    <p>برای لغو امتیاز، یک دکمه لغو در سمت چپ ستاره ها اضافه کنید.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">فاصله</h4>
                                    <p>می توانید فضای بین ستاره را تغییر دهید و آنها را شلوغ کنید.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">تکی</h4>
                                    <p>می‌توانید به‌جای آن ستاره‌ای را که روی ماوس گذاشته شده است، از اول تا آن ستاره روشن کنید.</p>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نیمه</h4>
                                    <p>ماوس نیم ستاره را فعال می کند تا امکان رای دادن با مقادیر نصف وجود داشته باشد.
                                    </p>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">نیم امتیاز</h4>
                                    <p>رنگ نیم ستاره را تغییر می دهد.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">آیکون سفارشی</h4>
                                    <p>حداکثر ستاره هایی را که می توان ایجاد کرد تغییر دهید.</p>
                                    <img src="images\rating\star-off.png">
                                    <img src="images\rating\star-half.png">
                                    <img src="images\rating\star-on.png">
                                    <img src="images\rating\heart.png">
                                    <img src="images\rating\cancel-off.png">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">رنج آیکون</h4>
                                    <p>تعدا ستاره ها را عوض کنید</p>
                                    <img src="images\rating\star-on.png">
                                    <img src="images\rating\heart.png">
                                    <img src="images\rating\cancel-off.png">
                                </div>
