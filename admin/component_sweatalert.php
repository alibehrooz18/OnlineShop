...
<head>
    ...
    <link href="assets\vendor_components\sweetalert2\sweetalert2.min.css" rel="stylesheet" type="text/css">
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18" style="margin-right:20px;"> سوئیت الرت2</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">فودا تم</a></li>
                                    <li class="breadcrumb-item active" style="margin-left:20px;">سوئیت الرت 2</li>
                                </ol>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">نمونه ها</h4>
                                    <p class="card-title-desc">یک نماش زیبا برای هر تغییری که باید به کاربر نشان داده شود</p>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-basic">کلیک کنید</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-title">کلیک کنید</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-success">کلیک کنید</button>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th scope="row">
                                                        یک پیام هشدار برای تائید یا لغو
                                                    </th>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-warning">کلیک کنید</button>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th scope="row">
                                                        با یک اعلان میتوانید تائید یا لغو کنید
                                                    </th>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-params">کلیک کنید</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-image">کلیک کنید</button>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th scope="row">
                                                        یک پیام با حالت نمایش اتوماتیک
                                                    </th>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-close">کلیک کنید</button>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th scope="row">
                                                        یک توضیح سفارشی با دکمه
                                                    </th>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="custom-html-alert">کلیک کنید</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="sa-position">کلیک کنید</button>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <th scope="row">
                                                        یک متن سفارشی با حاشیه و پس زمینه
                                                    </th>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="custom-padding-width-alert">کلیک کنید</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-primary btn-sm waves-effect waves-light" id="ajax-alert">کلیک کنید</button>
                                                    </td>
                                                </tr>
    ...
    <script src="src\js\sweetalert.init.js"></script>
