            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">لیست تماس</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">اپلیکیشن</li>
                                        <li class="breadcrumb-item active" aria-current="page">لیست مخاطبین</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="box-body p-0">
                                    <div class="flexbox align-items-center p-15">
                                        <div class="flexbox align-items-center">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">انتقال به</button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#"><span class="badge badge-ring badge-danger me-1"></span> فعالیت</a>
                                                    <a class="dropdown-item" href="#"><span class="badge badge-ring badge-warning me-1"></span> خانواده</a>
                                                    <a class="dropdown-item" href="#"><span class="badge badge-ring badge-info me-1"></span> دوستان</a>
                                                    <a class="dropdown-item" href="#"><span class="badge badge-ring badge-success me-1"></span> محرمانه</a>
                                                </div>
                                            </div>
                                            <div class="dropdown d-none d-sm-block">
                                                <button class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> مرتب اسازی بر اساس</button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#">تاریخ</a>
                                                    <a class="dropdown-item" href="#">نام</a>
                                                    <a class="dropdown-item" href="#">گروه</a>
                                                    <a class="dropdown-item" href="#">محبوب</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="media-list media-list-divided media-list-hover">
                                                ...
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="#"><i class="fa fa-fw fa-phone"></i> تماس</a>
                                                            <a class="dropdown-item" href="#"><i class="fa fa-fw fa-commenting"></i> پیام</a>
                                                            <a class="dropdown-item" href="#"><i class="fa fa-fw fa-envelope"></i> ایمیل</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" href="#"><i class="fa fa-fw fa-trash"></i> حذف</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="box-body">
                                    <div class="contact-page-aside">
                                        <ul class="list-style-none fs-16">
                                            <li class="box-label"><a href="javascript:void(0)">کل مخاطبین <span>123</span></a></li>
                                            <li class="divider"></li>
                                            <li><a class="text-danger" href="javascript:void(0)">فعالیت <span class="text-danger">103</span></a></li>
                                            <li><a class="text-warning" href="javascript:void(0)">خانواده <span class="text-warning">19</span></a></li>
                                            <li><a class="text-info" href="javascript:void(0)">دوستان <span class="text-info">623</span></a></li>
                                            <li><a class="text-success" href="javascript:void(0)">محرمانه <span class="text-success">53</span></a></li>
                                            <li class="box-label"><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success mt-10">+ ایجاد برچسب جدید</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
