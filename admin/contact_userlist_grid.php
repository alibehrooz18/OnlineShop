                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item" aria-current="page">ارتباطات</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="box ribbon-box">
                                <div class="ribbon-two ribbon-two-primary"><span>سئو</span></div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\1.jpg" alt="">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-center">
                                        <h3 class="my-10"><a href="#">رامبد کمالی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">طراح</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="box ribbon-box">
                                <div class="ribbon-two ribbon-two-danger"><span>مشاور</span></div>
                                <div class="box-header no-border p-0">
                                    <a href="#">
					  <img class="img-fluid" src="images\avatar\375x200\2.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">لیلا مرادی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">برنامه نویس</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="box ribbon-box">
                                <div class="ribbon-two ribbon-two-success"><span>پرسنل اداری</span></div>
                                <div class="box-header no-border p-0">
                                    <a href="#">
					  <img class="img-fluid" src="images\avatar\375x200\3.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">آرش رحیمی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">پشتیبانی</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                            </div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\4.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">محسن رحمانی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">طراح</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="box ribbon-box">
                                <div class="ribbon-two ribbon-two-info"><span>مدیریت</span></div>
                                <div class="box-header no-border p-0">
                                    <a href="#">
					  <img class="img-fluid" src="images\avatar\375x200\5.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">سیما تهرانی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">پشتیبانی</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\6.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">شیما گلی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">بازاریابی</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                            </div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\7.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">مریم قربانی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">طراح</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\8.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">مسعود رحیمی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">طراح</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
					  ...
					  <img class="img-fluid" src="images\avatar\375x200\2.jpg" alt="">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <h3 class="my-10"><a href="#">آزیتا تبریزی</a></h3>
                                        <h6 class="user-info mt-0 mb-10 text-fade">فول استک</h6>
                                        <p class="text-fade w-p85 mx-auto">تهران - الهیه - مریم شرقی </p>
                                    </div>
                                </div>
                            </div>
