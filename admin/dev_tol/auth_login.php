                                ...
                                <form action="index.php" method="post">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control ps-15 bg-transparent" placeholder="نام کاربری" style="direction:rtl;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="fog-pwd text-end">
                                                <a href="javascript:void(0)" class="hover-warning"><i class="ion ion-locked"></i>پسووردت رو فراموش کردی؟</a><br>
                                            </div>
                                        </div>
                                        <!-- /.col -->
