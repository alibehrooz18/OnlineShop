                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4>رنگ پس زمینه</h4>
                                    <p>هر باکس میتواند داشته باشد <code>.box-*</code> یک کلاس <b>*</b>داشته باشد <a href="ui/general.php" target="_blank">نام رنگ</a>. با ایجاد یک متن رنگی <code>.box-inverse</code> در باکس <em>.box</em> tag.</p>
                                </div>
                            </div>
                        </div>
