            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">تمام صفحه</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">اکستنشن</li>
                                        <li class="breadcrumb-item active" aria-current="page">تمام صفحه</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">تمام صفحه</h4>
                        ...
                        <div class="box-body">
                            <p>بسته بندی ساده برای استفاده متقابل مرورگر از JavaScript Fullscreen API، که به شما امکان می دهد صفحه را به حالت تمام صفحه بیاورید..<a href="https://github.com/sindresorhus/screenfull.js/" target="_blank" class="pull-right">مستندات رسمی</a></p>
                            <h5>نمونه ها</h5>
                            <div class="gap-items gap-y">
                                <button class="btn btn-rounded btn-info ms-1" id="request">درخواست</button>
                                <button class="btn btn-rounded btn-danger ms-1" id="exit">خروج</button>
                                <button class="btn btn-rounded btn-success ms-1" id="toggle">جابجایی</button>
                                <button class="btn btn-rounded btn-warning ms-1" id="request2">درخواست مدارک</button>
