        ...
        <div class="content-wrapper">
            <div class="container-full">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-12">
                                    <h5>رنگ کامل</h5>
                                    <p><code>.bg-*</code> به هر بخش فقط نام رنگ را <code>*</code> اضافه کنید.</p>
                                    <div class="row">
                                ...
                                <div class="col-12">
                                    <h5 class="mt-30">سایر رنگ ها</h5>
                                    <p>از این رنگ های دیگر میتوانید استفاده کنید.</p>
                                    <div class="row">
                                        <div class="col-lg-3 col-6">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><strong>رنگ های</strong> گرادیانت</h4>
                        </div>

                        <div class="box-body">
                            <div class="row">
                                <div class="col-12">
                                    <h5>رنگ های گرادیانت</h5>
                                    <div class="row">
                                        <div class="col-lg-3 col-6">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><strong>SVG</strong>پس زمینه</h4>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <h5 class="mt-30">SVG پس زمیته </h5>
                                    <div class="gap-items gap-y">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><strong>رنگی</strong>نوارهای</h4>
                        </div>

                        <div class="box-body">
                            <p><code>.border-*</code> به هر بخش فقط نام رنگ را <code>*</code>اضافه کنید</p>
                            <div class="gap-items gap-y">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"><strong>رنگی</strong>متن های</h4>
                        </div>

                        <div class="box-body">
                            <h5>Text colors</h5>
                            <p><code>.text-*</code> به هر متن مانند نمونه <code>*</code> رنگ را اضه کنید<code>&lt;a&gt;</code> به قسمت مورد نظر</p>
                            ...
                            <h5>هاور رنگ</h5>
                            <p><code>.hover-*</code> بعد از اشاره گر <code>*</code> رنگ قسمت مورد نظر <code>&lt;a&gt;</code> تغییر میکند.</p>
                            <div class="gap-items gap-y fs-20">
