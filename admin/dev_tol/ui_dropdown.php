            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">دراپ داون</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">ظاهر تم</li>
                                        <li class="breadcrumb-item active" aria-current="page">دراپ داون</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">دراپ داون های ساده<br><small>دراپ داون ها برای نمایش لیستی از لینک ها و یا بیشتر استفاده می شود.</small></h4>
                                </div>
                                <div class="box-body doc-dropdown">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>پیش فرض</h5>
                                                <p>یک دراپ داون ساده</p>
                                                <div class="btn-group">
                                                    <button class="btn btn-rounded btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>منوی</h5>
                                                <p><code>.dropdown-menu-end</code> اضافه کنید به <em>.dropdown-menu</em></p>

                                                <div class="btn-group">
                                                    <button class="btn btn-rounded btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>دراپ اپ</h5>
                                                <p><code>.dropup</code> جایگزین کنید با <em>.dropdown</em></p>

                                                <div class="btn-group dropup">
                                                    <button class="btn btn-rounded btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ اپ</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5 class="mt-30">دراپ اپ</h5>
                                                <p><code>.dropdown-menu-end</code> اضافه کنید به <em>.dropdown-menu</em></p>

                                                <div class="btn-group dropup">
                                                    <button class="btn btn-rounded btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ اپ</button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5 class="mt-30">بدون حالت</h5>
                                                <p><code>.no-caret</code> اضافه کنید به <em>.dropdown-toggle</em></p>

                                                <div class="btn-group">
                                                    <button class="btn btn-rounded btn-warning dropdown-toggle no-caret" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5 class="mt-30">باایکون</h5>
                                                <p><code>.icon</code> اضافه کنید به <em>.dropdown-toggle</em></p>

                                                <div class="btn-group">
                                                    <button class="btn btn-rounded btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown"><i class="icon ti-settings"></i> دراپ دان</button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">دراپ دان <br><small>دراپ دان ها نمایش از لیست لینک ها یا بیشتر را نمایش می دهند.</small></h4>
                                </div>
                                <div class="box-body doc-dropdown">
                                    <div class="row">
                                        <!--Header!-->
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>هدر</h5>
                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                                    <div class="dropdown-menu">
                                                        <h6 class="dropdown-header">هدر دراپ داون</h6>
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                                    </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="#">لینک جداساز</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                ...
                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="#"><i class="fa fa-share-alt"></i>اشتراک گذاری</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>با امکان متفاوت</h5>

                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>ایتم غیرفعال</h5>
                                                <p><code>.disabled</code> اضافه کنید به <em>.dropdown-item</em></p>

                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item disabled" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="h-200">
                                                <h5>ایتم فعال</h5>
                                                <p><code>.active</code> اضافه کنید به<em>.dropdown-item</em></p>

                                                <div class="dropdown">
                                                    <button class="btn btn-rounded btn-outline btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ داون</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#">عملیات</a>
                                                        <a class="dropdown-item active" href="#">دیگر</a>
                                                        <a class="dropdown-item" href="#">سایر</a>
                                                    </div>
                                                </div>
                                            </div>
