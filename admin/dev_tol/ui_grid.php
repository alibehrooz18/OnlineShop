            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title"> بخش بندی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">بخش بندی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title"> بخش بندی</h4>
                        </div>
                        <div class="box-body">
                            <p>در حالی که Bootstrap از ems یا rems برای تعریف بیشتر اندازه ها استفاده می کند، px ها برای نقاط شکست شبکه و عرض کانتینر استفاده می شوند. این به این دلیل است که عرض درگاه نمایش بر حسب پیکسل است و با اندازه فونت تغییر نمی کند.</p>
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="text-nowrap" scope="row"> حداکثر عرض صفحه</th>
                                            <td>None (auto)</td>
                                            <td>540px</td>
                                            <td>720px</td>
                                            <td>960px</td>
                                        ...
                                        <tr>
                                            <th class="text-nowrap" scope="row">کلاس های پیشوندی</th>
                                            <td><code>.col-</code></td>
                                        ...
                                        <tr>
                                            <th class="text-nowrap" scope="row"># ستون ها</th>
                                            <td colspan="6">12</td>
                                        </tr>
                                        <tr>
                                            <th class="text-nowrap" scope="row">عرض ناودان</th>
                                            <td colspan="6">1.5rem (.75rem از راست و چپ )</td>
                                        </tr>
                                        <tr>
                                            <th class="text-nowrap" scope="row">تودرتو</th>
                                            <td colspan="6">Yes</td>
                                        </tr>
                                        <tr>
                                            <th class="text-nowrap" scope="row"> ستون های سفارشی</th>
                                            <td colspan="6">Yes</td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title mb-5">مثال: پشته به افقی</h4>
                            <h6 class="box-subtitle mb-20">با استفاده از یک مجموعه از <code>.col-md-*</code> کلاس‌های شبکه، می‌توانید یک سیستم شبکه پیش‌فرض ایجاد کنید که قبل از افقی شدن روی دسک‌تاپ، به صورت انباشته در دستگاه‌های تلفن همراه و دستگاه‌های تبلت (از محدوده بسیار کوچک تا کوچک) شروع می‌شود.
                                دستگاه های (متوسط). ستون های شبکه را در هر کدام قرار دهید <code>.row</code>.</h6>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title mb-5">مثال: موبایل و دسکتاپ</h4>
                            <h6 class="box-subtitle mb-20">آیا نمی خواهید ستون های شما به سادگی در دستگاه های کوچکتر جمع شوند؟ با افزودن <code>.col-xs-*</code> <code>.col-md-*</code> به ستون‌های خود، از کلاس‌های شبکه دستگاه کوچک و متوسط اضافی استفاده کنید. برای ایده بهتر به مثال زیر مراجعه کنید
                                از اینکه چگونه همه کار می کند.</h6>
                            <div class="row bg-light mb-10 p-10">
                    ...
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title mb-5">مثال: موبایل، تبلت، دسکتاپ</h4>
                            <h6 class="box-subtitle mb-20">با ایجاد طرح‌بندی‌های پویاتر و قدرتمندتر با تبلت، از مثال قبلی استفاده کنید <code>.col-sm-*</code> classes.</h6>
                            <div class="row bg-light mb-10 p-10">
                    ...
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title mb-5">ستون پاسخگو بازنشانی می شود</h4>
                            <h6 class="box-subtitle mb-20">با چهار سطح شبکه‌های موجود، احتمالاً با مشکلاتی مواجه خواهید شد که در نقاط شکست خاص، ستون‌های شما کاملاً درست پاک نمی‌شوند، زیرا یکی از آنها بلندتر از دیگری است. برای رفع آن، از ترکیبی از <code>.clearfix</code> و کلاس‌های ابزار پاسخگو ما</h6> استفاده کنید.
                            <div class="row bg-light mb-10 p-10">
                    ...
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title mb-5">تنظیم ستون ها</h4>
                            <h6 class="box-subtitle mb-20">با استفاده از کلاس‌های <code>.offset-md--*</code>، ستون‌ها را به سمت راست حرکت دهید. این کلاس ها حاشیه سمت چپ یک ستون را با ستون های <code>*</code> افزایش می دهند. برای مثال، <code>.offset-md-4</code> <code>.col-md-4</code> را به چهار عدد منتقل می کند.
                                ستون ها.</h6>
                            <div class="row bg-light mb-10 p-10">
                                <div class="col-md-4">.col-md-4</div>
