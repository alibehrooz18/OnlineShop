...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">سرعت</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">افزونه</li>
                                        <li class="breadcrumb-item active" aria-current="page">سرعت</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            سرعت بارگذاری به طور خودکار در صفحه کار می کند. شما همچنان می توانید آن را با درخواست های ajax با افزودن این js پیاده سازی کنید:
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <button type="button" class="btn btn-info btn-rounded ajax" title="Ajax Request">
                                        <i class="fa fa-spin fa-refresh"></i>&nbsp; برو به محتوای خارجی
                                    </button>
                                </div>
                            </div>
    ...
    <script src="src\js\pages\pace.js"></script>
    <!-- CRMi App -->
