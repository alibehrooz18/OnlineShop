...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">تقویم</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">اپلیکیشن</li>
                                        <li class="breadcrumb-item active" aria-current="page">تقویم</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-12">
                            <div class="box no-border no-shadow">
                                <div class="box-header with-border">
                                    <h4 class="box-title">رخ دادها</h4>
                                </div>
                                <div class="box-body p-0">
                                    <!-- the events -->
                                    <div id="external-events">
                                        <div class="external-event m-15 bg-primary" data-class="bg-primary"><i class="fa fa-hand-o-right"></i>شروع</div>
                                        <div class="external-event m-15 bg-warning" data-class="bg-warning"><i class="fa fa-hand-o-right"></i>رفتن به خانه</div>
                                        <div class="external-event m-15 bg-info" data-class="bg-info"><i class="fa fa-hand-o-right"></i>انجام تکالیف</div>
                                        <div class="external-event m-15 bg-success" data-class="bg-success"><i class="fa fa-hand-o-right"></i> طراحی تم</div>
                                        <div class="external-event m-15 bg-danger" data-class="bg-danger"><i class="fa fa-hand-o-right"></i>خواب</div>
                                    </div>
                                    <div class="event-fc-bt mx-15 my-20">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-new-events" class="btn btn-success w-p100 my-10">
                                            <i class="ti-plus"></i> افزودن رویداد جدید
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><strong>ایجاد</strong> یک دسته بندی</h4>
                    ...
                    <div class="modal-body">
                        <form role="form">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">یک رنگ دسته انتخاب کنید</label>
                                    <select class="form-select form-white" data-placeholder="انتخاب رنگ دسته" name="category-color">
                                        <option value="success">ساکسس</option>
                                        <option value="danger">دنجر</option>
                                        <option value="info">اینفو</option>
                                        <option value="primary">پریمری</option>
                                        <option value="warning">وارنینگ</option>
                                        <option value="inverse">اینورس</option>
                                    </select>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success save-category" data-bs-dismiss="modal">ذخیره</button>
    ...
    <script src="src\js\pages\calendar.js"></script>
