            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">داشبورد پروژه</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">اکسترا</li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-4 connectedSortable">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">استایل 1</h4>
                                ...
                                <div class="box-body p-0">
                                    <ul class="todo-list">
                                        <li>
                                            ...
                                            <!-- todo text -->
                                            <span class="text-line">بررسی وضعیت بازار</span>
                                            <!-- Emphasis label -->
                                            <small class="badge bg-danger"><i class="fa fa-clock-o"></i> 2 دقیقه </small>
                                        ...
                                        <li>
                                            ...
                                            <span class="text-line">بررسی کارهای در دست انجام</span>
                                            <small class="badge bg-info"><i class="fa fa-clock-o"></i> 4 ساعت</small>
                                            <div class="tools">
                                                <i class="fa fa-edit"></i>
                                                <i class="fa fa-trash-o"></i>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <span class="text-line">سرعت اجرا</span>
                                            <small class="badge bg-warning"><i class="fa fa-clock-o"></i> 1 روز</small>
                                            <div class="tools">
                                                <i class="fa fa-edit"></i>
                                                <i class="fa fa-trash-o"></i>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <span class="text-line">فعالیت های سازمانی</span>
                                            <small class="badge bg-success"><i class="fa fa-clock-o"></i> 3 روز</small>
                                            <div class="tools">
                                                <i class="fa fa-edit"></i>
                                                <i class="fa fa-trash-o"></i>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <span class="text-line">پیام رسانی</span>
                                            <small class="badge bg-primary"><i class="fa fa-clock-o"></i> 1 هفته</small>
                                            <div class="tools">
                                                <i class="fa fa-edit"></i>
                                                <i class="fa fa-trash-o"></i>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <span class="text-line">وضعیت کارکنان</span>
                                            <small class="badge bg-info"><i class="fa fa-clock-o"></i> 1 ماه</small>
                                            <div class="tools">
                                                <i class="fa fa-edit"></i>
                                                <i class="fa fa-trash-o"></i>
                                            </div>
                        ...
                        <div class="col-xl-4 connectedSortable">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">استایل 2</h4>
                                    ...
                                    <ul class="todo-list">
                                        <li class="p-15">
                                            <div class="box p-15 mb-0 d-block bb-2 border-danger">
                                                ...
                                                <span class="pull-right badge badge-danger">تکمیلی</span>
                                                <span class="fs-18 text-line"><a href="">بررسی وضعیت بازار</a> </span>
                                                <ul class="list-inline mb-0 mt-15 ms-30">
                                                    <li>
                                                        <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="نام کاربری">
                                                            <img src="images\avatar\1.jpg" alt="img" class="avatar avatar-sm">
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="5 کار">
                                                            <i class="mdi mdi-format-align-left"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="3 کامنت">
                                        ...
                                        <li class="p-15">
                                            <div class="box p-15 mb-0 d-block bb-2 border-warning">
                                                ...
                                                <span class="pull-right badge badge-warning">بالا</span>
                                                <span class="fs-18 text-line"><a href="">پیام رسانی</a> </span>
                                                <ul class="list-inline mb-0 mt-15 ms-30">
                                                    <li>
                                                        <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="نام کاربری">
                                        ...
                                        <li class="p-15">
                                            <div class="box p-15 mb-0 d-block bb-2 border-secondary">
                                                ...
                                                <span class="fs-18 text-line"><a href="">وضعیت کارکنان</a> </span>
                                                <ul class="list-inline mb-0 mt-15 ms-30">
                                                    <li>
                                                        <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="نام کاربری">
                        ...
                        <div class="col-xl-4 connectedSortable">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">استایل 3</h4>
                                    ...
                                    <ul class="todo-list">
                                        <li class="bg-light p-0 mb-15">
                                            <div class="position-relative p-20">
                                                ...
                                                <!-- todo text -->
                                                <span class="text-line fs-18">بررسی کارهای در دست انجام</span>
                                                <!-- General tools such as edit or delete-->
                                                <div class="pull-right d-block text-dark flexbox">
                                                    <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="ویرایش"><i class="fa fa-edit"></i></a>
                                                    <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="حذف"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                                <div class="mt-5 ms-50 ps-5">توضیحات تکمیلی بصورد خلاصه</div>
                                                <div class="mt-5 ms-50 ps-5"><em>1402/02/12</em></div>
                                            </div>
                                        </li>
                                        <li class="bg-light p-0 mb-15">
                                            <div class="position-relative p-20">
                                                ...
                                                <!-- todo text -->
                                                <span class="text-line fs-18">تعمییرات طبقه همکف</span>
                                                <!-- General tools such as edit or delete-->
                                                <div class="pull-right d-block text-dark flexbox">
                                                    <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="ویرایش"><i class="fa fa-edit"></i></a>
                                                    <a href="" data-bs-toggle="tooltip" data-container="body" title="" data-bs-original-title="حذف"><i class="fa fa-trash-o"></i></a>
                        ...
                        <div class="col-xl-4 connectedSortable">
                            <div class="box box-solid box-primary">
                                <div class="box-header with-border">
                                    <h4 class="box-title">درحال اجرا</h4>
                        ...
                        <div class="col-xl-4 connectedSortable">
                            <div class="box box-solid box-warning">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نیمه کاره</h4>
                                    <ul class="box-controls pull-right">
                                        <li><a class="box-btn-close" href="#"></a></li>
                                        <li><a class="box-btn-slide" href="#"></a></li>
                                        <li><a class="box-btn-fullscreen" href="#"></a></li>
                        ...
                        <div class="col-xl-4 connectedSortable">
                            <div class="box box-solid box-success">
                                <div class="box-header with-border">
                                    <h4 class="box-title">کامل شده</h4>
                                    <ul class="box-controls pull-right">
                                        <li><a class="box-btn-close" href="#"></a></li>
                                        <li><a class="box-btn-slide" href="#"></a></li>
                                        <li><a class="box-btn-fullscreen" href="#"></a></li>
