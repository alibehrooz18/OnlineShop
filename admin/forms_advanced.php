...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_plugins\timepicker\bootstrap-timepicker.min.css">
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">اجزا ی پیشرفته فرم ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">اجزا ی پیشرفته فرم ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-header">
                                    <h4 class="box-title">نوع آپشن</h4>
                                </div>
                                <div class="box-body">
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">تاریخ و زمان</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="datetime-local" name="datetime">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="datetime-local"</code> <code> type="datetime-local" is not supported in Firefox, Safari or Internet Explorer 12 (or earlier).</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">تاریخ</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="date" name="date">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="date"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">ماه</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="month" name="month">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="month"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">زمان</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="time" name="time">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="time"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">هفته</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="week" name="week">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="week"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">عدد</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="number" name="number">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="number"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">ایمیل</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="email" name="email">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="email"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">URLآدرس </label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="url" name="url">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="url"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">جستجو</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="search" name="search">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="search"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">تلفن</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="tel" name="tel">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="tel"</code></span>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-form-label col-md-2">رنگ</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="color" name="color">
                                            <span class="form-text text-muted">استفاده کنید از <code>input type="color"</code></span>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                ...
                                <div class="box-header">
                                    <h4 class="box-title">فیلد فایل ساده</h4>
                                </div>
                                <div class="box-body">
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">پیش فرض</label>
                                        <input class="form-control" type="file" id="formFile">
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFileMultiple" class="form-label">چندتایی</label>
                                        <input class="form-control" type="file" id="formFileMultiple" multiple="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFileDisabled" class="form-label">دیسبل</label>
                                        <input class="form-control" type="file" id="formFileDisabled" disabled="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFileSm" class="form-label">نمونه فیلد کوچک</label>
                                        <input class="form-control form-control-sm" id="formFileSm" type="file">
                                    </div>
                                    <div>
                                        <label for="formFileLg" class="form-label">نمونه فیلد بزرگ</label>
                                        <input class="form-control form-control-lg" id="formFileLg" type="file">
                                    </div>
                                </div>

                                <div class="box-header">
                                    <h4 class="box-title">فیلد سفارشی</h4>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="input-group mb-3">
                                        <button class="btn btn-secondary btn-sm" type="button" id="inputGroupFileAddon03">دکمه</button>
                                        <input type="file" class="form-control" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                                    </div>

                                    <div class="input-group">
                                        <input type="file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                                        <button class="btn btn-secondary btn-sm" type="button" id="inputGroupFileAddon04">دکمه</button>
                                    </div>
                                </div>

                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">فیلد ماسک</h4>
                                </div>
                                <div class="box-body">
                                    <!-- Date dd/mm/yyyy -->
                                    ...
                                    <!-- IP mask -->
                                    <div class="form-group">
                                        <label class="form-label">IP فیلد:</label>
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">رنک و تایم پیکر</h4>
                                </div>
                                <div class="box-body">
                                    <!-- Color Picker -->
                                    <div class="form-group">
                                        <label class="form-label">انتخابگر رنگ:</label>
                                    ...
                                    <div class="bootstrap-timepicker">
                                        <div class="form-group">
                                            <label class="form-label">تایم پیکر:</label>
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">انتخابگر تاریخ</h4>
                                </div>
                                <div class="box-body">
                                    <!-- Date -->
                                    <div class="form-group">
                                    ...
                                    <!-- Date range -->
                                    <div class="form-group">
                                        <label class="form-label">رنج تاریخ:</label>
                                    ...
                                    <!-- Date and time range -->
                                    <div class="form-group">
                                        <label class="form-label">رنج تاریخ و زمان:</label>

                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-clock-o"></i>
                                            </div>
                                            <input type="text" class="form-control pull-right" name="tarikh" id="reservationtime">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <!-- /.form group -->
                                    ...
                                    <!-- Date and time range -->
                                    <div class="form-group">
                                        <label class="form-label">دکمه رنج تاریخ:</label>

                                        <div class="input-group">
                                            <button type="button" class="btn btn-default pull-right" id="daterange-btn">
                                                <span>
                                                    <i class="fa fa-calendar"></i> انتخابگر تاریخ
                                                </span>
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">انتخاب کنید</h4>
                                ...
                                <div class="box-body pb-0">
                                    <div class="row">
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                <label class="form-label">کوچک</label>
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                <label class="form-label">چندتایی</label>
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                <label class="form-label">ترکیبی</label>
                                                <select class="form-control select2" style="width: 100%;">
                                                    <option selected="selected">تهران</option>
                                                    <option>خرم آباد</option>
                                                    <option disabled="disabled">سنندج (disabled)</option>
                                                    <option>مشهد </option>
                                                    <option>اصفهان</option>
                                                    <option>تبریز</option>
                                                    <option>همدان</option>
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">بوت استرپ سلکت</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="my-10">انتخاب کنید</h5>
                                        ...
                                        <div class="col-md-4">
                                            <h5 class="my-10">انتخاب چند گزینه ای</h5>
                                            <select class="selectpicker">
                                                <optgroup label="">
                                                    <option>داده اول</option>
                                                    <option>داده دوم</option>
                                                    <option>داده سوم</option>
                                                </optgroup>
                                                <optgroup label="">
                                                    <option>داده اول</option>
                                                    <option>داده دوم</option>
                                        ...
                                        <div class="col-md-4">
                                            <h5 class="my-10">انتخاب چند تایی</h5>
                                    ...
                                    <h5 class="my-10">با کلاس دکمه های رنگی</h5>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <select class="selectpicker mb-20 me-10" data-style="btn-primary">
                                                <option data-tokens="Lorem">متن و یا داده های تست</option>
                                                <option data-tokens="ipsum">توضیحات تستی .</option>
                                                <option data-tokens="dolor">توضیحات تکمیلی .</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">بوت استرپ تاچ اسپین</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form class="pe-20">
                                                <div class="form-group">
                                                    <label class="form-label">عمودی</label>
                                                    <input class="vertical-spin" type="text" data-bts-button-down-class="btn btn-secondary" data-bts-button-up-class="btn btn-secondary" value="" name="vertical-spin">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">پیشوندی</label>
                                                    <input id="demo1" type="text" value="55" name="demo1" data-bts-button-down-class="btn btn-secondary" data-bts-button-up-class="btn btn-secondary">
                                                </div>
                                                <div class="form-group mb-0">
                                                    <label class="form-label">پیشوندی</label>
                                                    <input id="demo2" type="text" value="0" name="demo2" class=" form-control" data-bts-button-down-class="btn btn-secondary" data-bts-button-up-class="btn btn-secondary">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label">مقدار ست شده 30 </label>
                                                    <input id="demo3_1" type="text" value="30" name="demo3_1" data-bts-button-down-class="btn btn-secondary" data-bts-button-up-class="btn btn-secondary">
                                                </div>
                                                <div class="form-group mb-0">
                                                    <label class="form-label">دکمه های گروهی</label>
                                                    <div class="input-group">
                                ...
                                <!-- /.box-body -->
                                <div class="box-header with-border">
                                    <h4 class="box-title">فیلد های تگ</h4>
                                </div>
                                <div class="box-body">
                                    <h6 class="box-subtitle d-block mb-10">اضافه کنید <code>data-role="tagsinput"</code> تگ ها را و همچنین میتوانید براحتی عوض کنید.</h6>
                                    <div class="tags-default">
                                        <input type="text" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="تگ را اضافه کنید">
                                    </div>
                                    <h5 class="box-title mt-20">انتخاب تگ</h5>
                                    <h6 class="box-subtitle d-block mb-10">شما میتوانید <code>انتخاب چند تایی</code> را در فیلدها داشته باشید</h6>
                                    <select multiple="" data-role="tagsinput">
                                        <option value="Lorem">داده 1</option>
                                        <option value="Ipsum">داده 2</option>
                                        <option value="Amet">داده 3گکککککلبشششششششش</option>
                                    </select>
                                    <h5 class="box-title  mt-20 d-block mb-10">فیلدهای گروهی تگ</h5>
                                    <h6 class="box-subtitle d-block mb-10">میتوانید از گروهی از تگ ها <code>data-role="tagsinput"</code> در فیلد استفاده کنید.</h6>
                                    <div class="input-group">
                                        <input type="text" value="Lorem,Ipsum,Amet" data-role="tagsinput" placeholder="تگ را اضافه کنید"> <span class="input-group-addon">تگ ها</span>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">چک باکس های ساده</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">

                                    <div class="demo-checkbox">
                                        <input type="checkbox" id="basic_checkbox_133" checked="">
                                        <label for="basic_checkbox_133">Default</label>
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">چک باکس های ساده رنگی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">چک باکس های رنگی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">دکمه های ریدیو</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title"> دکمه ریدیو رنگی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">دکمه های توخالی ریدیو</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
    ...
    <script src="assets\vendor_plugins\timepicker\bootstrap-timepicker.min.js"></script>
