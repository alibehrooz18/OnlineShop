...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">کد ادیتور</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">کد ادیتور</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Ace ادیتور (Javascript)</h4>
                            <h6 class="box-subtitle">برای اطلاعات بیشتر بازدید کنید از <a href="https://github.com/ajaxorg/ace-builds" target="_blank">وبسایت رسمی </a></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
	...
	console.log(addResult);
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Ace ادیتور (Html Mode And Emmet)</h4>
                            <h6 class="box-subtitle">برای اطلاعات بیشتر بازدید کنید از <a href="https://github.com/ajaxorg/ace-builds" target="_blank">وبسایت رسمی </a></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">

                            <pre class="ace-editor" id="editorHTML" data-plugin="ace" data-mode="html" style="width: 100%;">&lt;!--
	...
	* language modes and 24 color themes!
	...
	&lt;/html>
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Ace ادیتور (Css Editor)</h4>
                            <h6 class="box-subtitle">برای اطلاعات بیشتر بازدید کنید از <a href="https://github.com/ajaxorg/ace-builds" target="_blank">وبسایت رسمی </a></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
    ...
    <script src="src\js\pages\form-code-editor.js"></script>
    <!-- CRMi App -->
