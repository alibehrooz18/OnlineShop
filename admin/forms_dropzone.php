            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">اجزای پیشرفته فرم ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">اجزای پیشرفته فرم ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">دراپ زون</h4>
                            <h6 class="box-subtitle">برای آپلود چند فایل، کلاس <code>.dropzone</code> را در فرم قرار دهید.</h6>
                        </div>
                        <div class="box-body">
