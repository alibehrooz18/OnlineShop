            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">مارک دان</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">مارک دان</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">ویرایشگر استاندارد</h4>
                                    <h6 class="box-subtitle">برای اطلاعات بیشتر بازدید کنید از <a href="https://github.com/toopay/bootstrap-markdown" target="_blank">وبسایت رسمی </a></h6>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">

                                    <p>
                                        <strong>بوت استرپ مارک دان</strong> طراحی شده تا به راحتی با پروژه بوت استرپ شما ادغام شود. API مفیدی را نشان می دهد که به شما امکان می دهد به طور کامل به افزونه
                                    </p> متصل شوید
                                    <div class="example">
                                        <form>
                                            <textarea name="content" data-provide="markdown" data-iconlibrary="fa" rows="11">### هدر را اینجا قراردهید
		توضیحات و متن تست <u>ورزش</u> متن بیشتر و ادامه توضیحات.
			* متن را در اینجا فهرست کنید
* متن را در اینجا فهرست کنید
* 1. متن را در اینجا فهرست کنید
2. متن را در اینجا فهرست کنید
3. متن را در اینجا فهرست کنید
* متن را در اینجا فهرست کنید
#### عنوان
			متن بیشتر و ادامه توضیحات.(http://www.github.com)(http://www.github.com)</textarea>
                                        </form>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">ویرایش خطی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <p>ویرایش درون خطی با
                                        <strong>بوت استرپ مارک دان</strong> با افزودن ویژگی <code class="prettyprint">data-provide=&quot;markdown-editable&quot;</code> انجام می شود
                                    </p>
                                    <div class="example">
                                        <div data-provide="markdown-editable" data-iconlibrary="fa">
                                            <h3>هدر را قرار دهید</h3>
                                            <p>متن تست,
                                                <strong><b>توضیحات</b></strong>ادامه توضیحات <u>تمرین</u> بررسی بیشتر
                                            </p>
                                            ...
                                            <h4>عنوان</h4>
                                            <p>ادامه توضیحات <a href="http://www.github.com">لینک</a>(http://www.github.com)</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نمونه ها</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form>
                                        <p>عرض سفارشی با استفاده از ویژگی <code>data-width="400"</code></p>
                        ...
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form>
                                        <p>دکمه‌های پنهان با استفاده از ویژگی <code>data-hidden-buttons="cmdBold"</code></p>
                                        <div class="example">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form>
                                        <p>قابل پنهان شدن در حالت تاری با استفاده از ویژگی <code>data-hideable="true"</code></p>
                                        <div class="example">
                        ...
                        <div class="col-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form>
                                        <p>قابل ذخیره با استفاده از ویژگی <code>data-savable="true"</code></p>
                                        <div class="example">
    ...
    <script src="assets\vendor_components\to-markdown\to-markdown.js"></script>
