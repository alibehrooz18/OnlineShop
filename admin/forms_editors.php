...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\easymde\easymde.min.css">
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="form-group">
                                ...
                                <textarea name="introduction" id="introduction" name="introduction" class="form-control form-control-sm" rows="6"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">ویرایشگر TinyMCE</h4>
                                    <p class="text-muted mb-3">برای لیست دستورالعمل ها و گزینه های دیگر <a href="https://www.tiny.cloud/docs" target="_blank"> اسناد رسمی TinyMCE </a> را بخوانید.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">ویرایشگر EasyMDE</h4>
                                    <p class="text-muted mb-3">برای لیست دستورالعمل ها و گزینه های دیگر <a href="https://easy-markdown-editor.tk/" target="_blank"> اسناد رسمی EasyMDE </a> را بخوانید.</p>
    ...
    <script src="assets\vendor_components\tinymce-rtl\tinymce.min.js"></script>

    <script src="assets\vendor_components\easymde\easymde.min.js"></script>
    <!-- Vendor JS -->
    <script src="src\js\vendors.min.js"></script>

    <script src="assets\icons\feather-icons\feather.min.js"></script>
    <script src="src\js\tinymce.js"></script>
