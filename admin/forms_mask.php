...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">فرم ماسک</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">فرم ماسک</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header no-border">
                            <h4 class="box-title">فرمت کننده</h4>
                            <h6 class="subtitle">طبق فرمت زیر کاربرمیتواند استفاده کند<br>
                                <a class="fs-12" href="http://firstopinion.github.io/formatter.js/" target="_blank">مستندات رسمی</a>
                            </h6>
                        </div>
                        <!-- /.box-header -->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="form-label">تاریخ 2</label>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <small class="sidetitle">مثال (123) 456-7890</small>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <small class="sidetitle">مثال +1 123-456-7890</small>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <small class="sidetitle">8 کاراکتر</small>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <small class="sidetitle">88.000</small>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="form-label">کارت اعتباری</label>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="form-label">ش کارت</label>
                                        <small class="sidetitle">مثال. 123-45-6789</small>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <small class="sidetitle">مثال 123 4567</small>
    ...
    <script src="src\js\pages\formatter.js"></script>
