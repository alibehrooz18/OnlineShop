            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">فرم اعتبارسنجی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">فرم اعتبارسنجی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">فرم اعتبارسنجی</h4>
                            <h6 class="box-subtitle"> برای اطلاعات بیشتر<a class="text-warning" href="http://reactiveraven.github.io/jqBootstrapValidation/">وبسایت رسمی را بازدید نمائید </a></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col">
                                    <form novalidate="">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <h5>فیلد متن ساده <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="text" class="form-control" required="" data-validation-required-message="This field is required">
                                                    </div>
                                                    <div class="form-control-feedback"><small>اضافه کنید <code>required</code> را به اعتبار سنجی.</small></div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد ایمیل <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="email" name="email" class="form-control" required="" data-validation-required-message="This field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد پسوورد <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="password" name="password" class="form-control" required="" data-validation-required-message="This field is required">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد تائید پسوورد <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="password" name="password2" data-validation-match-match="password" class="form-control" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد آپلود <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="file" name="file" class="form-control" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد با آیکون<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="راست چین" data-validation-required-message="This field is required">
                                                            <span class="input-group-addon" id="basic-addon1"><i class="fa fa-dollar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>حداکثر تعداد کاراکتر <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                    ...
                                                    <div class="form-control-feedback"><small>اضافه کنید<code>maxlength='10'</code>زا به فیلد. </small></div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>حداقل تعداد کاراکتر <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                    ...
                                                    <div class="form-control-feedback"><small>اضافه کنید <code>minlength="6"</code> را به فیلد.</small></div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فقط اعداد <span class="text-danger">*</span></h5>
                                                ...
                                                <div class="form-group">
                                                    <h5>حداکثر تعداد <span class="text-danger">*</span></h5>
                                                    ...
                                                    <div class="form-control-feedback">
                                                        <small><i>باید کمتر باشد از 25</i></small> - <small>اضافه کنید<code>max</code> حداکثر تعداد قابل قبول <code>data-validation-max-message</code> در فیلد قبول باشد </small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <h5>کمترین تعداد <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="number" name="minNum" class="form-control" required="" data-validation-required-message="This field is required" min="10">
                                                    </div>
                                                    <div class="form-control-feedback">
                                                        <small><i>کمتر باشد از 10</i></small> - <small>اضافه کنید <code>min</code> تعداد قابل <code>data-validation-min-message</code> که فیلد قبول کند</small>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد متن رنج <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="text" class="form-control" required="" data-validation-required-message="This field is required" minlength="10" maxlength="20" placeholder="بین  10 &amp; 20">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فیلد با دکمه <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" placeholder="جستجو" required="">
                                                            <button class="btn btn-info btn-sm" type="button">برو!</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>فقط عدد <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                ...
                                                <div class="form-group">
                                                    <h5>الگو <span class="text-danger">*</span> <small><i>شروع از 'a' پایان تا 'z'</i></small></h5>
                                                    <div class="controls">
                                                        ...
                                                        <div class="form-control-feedback">
                                                            <small>اضافه کنید <code>الگو</code> را در استفاده <code>data-validation-pattern-message</code> متن الگو عنوان شده</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>آدرس URL <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="آدرس URL" data-validation-regex-regex="((http[s]?|ftp[s]?):\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*" data-validation-regex-message="Only Valid URL's">
                                                        <div class="form-control-feedback">
                                                            <small>اضافه کنید <code>data-validation-regex-regex</code> اتریبوت را <code>data-validation-regex-message</code> برای اعتبارسنجی</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>ایمیل آدرس<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="ایمیل" data-validation-regex-regex="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" data-validation-regex-message="Enter Valid Email">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>داده را وارد کنید <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="date" name="date" class="form-control" required="" data-validation-required-message="This field is required">
                                                    </div>
                                                    <div class="form-control-feedback">
                                                        <small>اضافه کنید <code>required</code> را برای اعتبار سنجی.</small>
                                                    </div>

                                                </div>
                                                <div class="form-group">
                                                    <h5>انتخاب ساده <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <select name="select" id="select" required="" class="form-select">
                                                            <option value="">شهرتان را انتخاب کنید</option>
                                                            <option value="1">تهران</option>
                                                            <option value="2">سقز</option>
                                                ...
                                                <div class="form-group">
                                                    <h5>تکست ارا <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <textarea name="textarea" id="textarea" class="form-control" required="" placeholder="تکست ارا"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>چک باکس <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="checkbox" id="checkbox_1" value="single">
                                                        <label for="checkbox_1">چک کنید</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>چک باکس گروهی <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_2" value="x">
                                                            <label for="checkbox_2">چک کردم</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_3" value="y">
                                                            <label for="checkbox_3">چک نکردم</label>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>بیشتر از 2 تا انتخاب کنید<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_4">چک نکرد</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_5">چک کردم</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_6">چک کنید</label>
                                                        </fieldset>
                                                    </div>
                                                    <small>2 گزینه انتخاب کنید</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>انتخاب دو تایی<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_7">چک کردم</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_8">چک میکنم</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <label for="checkbox_9">چک کنید</label>
                                                        </fieldset>
                                                    </div>
                                                    <small>انتخاب دو گزینه ای</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
