            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">فرم ویزارد</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فرم ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">فرم ویزارد</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">عضویت کاربران</h4>
                            <h6 class="box-subtitle">مستندات کامل را<a href="http://www.jquery-steps.com" target="_blank"> بررسی کنید</a></h6>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <form action="#" class="tab-wizard wizard-circle">
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="firstName5" class="form-label">نام:</label>
                                                <input type="text" class="form-control" id="firstName5">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="lastName1" class="form-label">فامیلی :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="emailAddress1" class="form-label">ایمیل :</label>
                                                <input type="email" class="form-control" id="emailAddress1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="phoneNumber1" class="form-label">موبایل :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="addressline1" class="form-label">ادرس :</label>
                                                <input type="text" class="form-control" id="addressline1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="addressline2" class="form-label">ادرس دیگر :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="location3" class="form-label">انتخاب شهر :</label>
                                                <select class="form-select" id="location3" name="location">
                                                    <option value="">انتخاب شهر</option>
                                                    <option value="Amsterdam">تهران</option>
                                                    <option value="Berlin">اصفهان</option>
                                                    <option value="Frankfurt">سقز</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date1" class="form-label">تاریخ تولد :</label>
                                ...
                                <!-- Step 2 -->
                                <h6>راه اندازی حساب</h6>
                                <section>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="url123" class="form-label">ادرس :</label>
                                                <input type="url" class="form-control" id="url123" placeholder="http://">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="username123" class="form-label">نام کاربری :</label>
                                                <input type="text" class="form-control" id="username123">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="password123" class="form-label">پسوورد :</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    ...
                                                    <label for="radio_123" class="d-block">فروشندگان</label>
                                                    <input name="group456" type="radio" id="radio_456" value="1">
                                                    <label for="radio_456">مشتریان</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="int123" class="form-label">نام دارنده کارت :</label>
                                                <input type="text" class="form-control" id="int123">
                                            </div>
                                            <div class="form-group">
                                                <label for="int234" class="form-label">شماره کارت :</label>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <label for="intType1" class="form-label">ماه انقضا :</label>
                                                        <select class="form-select" id="intType1" data-placeholder="Exp Month" name="intType1">
                                                            <option value="">انتخاب</option>
                                                            <option value="۰۱">۰۱</option>
                                                            <option value="۰۲">۰۲</option>
                                                            <option value="۰۳">۰۳</option>
                                                            <option value="۰۴" selected="">۰۴</option>
                                                            <option value="۰۵">۰۵</option>
                                                            <option value="۰۶">۰۶</option>
                                                            <option value="۰۷">۰۷</option>
                                                            <option value="۰۸">۰۸</option>
                                                            <option value="۰۹">۰۹</option>
                                                    ...
                                                    <div class="col-4">
                                                        <label for="intType1" class="form-label">سال انقضا :</label>
                                                        <select class="form-select" id="intType12" data-placeholder="Exp Year" name="intType12">
                                                            <option value="">انتخاب</option>
                                                            <option value="۲۰۱۸">۲۰۱۸</option>
                                                            <option value="۲۰۱۹">۲۰۱۹</option>
                                                            <option value="۲۰۲۰">۲۰۲۰</option>
                                                            <option value="۲۰۲۱" selected="">۲۰۲۱</option>
                                                            <option value="۲۰۲۲">۲۰۲۲</option>
                                                            <option value="۲۰۲۳">۲۰۲۳</option>
                                                            <option value="۲۰۲۴">۲۰۲۴</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-4">
                                                        <label for="intType1" class="form-label">CVV :</label>
                                                        <input type="number" class="form-control" name="billing_card_cvv" placeholder="" value="790">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="addressline12" class="form-label">ادرس :</label>
                                                <input type="text" class="form-control" id="addressline12">
                                            </div>

                                            <div class="form-group">
                                                <label for="addressline13" class="form-label">ادرس دیگر:</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="c-inputs-stacked">
                                                    ...
                                                    <label for="radio_1" class="d-block">معمولی</label>
                                                    <input name="group1" type="radio" id="radio_2" value="1">
                                                    <label for="radio_2">سریع</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="decisions1" class="form-label">کامنت ها</label>
                                                <textarea name="decisions" id="decisions1" rows="4" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkbox_1">
                                                    <label for="checkbox_1" class="d-block">اینجا را کلیک کنید تا نشان دهید که شرایط ارائه شده در توافقنامه شرایط و ضوابط را خوانده اید و با آن موافق هستید</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">ویزارد مرحله ای</h4>
                            <h6 class="box-subtitle">مستندات کامل را <a href="http://www.jquery-steps.com" target="_blank">بررسی کنید</a></h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body wizard-content">
                            <form action="#" class="tab-wizard vertical wizard-circle">
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="firstName1" class="form-label">نام :</label>
                                                <input type="text" class="form-control" id="firstName1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="lastName2" class="form-label">فامیلی :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="emailAddress2" class="form-label">ایمیل :</label>
                                                <input type="email" class="form-control" id="emailAddress2">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="phoneNumber2" class="form-label">موبایل :</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date2" class="form-label">تاریخ تولد :</label>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="jobTitle6" class="form-label">عنوان شغل :</label>
                                                <input type="text" class="form-control" id="jobTitle6">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="videoUrl2" class="form-label">نام شرکت :</label>
                                                <input type="text" class="form-control" id="videoUrl2">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="shortDescription2" class="form-label">توضیحات شغل:</label>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="int2" class="form-label">مصاحبه برای :</label>
                                                <input type="text" class="form-control" id="int2">
                                            </div>
                                            <div class="form-group">
                                                <label for="intType3" class="form-label">سطح مصاحبه :</label>
                                                <select class="form-select" id="intType3" data-placeholder="Type to search cities" name="intType3">
                                                    <option value="Banquet">نرمال</option>
                                                    <option value="Fund Raiser">متوسط</option>
                                                    <option value="Dinner Party">سخت</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="location3" class="form-label">انتخاب شهر :</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="jobTitle5" class="form-label">تاریخ مصاحبه :</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="radio_5" class="d-block">کارمندان</label>
                                                <input name="group3" type="radio" id="radio_6" value="1">
                                                <label for="radio_6">قرارداد</label>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="behName2" class="form-label">رفتار :</label>
                                                <input type="text" class="form-control" id="behName2">
                                            </div>
                                            <div class="form-group">
                                                <label for="participants5" class="form-label">اعتماد</label>
                                                <input type="text" class="form-control" id="participants5">
                                            </div>
                                            <div class="form-group">
                                                <label for="participants4" class="form-label">نتیجه</label>
                                                <select class="form-select required" id="participants4" name="location">
                                                    ...
                                                    <option value="Call Second-time">مرحله دوم</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="decisions3" class="form-label">کامنت ها</label>
                                                <textarea name="decisions" id="decisions3" rows="4" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">به مصاحبه گر امتیاز دهید :</label>
                                                <div class="c-inputs-stacked">
                                                    <input type="checkbox" id="checkbox_6">
                                                    <label for="checkbox_6" class="d-block">۱ ستاره</label>
                                                    <input type="checkbox" id="checkbox_7">
                                                    <label for="checkbox_7" class="d-block">۲ ستاره</label>
                                                    <input type="checkbox" id="checkbox_8">
                                                    <label for="checkbox_8" class="d-block">۳ ستاره</label>
                                                    <input type="checkbox" id="checkbox_9">
                                                    <label for="checkbox_9" class="d-block">۴ ستاره</label>
                                                    <input type="checkbox" id="checkbox_10">
                                                    <label for="checkbox_10" class="d-block">۵ ستاره</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">ویزارد مرحله با اعتبارسنجی</h4>
                            <h6 class="box-subtitle">شما می توانید اعتبارسنجی را مانند آنچه ما انجام دادیم برای ما انجام دهید</h6>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body wizard-content">
                            <form action="#" class="validation-wizard wizard-circle">
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wfirstName2" class="form-label"> نام : <span class="danger">*</span> </label>
                                                <input type="text" class="form-control required" id="wfirstName2" name="firstName">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wlastName2" class="form-label"> فامیلی : <span class="danger">*</span> </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wemailAddress2" class="form-label"> ایمیل : <span class="danger">*</span> </label>
                                                <input type="email" class="form-control required" id="wemailAddress2" name="emailAddress">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wphoneNumber2" class="form-label">موبایل :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wlocation2" class="form-label"> انتخاب شهر : <span class="danger">*</span> </label>
                                                <select class="form-select required" id="wlocation2" name="location">
                                                    <option value="">انتخاب شهر</option>
                                                    <option value="India">شیراز</option>
                                                    <option value="USA">تبریز</option>
                                                    <option value="Dubai">سنندج</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wdate2" class="form-label">تاریخ تولد :</label>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="jobTitle3" class="form-label">شرکت :</label>
                                                <input type="text" class="form-control required" id="jobTitle3">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="webUrl3" class="form-label">ادرس شرکت :</label>
                                                <input type="url" class="form-control required" id="webUrl3" name="webUrl3">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="shortDescription3" class="form-label">توضیحات کوتاه :</label>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="wint1" class="form-label">مصاحبه برای :</label>
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="behName3" class="form-label">رفتارها :</label>
                                                <input type="text" class="form-control required" id="behName3">
                                            </div>
                                            <div class="form-group">
                                                <label for="participants3" class="form-label">اطمینان</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="decisions2" class="form-label">کامنت ها</label>
