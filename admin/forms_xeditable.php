...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
                        ...
                        <div class="col">
                            <div class="box">
                                <div class="box-header with-border">
                                    ...
                                    <h6 class="box-subtitle">ویرایشگر خطی</h6>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="d-lg-flex d-block align-items-center">
                                        <div class="my-3 min-w-lg-350">فیلد متنی تست</div>
                                        <div class="my-3"><a href="#" id="inline-username" data-type="text" data-pk="1" data-title="نام کاربری را وارد کنید">کاربر ویژه</a></div>
                                    </div>

                                    <div class="d-lg-flex d-block align-items-center mt-lg-0 mt-30">
                                        <div class="my-3 min-w-lg-350">فیلد متن خالی، لازم است</div>
                                        <div class="my-3"><a href="#" id="inline-firstname" data-type="text" data-pk="1" data-placement="right" data-placeholder="ضروری" data-title="نام خود را بنویسید"></a></div>
                                    </div>

                                    <div class="d-lg-flex d-block align-items-center mt-lg-0 mt-30">
                                        <div class="my-3 min-w-lg-350">انتخاب، آرایه محلی، نمایش سفارشی</div>
                                        <div class="my-3"><a href="#" id="inline-sex" data-type="select" data-pk="1" data-value="" data-title="Select sex"></a></div>
                                    </div>

                                    <div class="d-lg-flex d-block align-items-center mt-lg-0 mt-30">
                                        <div class="my-3 min-w-lg-350">انتخاب کنید، هنگام بارگیری خطا می کند</div>
                                        <div class="my-3"><a href="#" id="inline-status" data-type="select" data-pk="1" data-value="0" data-source="/status" data-title="Select status">فعال</a></div>
                                    </div>

                                    <div class="d-lg-flex d-block align-items-center mt-lg-0 mt-30">
                                        <div class="my-3 min-w-lg-350">ترکیب کردن</div>
                                    ...
                                    <div class="d-lg-flex d-block align-items-center mt-lg-0 mt-30">
                                        <div class="my-3 min-w-lg-350">تکست ارا با دکمه زیرین</div>
                                        <div class="my-3"><a href="#" id="inline-comments" data-type="textarea" data-pk="1" data-placeholder="دیدگاه تان را بنویسید.." data-title="کامنت بگذارید">هر کاربری!</a></div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="src\js\pages\form-x-editable.js"></script>
