            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">آیکون های پرچم</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">آیکون ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">آیکون های پرچم</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-body">
                            <h4 class="box-title">آیکون های پرچم</h4>
                            <h6 class="box-subtitle mb-15">شما میتوانید برای استفاده از آیکون ها از این کلاس ها استفاده کنید <code>flag-icon flag-icon-us</code></h6>
