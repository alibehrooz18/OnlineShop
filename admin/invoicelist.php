            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">لیست صورتحساب ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">فاکتور</li>
                                        <li class="breadcrumb-item active" aria-current="page">لیست صورتحساب ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-10 col-lg-9 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">لیست صورتحساب ها</h4>
                                    <h6 class="box-subtitle">فاکتور را بصورت Copy, CSV, Excel, PDF & Printاکسپورت کنید</h6>
                                </div>
                                <div class="box-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <a href="#">مختار</a>
                                                            <span class="d-block text-muted">روش پرداخت: درگاه بانک</span>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <select name="status" class="form-select" data-placeholder="Select status">
                                                            <option value="overdue">نقدی</option>
                                                            <option value="hold" selected="">در انتظار</option>
                                                            <option value="pending">درحال پرداخت</option>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-success">پرداخت شده در اسفند1401</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">36,890 <span class="d-block text-muted fw-normal"> تومان4,859</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            ...
                                                            <div class="list-icons-item dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <a href="#" class="dropdown-item"><i class="fa fa-download"></i> دانلود</a>
                                                                    <a href="#" class="dropdown-item"><i class="fa fa-print"></i>پرینت</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a href="#" class="dropdown-item"><i class="fa fa-pencil"></i> ویرایش</a>
                                                                    <a href="#" class="dropdown-item"><i class="fa fa-remove"></i> حذف</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <a href="#">مسعود</a>
                                                            <span class="d-block text-muted">روش پرداخت: انتقال</span>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <select name="status" class="form-select" data-placeholder="Select status">
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-warning">5 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">8,854 <span class="d-block text-muted fw-normal"> تومان4,785</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <a href="#">حامد</a>
                                                            <span class="d-block text-muted">روش پرداخت: اقساطی</span>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <select name="status" class="form-select" data-placeholder="Select status">
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-primary">27 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">12,854 <span class="d-block text-muted fw-normal"> تومان7,845</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <a href="#">نیما</a>
                                                            <span class="d-block text-muted">روش پرداخت: بانک ملت</span>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <select name="status" class="form-select" data-placeholder="Select status">
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-primary">12 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">458 <span class="d-block text-muted fw-normal"> تومان985</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-danger">- 3 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">845 <span class="d-block text-muted fw-normal"> تومان98</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-secondary">در انتظار</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">تومان 985 <span class="d-block text-muted fw-normal">548</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">958 <span class="d-block text-muted fw-normal"> تومان652</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">358 <span class="d-block text-muted fw-normal"> تومان652</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-warning">2 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">687 <span class="d-block text-muted fw-normal"> تومان845</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-primary">15 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">985 <span class="d-block text-muted fw-normal"> تومان365</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-pill badge-warning">6 روز پیش</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">369 <span class="d-block text-muted fw-normal"> تومان85</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">985 <span class="d-block text-muted fw-normal"> تومان458</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0 fw-bold">985 <span class="d-block text-muted fw-normal"> تومان124</span></h6>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="list-icons d-inline-flex">
                                                            <a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
                                    ...
                                    <div class="flexbox">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item" href="#"><i class="ion-android-add"></i> فاکتور جدید</a>
