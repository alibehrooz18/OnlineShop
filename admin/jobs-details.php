            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-md-flex align-items-center justify-content-between">
                        <div>
                            <a href="jobs-details.html" class="waves-effect waves-light btn active btn-outline btn-primary">شغل</a>
                            <a href="people.html" class="waves-effect waves-light btn btn-outline btn-primary mx-lg-10">نامزدها</a>
                            <a href="mailbox.html" class="waves-effect waves-light btn btn-outline btn-primary">پیام ها</a>
                        </div>
                        <a href="#" class="waves-effect waves-light btn btn-danger mt-10 mt-md-0">انتشار شغل</a>
                    </div>
                </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <a href="#" class="mb-15 d-block"><i class="fa fa-angle-left"></i> بازگشت به لیست مشاغل</a>
                                    <div class="d-md-flex justify-content-between align-items-center">
                                        <div>
                                            <h4 class="mb-0">فول استک</h4>
                                            <p class="text-fade">تهران - تهرانپارس</p>
                                        </div>
                                        <a href="#" class="waves-effect waves-light btn btn-outline btn-success mt-10 mt-md-0">حامی این کار</a>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-xl-4 col-12">
                                            <div>
                                                <h5>این هفته را کلیک کنید <i class="fa fa-info-circle text-primary"></i></h5>
                                                <h1>122</h1>
                                                <a href="#" class="mt-20 waves-effect waves-light btn btn-block w-p100 btn-outline btn-primary">اسپانسر شغل برای کلیک های بیشتر</a>
                                                <a href="#" class="mt-5 waves-effect waves-light btn btn-block w-p100 btn-outline btn-warning">بهبود شرح شغل</a>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="text-center b-1 p-30">
                                                <h6 class="mt-0">در انتظار بررسی</h6>
                                                <h1 class="mb-0">41</h1>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="text-center b-1 p-30">
                                                <h6 class="mt-0">مجموع (به استثنای موارد رد شده)</h6>
                                                <h1 class="mb-0">51</h1>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="bg-primary-light p-15">
                                                <div class="d-md-flex justify-content-between align-items-center">
                                                    <div>
                                                        <i class="fa fa-info fs-24 mb-10"></i>
                                                        <h4 class="text-primary">با ارسال ارزیابی رایگان، متقاضیان برتر خود را سریعتر کشف کنید</h4>
                                                        <p>انواع مختلفی از قسمت‌های لورم ایپسوم در دسترس است، اما اکثریت آن‌ها به شکلی دچار تغییراتی شده‌اند، با طنز تزریقی، یا کلمات تصادفی که حتی اندکی هم باورپذیر به نظر نمی‌رسند.
                                                        </p>
                                                    </div>
                                                    <a href="#" class="mt-md-0 mt-10 waves-effect waves-light btn btn-primary d-table text-nowrap">درخواست ارزیابی</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>شرح شغل</h4>
                                            <ul>
                                                <li>کارهای روزانه را انجام دهید. </li>
                                                <li>کار روزانه اداری. </li>
                                                <li>سوابق دفتر را نگهداری کنید.</li>
                                                <li>سایر فعالیت های اداری </li>
                                                <li>مدیریت مشتری </li>
                                            </ul>
                                            <p>تاریخ مورد انتظار استن: 23/11/2020 </p>
                                            <p>انواع شغل: تمام وقت، تازه تر </p>
                                            <p>حقوق: از 8000 دلار در ماه</p>
                                            <h5 class="fw-500">با کارفرما صحبت کنید</h5>
                                            <p>+1 123 456 7890 </p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            <h4 class="mb-25">سوالات کاربردی </h4>

                                            <h4>شما درخواست کرده اید که Indeed از نامزدها سوالات زیر را بپرسد:</h4>
                                            <ul>
                                                <li>بالاترین سطح تحصیلی که گذرانده اید چیست؟ </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="media-list media-list-hover media-list-divided">
                                        <a class="media media-single rounded-0" href="#">
                                            <span class="title mx-0">بستن کار </span>
                                            <span class="badge badge-pill badge-secondary-light mx-0"><i class="fa fa-arrow-right"></i></span>
                                        </a>
                                        <a class="media media-single rounded-0" href="#">
                                            <span class="title mx-0">مشاهده هزینه و عملکرد </span>
                                            <span class="badge badge-pill badge-secondary-light mx-0"><i class="fa fa-arrow-right"></i></span>
                                        </a>
                                        <a class="media media-single rounded-0" href="#">
                                            <span class="title mx-0">کاندیداهای این شغل را پیدا کنید</span>
                                            <span class="badge badge-pill badge-secondary-light mx-0"><i class="fa fa-arrow-right"></i></span>
                                        </a>
                                    </div>
                                    <a href="#" class="waves-effect waves-light btn btn-block w-p100 btn-outline btn-success my-15">کاندید اضافه کنید</a>
                                    <div>
                                        <p><strong>بازدید:</strong> 251</p>
                                        <p class="text-primary"><strong>کاندیدا ها:</strong> 251</p>
                                        <p><strong>وضعیت:</strong> باز - <span class="badge badge-primary-light">مکث</span></p>
                                        <p><strong>ایجاد شده در:</strong> 18-بهمن</p>
                                    </div>
                                    <a href="#" class="waves-effect waves-light btn btn-block w-p100 btn-outline btn-danger my-15">بازدید صفحه عمومی مشاغل</a>
                                    <p class="text-fade">این شغل را برای نامزدهای بیشتری تبلیغ کنید:</p>
                                    <a href="#" class="p-5 bg-facebook text-white d-inline-block mb-10 rounded"><i class="fa fa-facebook-f"></i> اشتراک گذاری 0</a>
                                    <a href="#" class="p-5 bg-twitter text-white d-inline-block mb-10 rounded"><i class="fa fa-twitter"></i> توییت</a>
                                    <a href="#" class="p-5 bg-linkedin text-white d-inline-block mb-10 rounded"><i class="fa fa-linkedin-square"></i> اشتراک گذاری</a>
                                </div>
                            </div>
                        </div>
                    </div>
