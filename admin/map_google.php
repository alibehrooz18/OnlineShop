            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نقشه گوگل</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نقشه</li>
                                        <li class="breadcrumb-item active" aria-current="page">نقشه گوگل</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نقشه پایه ساده</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">بازار با پنجره اطلاعات</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نقشه روی لایه</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نقشه چند ضلعی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نقشه چرخشی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نقشه با استایل</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
