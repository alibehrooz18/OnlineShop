            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">فرصت های شغلی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item active" aria-current="page">فرصت های شغلی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <div class="mt-10 d-flex justify-content-between align-items-center">
                                            <a href="people.html" class="waves-effect waves-light btn btn-primary mb-5">مشاهده برنامه ها</a>
                                            <p class="mb-0 text-fade"><i class="fa fa-map-marker"></i> تهران</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <div class="mt-10 d-flex justify-content-between align-items-center">
                                            <a href="people.html" class="waves-effect waves-light btn btn-primary mb-5">مشاهده برنامه ها</a>
                                            <p class="mb-0 text-fade"><i class="fa fa-map-marker"></i> اصفهان</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <div class="mt-10 d-flex justify-content-between align-items-center">
                                            <a href="people.html" class="waves-effect waves-light btn btn-primary mb-5">مشاهده برنامه ها</a>
                                            <p class="mb-0 text-fade"><i class="fa fa-map-marker"></i> شیراز</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <div class="mt-10 d-flex justify-content-between align-items-center">
                                            <a href="people.html" class="waves-effect waves-light btn btn-primary mb-5">مشاهده برنامه ها</a>
                                            <p class="mb-0 text-fade"><i class="fa fa-map-marker"></i> سنندج</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
