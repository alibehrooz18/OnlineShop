                                        ...
                                        <table id="example2" class="table mb-0 w-p100">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>نام</th>
                                                    <th>وضعیت</th>
                                                    <th>سوالات صفحه نمایش</th>
                                                    <th>تاریخ اعمال</th>
                                                    <th><i class="fa fa-lock me-5"></i>علاقه دارید؟</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>مختار مینائی</td>
                                                    <td>در انتظار </td>
                                                    <td><span class="badge badge-success-light">1/1 سوال ترجیحی پاسخ داده شد</span></td>
                                                    <td>1402/02/12</td>
                                                    <td>
                                                        <div class="btn-group">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>رامین صداقت</td>
                                                    <td>در انتظار </td>
                                                    <td><span class="badge badge-secondary-light">0/1 سؤال برگزیده پاسخ داده شد</span></td>
                                                    <td>1402/02/12</td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="waves-effect waves-light btn btn-outline btn-success"><i class="fa fa-check"></i></a>
