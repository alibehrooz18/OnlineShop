            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">صفحه بزودی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">نمونه صفحات</li>
                                        <li class="breadcrumb-item active" aria-current="page">بزودی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header no-border">
                            <h4 class="box-title d-block text-center">شما میتوانید از صفحات متعددی در طراحی این صفحه استفاده کنید.</h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block text-center">نمونه 1</h3>
                                </div>
                                <div class="box-body">
                                    <a class="d-block" href="sample_coming_soon_1.html" target="_blank">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block text-center"> نمونه2</h3>
                                </div>
                                <div class="box-body">
                                    <a class="d-block" href="sample_coming_soon_2.html" target="_blank">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title d-block text-center">نمونه 3</h3>
                                </div>
                                <div class="box-body">
                                    <a class="d-block" href="sample_coming_soon_3.html" target="_blank">
