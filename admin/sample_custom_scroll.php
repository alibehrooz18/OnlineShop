...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">اسکرول سفارشی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">صفحات</li>
                                        <li class="breadcrumb-item active" aria-current="page">اسکرول سفارشی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسکرول متن</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-5"><img src="images\gallery\thumb\1.jpg" class="img-fluid" alt=""></div>
                                        <div class="col-md-7">
                                            <div id="slimtest1">
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسکرول دوتایی</h4>
                                </div>
                                <div class="box-body">
                                    <div id="slimtest2">
                                        <div class="row">
                                            <div class="col-md-5"><img src="images\gallery\thumb\2.jpg" class="img-responsive" alt=""></div>
                                            <div class="col-md-7">
                                                <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش.</p>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسکرول چپ</h4>
                                </div>
                                <div class="box-body">
                                    <div id="slimtest3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5"><img src="images\gallery\thumb\3.jpg" class="img-responsive" alt=""></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسکرول سفارشی رنگی</h4>
                                </div>
                                <div class="box-body">
                                    <div id="slimtest4">
                                        <div class="row">
                                            <div class="col-md-5"><img src="images\gallery\thumb\4.jpg" class="img-responsive" alt=""></div>
                                            <div class="col-md-7">
                                                <p>متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش متن تست و ساختگی جهت این بخش متن تست و ساختگی جهت تکمیل این بخش.</p>
                                            </div>
                                        </div>
    ...
    <script src="src\js\pages\custom-scroll.js"></script>
