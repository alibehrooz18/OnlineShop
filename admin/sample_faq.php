                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <ul class="nav nav-pills rounded nav-justified">
                                        <li class="nav-item"> <a href="#navpills-1" class="nav-link active" data-bs-toggle="tab" aria-expanded="false">کلی</a> </li>
                                        <li class="nav-item"> <a href="#navpills-2" class="nav-link" data-bs-toggle="tab" aria-expanded="false">پرداحت ها</a> </li>
                                        <li class="nav-item"> <a href="#navpills-3" class="nav-link" data-bs-toggle="tab" aria-expanded="true">تخفیفات</a> </li>
                                        <li class="nav-item"> <a href="#navpills-4" class="nav-link" data-bs-toggle="tab" aria-expanded="true"> حریم خصوصی و امنیت</a> </li>
                                    </ul>
                                </div>
                                <!-- /.box-body -->
                            </div>
                                                ...
                                                <div class="panel-group panel-group-simple panel-group-continuous" id="accordion2" aria-multiselectable="true" role="tablist">
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-1" role="tab">
                                                            <a class="panel-title" aria-controls="answer-1" aria-expanded="true" data-bs-toggle="collapse" href="#answer-1" data-parent="#accordion1">
                                                                سوال در مورد چگونی فرآیند خرید؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse show" id="answer-1" aria-labelledby="question-1" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                من باید برای شما توضیح دهم که چگونه این تصور اشتباه در تقبیح لذت و ستایش درد به وجود آمد و گزارش کاملی از این سیستم برای شما ارائه خواهم کرد و آموزه های واقعی کاشف بزرگ حقیقت، استاد سازنده سعادت بشری را شرح خواهم داد. .
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Question 1 -->
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-2" role="tab">
                                                            <a class="panel-title" aria-controls="answer-2" aria-expanded="false" data-bs-toggle="collapse" href="#answer-2" data-parent="#accordion1">
                                                                سول دوم و ادامه ؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-2" aria-labelledby="question-2" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                هیچ کس خود لذت را رد نمی کند، نمی پسندد یا از آن اجتناب نمی کند، زیرا لذت است، بلکه به این دلیل است که کسانی که نمی دانند چگونه به طور عقلانی لذت را دنبال کنند، با پیامدهایی مواجه می شوند که بسیار زیاد است.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Question 2 -->
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-3" role="tab">
                                                            <a class="panel-title" aria-controls="answer-3" aria-expanded="false" data-bs-toggle="collapse" href="#answer-3" data-parent="#accordion1">
                                                                سوال سوم و ادامه
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-3" aria-labelledby="question-3" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                باز هم کسی نیست که دوست داشته باشد یا دنبال کند یا بخواهد درد را از خود به دست آورد، زیرا درد است، بلکه به این دلیل که گاه شرایطی پیش می آید که در آن زحمت و درد به دست می آید.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Question 3 -->
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-4" role="tab">
                                                            <a class="panel-title" aria-controls="answer-4" aria-expanded="false" data-bs-toggle="collapse" href="#answer-4" data-parent="#accordion1">
                                                                سوال چهارم و ادامه سوالات قبل؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-4" aria-labelledby="question-4" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                او برخی از لذت بزرگ. برای مثال بی اهمیت، کدام یک از ما تا به حال تمرینات بدنی سختی را انجام می دهیم، مگر اینکه از آن مزیتی کسب کنیم؟ اما چه کسی حق دارد ایراد بگیرد
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- End Question 4 -->
                                                ...
                                                <div class="panel-group panel-group-simple panel-group-continuous" id="accordion" aria-multiselectable="true" role="tablist">
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-5" role="tab">
                                                            <a class="panel-title" aria-controls="answer-5" aria-expanded="true" data-bs-toggle="collapse" href="#answer-5" data-parent="#accordion1">
                                                                سوال در مورد چگونی فرآیند خرید؟
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-6" role="tab">
                                                            <a class="panel-title" aria-controls="answer-6" aria-expanded="false" data-bs-toggle="collapse" href="#answer-6" data-parent="#accordion1">
                                                                سول دوم و ادامه ؟
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-7" role="tab">
                                                            <a class="panel-title" aria-controls="answer-7" aria-expanded="false" data-bs-toggle="collapse" href="#answer-7" data-parent="#accordion1">
                                                                سوال سوم و ادامه
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="panel-group panel-group-simple panel-group-continuous" id="accordion1" aria-multiselectable="true" role="tablist">
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-8" role="tab">
                                                            <a class="panel-title" aria-controls="answer-8" aria-expanded="false" data-bs-toggle="collapse" href="#answer-8" data-parent="#accordion1">
                                                                سوال قبل؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-8" aria-labelledby="question-8" role="tabpanel" data-bs-parent="#category-3">
                                                            <div class="panel-body">
                                                                او برخی از لذت بزرگ. برای مثال بی اهمیت، کدام یک از ما تا به حال تمرینات بدنی سختی را انجام می دهیم، مگر اینکه از آن مزیتی کسب کنیم؟ اما چه کسی حق دارد ایراد بگیرد
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="panel-group panel-group-simple panel-group-continuous" id="accordion3" aria-multiselectable="true" role="tablist">
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-10" role="tab">
                                                            <a class="panel-title" aria-controls="answer-10" aria-expanded="true" data-bs-toggle="collapse" href="#answer-10" data-parent="#accordion1">
                                                                سوال در مورد چگونی فرآیند خرید؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse show" id="answer-10" aria-labelledby="question-10" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                من باید برای شما توضیح دهم که چگونه این تصور اشتباه در تقبیح لذت و ستایش درد به وجود آمد و گزارش کاملی از این سیستم برای شما ارائه خواهم کرد و آموزه های واقعی کاشف بزرگ حقیقت، استاد سازنده سعادت بشری را شرح خواهم داد. .
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-2" role="tab">
                                                            <a class="panel-title" aria-controls="answer-11" aria-expanded="false" data-bs-toggle="collapse" href="#answer-11" data-parent="#accordion1">
                                                                سول دوم و ادامه ؟
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-11" aria-labelledby="question-11" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                هیچ کس خود لذت را رد نمی کند، نمی پسندد یا از آن اجتناب نمی کند، زیرا لذت است، بلکه به این دلیل است که کسانی که نمی دانند چگونه به طور عقلانی لذت را دنبال کنند، با پیامدهایی مواجه می شوند که بسیار زیاد است.
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="panel">
                                                        <div class="panel-heading" id="question-12" role="tab">
                                                            <a class="panel-title" aria-controls="answer-12" aria-expanded="false" data-bs-toggle="collapse" href="#answer-12" data-parent="#accordion1">
                                                                سوال سوم و ادامه
                                                            </a>
                                                        </div>
                                                        <div class="panel-collapse collapse" id="answer-12" aria-labelledby="question-12" role="tabpanel" data-bs-parent="#category-1">
                                                            <div class="panel-body">
                                                                باز هم کسی نیست که دوست داشته باشد یا دنبال کند یا بخواهد درد را از خود به دست آورد، زیرا درد است، بلکه به این دلیل که گاه شرایطی پیش می آید که در آن زحمت و درد به دست می آید.
                                                            </div>
                                                        </div>
