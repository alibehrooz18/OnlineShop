                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item" aria-current="page">پیج نمونه</li>
                    ...
                    <div id="gallery">
                        <div class="box bg-transparent no-shadow b-0">
                            <div class="box-body text-center p-0">
                                <div class="btn-group">
                                    <button class="btn btn-info" id="filter-all">همه</button>
                                    <button class="btn btn-info" id="filter-studio">استودیو</button>
                                    <button class="btn btn-info" id="filter-landscape">متفاوت</button>
                                </div>
                            </div>
                        </div>
                        <!-- Default box -->
