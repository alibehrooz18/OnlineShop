...
<head>
    ...
    <link rel="stylesheet" href="assets\vendor_components\Magnific-Popup-master\dist\magnific-popup.css">
</head>
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">پنجره لایت باکس</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">صفحات</li>
                                        <li class="breadcrumb-item active" aria-current="page">پنجره لایت باکس</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">لایت باکس تک تصویری</h3>
                            <h6 class="subtitle"><code>&lt;a class="image-popup-no-margins" href="..." title="title will be apear here"&gt;&lt;img src="..."/&gt;&lt;/a&gt;</code></h6>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <a class="image-popup-vertical-fit" href="images\gallery\thumb\1.jpg" title="عنوان می تواند به هر طرف تراز شود و حاوی هر HTML باشد..">
                                        <img src="images\gallery\thumb\1.jpg" class="img-fluid" alt="">
                                    </a>
                                    <small>به صورت افقی و عمودی مناسب است</small>
                                </div>
                                <div class="col-sm-4">
                                    <a class="image-popup-fit-width" href="images\gallery\thumb\2.jpg" title="این تصویر فقط به صورت افقی مناسب است..">
                                        <img src="images\gallery\thumb\2.jpg" class="img-fluid" alt="">
                                    </a>
                                    <small>فقط به صورت افقی</small>
                                </div>
                                <div class="col-sm-4">
                                    <a class="image-popup-no-margins" href="images\gallery\thumb\3.jpg">
                                        <img src="images\gallery\thumb\3.jpg" class="img-fluid" alt="">
                                    </a>
                                    <small>بزرگنمایی انیمیشن، در بالا سمت راست ببندید.</small>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">گالری لایت باکس</h4>
                            <h6 class="subtitle"><code>&lt;a href="..." title="title will be apear here"&gt;&lt;img src="..."/&gt;&lt;/a&gt;</code></h6>
                        </div>
                        <div class="box-body">
                            <div class="popup-gallery">
                                <a href="images\gallery\thumb\4.jpg" title="عنوان می تواند به هر طرف تراز شود و حاوی هر HTML باشد..">
                                    <img src="images\gallery\thumb\4.jpg" width="32.5%" alt="">
                                </a>
                                <a href="images\gallery\thumb\5.jpg" title="این تصویر فقط به صورت افقی مناسب است.">
                                    <img src="images\gallery\thumb\5.jpg" width="32.5%" alt="">
                                </a>
                                <a href="images\gallery\thumb\6.jpg">
                                    <img src="images\gallery\thumb\6.jpg" width="32.5%" alt="">
                                </a>
                            </div> <small>کد زیزرا اضافه کنید class="popup-gallery".</small>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">زوم-گالری</h4>
                        </div>
                        <div class="box-body">
                            <div class="zoom-gallery m-t-30">
                                <a href="images\gallery\thumb\7.jpg" title="عنوان می تواند به هر طرف تراز شود و حاوی هر HTML باشد.">
                                    <img src="images\gallery\thumb\7.jpg" width="32.5%" alt="">
                                </a>
                                <a href="images\gallery\thumb\8.jpg" title="این تصویر فقط به صورت افقی مناسب است.">
                                    <img src="images\gallery\thumb\8.jpg" width="32.5%" alt="">
                                </a>
                                <a href="images\gallery\thumb\9.jpg">
                                    <img src="images\gallery\thumb\9.jpg" width="32.5%" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- /.box-body -->
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Css انیمیشن</h4>
                        </div>
                        <div class="box-body">
                            <div id="image-popups" class="row">
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\10.jpg" data-effect="mfp-zoom-in"><img src="images\gallery\thumb\10.jpg" class="img-fluid" alt="">
                                        <br>زوم</a>
                                </div>
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\11.jpg" data-effect="mfp-newspaper"><img src="images\gallery\thumb\11.jpg" class="img-fluid" alt="">
                                        <br>روزنامه</a>
                                </div>
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\12.jpg" data-effect="mfp-move-horizontal"><img src="images\gallery\thumb\12.jpg" class="img-fluid" alt="">
                                        <br>حرکت افقی</a>
                                </div>
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\13.jpg" data-effect="mfp-move-from-top"><img src="images\gallery\thumb\13.jpg" class="img-fluid" alt="">
                                        <br>حرکت از بالا</a>
                                </div>
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\14.jpg" data-effect="mfp-3d-unfold"><img src="images\gallery\thumb\14.jpg" class="img-fluid" alt="">
                                        <br>3d آنفولد</a>
                                </div>
                                <div class="col-sm-2">
                                    <a href="images\gallery\thumb\15.jpg" data-effect="mfp-zoom-out"><img src="images\gallery\thumb\15.jpg" class="img-fluid" alt="">
                                        <br>خروج از زوم</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">پاپ آپ با ویدیوی یوتیوب</h4>
                                    <h6 class="subtitle">می توانید از ویدیوی یوتیوب با پنجره بازشو استفاده کنید فقط کلاس <code>popup-youtube</code></h6> را اضافه کنید
                                </div>
                                <div class="box-body">
                                    <a class="popup-youtube btn btn-danger" href="www.youtube.com/watch?v=sK7riqg2mr4">باز کردن ویدئو</a>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">گوگل مپ</h4>
                                    <h6 class="subtitle">می‌توانید از Google Map با پاپ‌آپ استفاده کنید فقط با <code>popup-gmaps</code></h6> کلاس اضافه کنید
                                </div>
                                <div class="box-body">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">از پاپ اپ</h4>
                        </div>
                        <div class="box-body">
                            <a class="popup-with-form btn btn-success" href="#test-form">باز کردن از</a>

                            <!-- form itself -->
                            <form id="test-form" class="mfp-hide white-popup-block">
                                <h1>از</h1>
                                <fieldset style="border:0;">
                                    <p>Lightbox گزینه ای برای فوکوس خودکار روی اولین ورودی دارد. اکیداً توصیه می شود از نوع بازشو <code>inline</code> برای لایت باکس های دارای فرم به جای <code>ajax</code> استفاده کنید (برای حفظ داده های وارد شده در صورتی که کاربر
                                        به طور تصادفی صفحه را بازخوانی کرد).</p>
                                    <div class="form-group">
                                        <label class="form-label" for="inputName">نام</label>
                                        <input type="text" class="form-control" id="inputName" name="name" placeholder="نام" required="">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="inputEmail">ایمیل</label>
                                        <input type="email" class="form-control" id="inputEmail" name="email" placeholder="example@domain.com" required="">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="inputPhone">تلفن</label>
                                        <input type="tel" class="form-control" id="inputPhone" name="تلفن" placeholder="Eg. +447500000000" required="">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="textarea">تکست ارا</label>
                                        <br>
                                        <textarea class="form-control" id="textarea">سعی کنید اندازه من را تغییر دهید تا ببینید تغییر اندازه مبتنی بر CSS بازشو چگونه کار می کند.</textarea>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
