            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">لیست قیمت ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">صفحه نمونه</li>
                                        <li class="breadcrumb-item active" aria-current="page">لیست قیمت ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="box box-inverse bg-gradient-primary">
                                <div class="box-body text-center">
                                    <h5 class="text-uppercase text-muted">پکیج ساده</h5>
                                    <br>
                                    <h3 class="price">
                                        <sup>تومان </sup>0
                                        <span>&nbsp;</span>
                                    ...
                                    <hr>
                                    <p><strong>500 MB</strong> فضای ذخیره سازی</p>
                                    <p><strong>24x7</strong> پشتیبانی</p>
                                    <p><strong>5</strong> پروژه</p>
                                    <p><strong>1</strong> کاربر</p>

                                    <br><br>
                                    <a class="btn btn-outline btn-white" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="box card-shadowed box-inverse bg-gradient-danger">
                                <div class="box-body text-center">
                                    <h5 class="text-uppercase text-muted">پکیح حرفه ای</h5>
                                    <br>
                                    <h3 class="price">
                                        <sup>تومان </sup>5<sup>.99</sup>
                                        <span>در ماه</span>
                                    </h3>

                                    <hr>
                                    <p><strong>1 GB</strong> فضای ذخیره سازی</p>
                                    <p><strong>24x7</strong> پشتیبانی</p>
                                    <p><strong>15</strong> پروژه</p>
                                    <p><strong>3</strong> کاربر</p>
                        ...
                        <div class="col-lg-4">
                            <div class="box box-inverse bg-gradient-success">
                                <div class="box-body text-center">
                                    <h5 class="text-uppercase text-muted">پکیج طلایی</h5>
                                    <br>
                                    <h3 class="price">
                                        <sup>تومان </sup>15<sup>.99</sup>
                                        <span>در ماه</span>
                                    </h3>

                                    <hr>
                                    <p><strong>5 GB</strong> فضای ذخیره سازی</p>
                                    <p><strong>24x7</strong> پشتیبانی</p>
                                    <p><strong>50</strong> پروژه</p>
                                    <p><strong>10</strong> کاربر</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center p-50 bg-img box-inverse" style="background-image: url(images/gallery/thumb-sm/1.jpg)" data-overlay="7">
                                <div class="box-body">
                                    <h5 class="text-uppercase text-muted">ساده</h5>
                                    <br>
                                    <h3 class="fw-100 fs-70">تومان 5</h3>
                                    <small>ماهیانه /کاربر</small>
                                    ...
                                    <br><br>
                                    <a class="btn d-grid btn-outline btn-white" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center p-50 bg-img box-inverse" style="background-image: url(images/gallery/thumb-sm/12.jpg)" data-overlay="7">
                                <div class="box-body">
                                    <h5 class="text-uppercase text-muted">حرفه ای</h5>
                                    <br>
                                    <h3 class="fw-100 fs-70">تومان 15</h3>
                                    <small>ماهیانه /کاربر</small>

                                    <hr>

                                    <p><strong>50 GB</strong> فضای ذخیره سازی</p>
                                    <p><strong>24x7</strong> پشتیبانی</p>
                                    <p><strong>50</strong> پروژه</p>
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center p-50 bg-img box-inverse" style="background-image: url(images/gallery/thumb-sm/15.jpg)" data-overlay="7">
                                <div class="box-body">
                                    <h5 class="text-uppercase text-muted">پیشرفته</h5>
                                    <br>
                                    <h3 class="fw-100 fs-70">تومان 25</h3>
                                    <small>ماهیانه /کاربر</small>

                                    <hr>

                                    <p><strong>نامحدود </strong> فضای ذخیره سازی</p>
                                    <p><strong>24x7</strong> پشتیبانی</p>
                                    <p><strong>نامحدود </strong> پروژه</p>
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center p-50 bg-img box-inverse" style="background-image: url(images/gallery/thumb-sm/6.jpg)" data-overlay="7">
                                <div class="box-body">
                                    <h5 class="text-uppercase text-muted">فوق العاده</h5>
                                    <br>
                                    <h3 class="fw-100 fs-70">تومان 255</h3>
                                    <small>ماهیانه /کاربر</small>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center">
                                <div class="box-body">
                                    <h2 class="text-uppercase text-danger">پایه </h2>
                                    <p>یک امکان حرفه ای برا موفقیت کسب و کار </p>
                                ...
                                <div class="box-body bg-danger">
                                    ...
                                    <br>
                                    <a class="btn d-grid btn-round btn-danger" href="#">ثبت نام</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box box-shadowed text-center" style="margin-top:-20px">
                                <div class="box-body bg-primary pt-30">
                                    <h2 class="text-uppercase">حرفه ای</h2>
                                    <p>شامل برنامه و ویژگی های نامحدود</p>.
                                    <h4> پشتیبانی</h4>
                                </div>
                                <div class="box-body pb-40">
                                    ...
                                    <br>
                                    <a class="btn d-grid btn-round btn-primary" href="#">ثبت نام</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center">
                                <div class="box-body">
                                    <h2 class="text-uppercase text-warning">معمولی</h2>
                                    <p>یک امتیاز ویژه برای شما.</p>
                                    <h4>24/7 پشتیبانی</h4>
                                </div>
                                <div class="box-body bg-warning">
                                    ...
                                    <br>
                                    <a class="btn d-grid btn-round btn-warning" href="#">ثبت نام</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box text-center">
                                <div class="box-body">
                                    <h2 class="text-uppercase text-success">فوق العاده</h2>
                                    <p>یک امتیاز ویژه برای شما.</p>
                                    <h4>24/7 پشتیبانی</h4>
                                </div>
                                <div class="box-body bg-success">
                                    ...
                                    <br>
                                    <a class="btn d-grid btn-round btn-success" href="#">ثبت نام</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-4">
                            <div class="box p-60 text-center">
                                <h4 class="text-danger text-uppercase">پایه </h4>
                                <br>
                                <p>یک امکان حرفه ای برا موفقیت کسب و کار </p>
                                <p>ایمیل پشتیبانی</p>
                                <br>
                        ...
                        <div class="col-lg-4">
                            <div class="box box-shadowed box-round text-center py-80 px-60 bg-primary" style="margin-top:-20px">
                                ...
                                <br>
                                <a class="btn btn-round btn-outline btn-white " href="#">ثبت نام</a>
                            </div>
                        </div>

                        <div class="col-lg-4">
                            <div class="box p-60 text-center">
                                <h4 class="text-success text-uppercase">فوق العاده</h4>
                                <br>
                                <p>یک امتیاز ویژه برای شما.</p>
                                <p>24/7 پشتیبانی</p>
                                <br>
                                ...
                                <br>
                                <a class="btn btn-round btn-success" href="#">ثبت نام</a>
                            </div>
                        </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-4">
                            <div class="box box-shadowed box-round text-center p-40">
                                ...
                                <h3 class="price text-primary">
                                    <sup>تومان </sup>9
                                    <span class="text-fade">ماهیانه</span>
                                </h3>
                                <a class="btn btn-outline btn-round btn-primary" href="#">ثبت نام</a>

                                <ul class="list-unstyled mt-10 mb-0">
                                    <li class="py-10"><b>10GB</b> فضای دیسک</li>
                                    <li class="py-10"><b>100GB</b> ماهیانه پهنای باند</li>
                                    <li class="py-10"><b>20</b> ایمیل کاربری</li>
                                    <li class="pt-10"><b>نامحدود </b> زیر دامنه ها</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="box px-40 py-80 text-center bg-info" style="margin-top:-40px">
                                <h4 class="text-white text-uppercase">استاندارد</h4>
                                <h3 class="price text-white">
                                    <sup>تومان </sup>29
                                    <span class="text-white">ماهیانه</span>
                                </h3>
                                <a class="btn btn-outline btn-round btn-white" href="#">ثبت نام</a>
                        ...
                        <div class="col-lg-4">
                            <div class="box box-shadowed box-round text-center p-40">
                                <h4 class="text-danger text-uppercase">معمولی</h4>
                                <h3 class="price text-danger">
                                    <sup>تومان </sup>59
                                    <span class="text-fade">ماهیانه</span>
                                </h3>
                                <a class="btn btn-outline btn-round btn-danger" href="#">ثبت نام</a>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3">
                            <div class="box p-60 text-center bg-danger">
                                <h4 class="text-white text-uppercase">پایه </h4>
                                <br>
                                <p>یک امکان حرفه ای برا موفقیت کسب و کار </p>
                                <p>ایمیل پشتیبانی</p>
                                <br>
                        ...
                        <div class="col-lg-3">
                            <div class="box box-shadowed text-center py-80 px-60 b-3 border-primary" style="margin-top:-20px">
                                <h4 class="text-primary text-uppercase">حرفه ای</h4>
                                <br>
                                <p>شامل برنامه و ویژگی های نامحدود</p>.
                                <p> پشتیبانی</p>
                                <br>
                                ...
                                <br>
                                <a class="btn btn-round btn-primary" href="#">ثبت نام</a>
                            </div>
                        </div>

                        <div class="col-lg-3">
                            <div class="box p-60 text-center bg-warning">
                                <h4 class="text-white text-uppercase">معمولی</h4>
                                <br>
                                <p>یک امتیاز ویژه برای شما.</p>
                                <p>24/7 پشتیبانی</p>
                                <br>
                        ...
                        <div class="col-lg-3">
                            <div class="box p-60 text-center bg-success">
                                <h4 class="text-white text-uppercase">فوق العاده</h4>
                                <br>
                                <p>یک امتیاز ویژه برای شما.</p>
                                <p>24/7 پشتیبانی</p>
                                <br>
                    ...
                    <div class="row gap-y text-center">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="box shadow-1 hover-shadow-3 transition-5s bg-white b-1 border-success">
                                <p class="text-uppercase fw-400 bb-1 py-10 ls-2">رایگان</p>
                                <br>
                                <h2 class="fw-500 fs-60"><span class="price-dollar">تومان </span> 0</h2>
                                <br>

                                <small><b>1</b> کاربر</small><br>
                                <small><b>1</b> پشتیبانی</small><br>
                                <small><b>100 MB</b> ضمیمه</small><br>
                                <br>
                                <div class="d-block">
                                    <a class="btn btn-success" href="#">شروع کن</a>
                                </div>
                                <br><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="box shadow-1 hover-shadow-3 transition-5s bg-white b-1 border-info">
                                <p class="text-uppercase fw-400 bb-1 py-10 ls-2"> شخصی</p>
                                <br>
                                <h2 class="fw-500 fs-60"><span class="price-dollar">تومان </span> 9 <span class="price-interval">/ماهیانه</span></h2>
                                <br>

                                <small><b>1</b> کاربر</small><br>
                                <small><b>10</b> پشتیبانی</small><br>
                                <small><b>10 GB</b> ضمیمه</small><br>
                                <br>
                                <div class="d-block">
                                    <a class="btn btn-info" href="#">شروع کن</a>
                                </div>
                                <br><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="box shadow-1 hover-shadow-3 transition-5s bg-white b-1 border-primary">
                                ...
                                <br>
                                <h2 class="fw-500 fs-60"><span class="price-dollar">تومان </span> 39 <span class="price-interval">/mo</span></h2>
                                <br>

                                <small><b>5</b> کاربر</small><br>
                                <small><b>25</b> پشتیبانی</small><br>
                                <small><b>100 GB</b> ضمیمه</small><br>
                                <br>
                                <div class="d-block">
                                    <a class="btn btn-primary" href="#">شروع کن</a>
                                </div>
                                <br><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="box shadow-1 hover-shadow-3 transition-5s bg-white b-1 border-warning">
                                <p class="text-uppercase fw-400 bb-1 py-10 ls-2">حرفه ای</p>
                                <br>
                                <h2 class="fw-500 fs-60"><span class="price-dollar">تومان </span> 89 <span class="price-interval">/mo</span></h2>
                                <br>

                                <small><b>50</b> کاربر</small><br>
                                <small><b>250</b> پشتیبانی</small><br>
                                <small><b>1,000 GB</b> ضمیمه</small><br>
                                <br>
                                <div class="d-block">
                                    <a class="btn btn-warning" href="#">شروع کن</a>
                                </div>
                                <br><br>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="box">
                                <div class="box-body text-center">
                                    ...
                                    <br><br>
                                    <a class="btn btn-success" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="box box-inverse box-info">
                                <div class="box-body text-center">
                                    ...
                                    <h3 class="price">
                                        <sup>تومان </sup>5<sup>.99</sup>
                                        <span class="text-white">در ماه</span>
                                    </h3>
                        ...
                        <div class="col-lg-4">
                            <div class="box">
                                <div class="box-body text-center">
                                    ...
                                    <br><br>
                                    <a class="btn btn-warning" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="box box-shadowed">
                                <div class="box-body text-center">
                                    ...
                                    <br><br>
                                    <a class="btn btn-primary" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box">
                                <div class="box-body text-center">
                                    ...
                                    <br><br>
                                    <a class="btn btn-info" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="box">
                                <div class="box-body text-center">
                                    <h3 class="price">
                                        <sup>تومان </sup>25<sup>.99</sup>
                                        <span>در ماه</span>
                                    </h3>
                                    <h5 class="text-uppercase text-muted">پکیج فوق العاده</h5>
                                    ...
                                    <br><br>
                                    <a class="btn btn-danger" href="#">انتخاب پلن</a>
                                </div>
                            </div>
                        </div>
