            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">جداول رنگی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">جداول</li>
                                        <li class="breadcrumb-item active" aria-current="page">جداول رنگی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول پرایمری</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس<code>.bg-primary</code> استفاده کنید <code>&lt;thead&gt;</code>.</h6>
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول موفقیت</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس<code>.bg-success</code> استفاده کنید <code>&lt;thead&gt;</code>.</h6>
                                    <div class="table-responsive">
                                        <table class="table">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول اطلاع رسانی</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس <code>.bg-info</code> استفاده کنید<code>&lt;thead&gt;</code>.</h6>
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead class="bg-info">
                                                <tr>
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول هشدار</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس <code>.bg-warning</code> استفاده کنید <code>&lt;thead&gt;</code>.</h6>
                                    <div class="table-responsive">
                                        <table class="table">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول اخطار</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس <code>.bg-danger</code> استفاده کنید<code>&lt;thead&gt;</code>.</h6>
                                    <div class="table-responsive">
                                        <table class="table">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول معکوس</h4>
                                    <h6 class="box-subtitle mb-20">از این کلاس <code>.bg-inverse</code> استفاده کنید<code>&lt;thead&gt;</code>.</h6>
                                    <div class="table-responsive">
                                        <table class="table">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول پرایمری</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس<code>.bg-primary</code> را با <code>&lt;thead&gt;</code> این کلاس <code>.b-1 .border-primary</code> استفاده کنید <code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول با هدر سبز</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس <code>.bg-success</code> را با <code>&lt;thead&gt;</code> این کلاس <code>.b-1 .border-success</code> استفاده کنید <code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول با هدر اینفو</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس<code>.bg-info</code> را با <code>&lt;thead&gt;</code> این کلاس<code>.b-1 .border-info</code> استفاده کنید <code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول با هدر هشدار</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس <code>.bg-warning </code> را با<code>&lt;thead&gt;</code> این کلاس <code>.b-1 .border-warning</code> استفاده کنید<code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">جدول با هدر اخطار</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس <code>.bg-danger </code> را با <code>&lt;thead&gt;</code> این کلاس<code>.b-1 .border-danger</code> استفاده کنید <code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                        ...
                        <div class="col-lg-6">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">هدر اینورس</h4>
                                    <h6 class="box-subtitle mb-20">این کلاس <code>.bg-dark</code> رابا <code>&lt;thead&gt;</code> این کلاس <code>.b-1 .border-dark</code> استفاده کنید<code>&lt;table&gt;</code></h6>
                                    <div class="table-responsive">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title"><strong>رنگ های </strong> پس زمینه</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5>رنگ ثابت</h5>
                                            <p><code>bg-*</code> <a href="#" target="_blank">utility class</a> اضافه کنید به <em>tr</em>.</p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">نوارهای <strong>ردیف جدول</strong></h4>
                                </div>
                                <div class="box-body">
                                    <p>شما میتوانید استفاده کنید از<a href="#" target="_blank">border utility classes</a> در <code>&lt;tr&gt;</code> المنت ها</p>
                                    <div class="table-responsive">
