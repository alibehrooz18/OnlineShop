...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">جدول قابل ویرایش</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">جداول</li>
                                        <li class="breadcrumb-item active" aria-current="page">جدول قابل ویرایش</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">جدول قابل ویرایش با <strong>دیتا تیبل</strong></h4>
                                    <h6 class="subtitle">کافیه روی فیلد کلیک کنید و مقدار را ویرایش کنید</h6>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title"><strong>ادیتیبل </strong> ساده</h4>
                                    <h6 class="subtitle">تنها با یک کلیک مقادیر را تغییر دهید</h6>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
    ...
    <script src="assets\vendor_components\tiny-editable\mindmup-editabletable.js"></script>
    <script src="assets\vendor_components\tiny-editable\numeric-input-example.js"></script>


    <script src="src\js\pages\data-table.js"></script>
    <script src="src\js\pages\editable-tables.js"></script>
