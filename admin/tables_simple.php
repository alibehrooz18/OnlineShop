            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">جداول بوت استرپ</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">جداول</li>
                                        <li class="breadcrumb-item active" aria-current="page">جداول ساده</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جداول ساده</h4>
                                    <p class="subtitle">استفاده کنید از کلاس<code class="highlighter-rouge">.table-responsive{-sm|-md|-lg|-xl|-xxl}</code> برای ایجاد یک جدول ریسپانسیو
                                    </p>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول ریسپانسیو</h4>
                                ...
                                <div class="box-body no-padding">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td><a href="javascript:void(0)">سفارش#123456</a></td>
                                                <td>توضیحات</td>
                                                <td><span class="text-muted"><i class="fa fa-clock-o"></i> Oct 16, 2017</span> </td>
                                                <td>158.00</td>
                                                <td><span class="badge badge-pill badge-danger">پرداخت شده</span></td>
                                                <td>CH</td>
                                            </tr>
                                            <tr>
                                                <td><a href="javascript:void(0)">سفارش #458789</a></td>
                                                <td>توضیحات</td>
                                                <td><span class="text-muted"><i class="fa fa-clock-o"></i> Oct 16, 2017</span> </td>
                                                <td>55.00</td>
                                                <td><span class="badge badge-pill badge-warning">ارسال شده</span></td>
                                                <td>US</td>
                                            </tr>
                                            <tr>
                                                <td><a href="javascript:void(0)">سفارش #84532</a></td>
                                                <td>توضیحات</td>
                                                <td><span class="text-muted"><i class="fa fa-clock-o"></i> Oct 16, 2017</span> </td>
                                                <td>845.00</td>
                                                <td><span class="badge badge-pill badge-danger">درحال بررسی</span></td>
                                                <td>IG</td>
                                            </tr>
                                            <tr>
                                                <td><a href="javascript:void(0)">سفارش #48956</a></td>
                                                <td>توضیحات</td>
                                                <td><span class="text-muted"><i class="fa fa-clock-o"></i> Oct 16, 2017</span> </td>
                                                <td>145.00</td>
                                            ...
                                            <tr>
                                                <td><a href="javascript:void(0)">سفارش #92154</a></td>
                                                <td>توضیحات</td>
                                                <td><span class="text-muted"><i class="fa fa-clock-o"></i> Oct 16, 2017</span> </td>
                                                <td>$450.00</td>
                                                <td><span class="badge badge-pill badge-warning">ارسال شده</span></td>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول پیشفرض</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول تیره</h4>
                                </div>
                                <!-- /.box-header -->
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول با هدر</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول با هد</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول ساده</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول نواری</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول تیره با بردر</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول بدون بردر</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول تیره بدون بردر</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول هاور</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول تیره بدون نوار</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">جدول کوچک</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
