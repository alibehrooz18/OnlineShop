            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نشان ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">نشان ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">نشان های ساده</h4>
                                </div>
                                <div class="box-body">
                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان آبی</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-primary">Primary</span></div>
                                        <div class="px-25 py-10">Primary را اضافه کنید <code>.badge-primary</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان خاکستری</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-secondary">Secondary</span></div>
                                        <div class="px-25 py-10">secondary را اضافه کنید <code>.badge-secondary</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان اطلاعات</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-info">Info</span></div>
                                        <div class="px-25 py-10">Info را اضافه کنید <code>.badge-Info</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان موفق</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-success">Success</span></div>
                                        <div class="px-25 py-10">Success را اضافه کنید <code>.badge-Success</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان هشدار</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-danger">Danger</span></div>
                                        <div class="px-25 py-10">Danger را اضافه کنید <code>.badge-Danger</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان اخطار</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-warning">Warning</span></div>
                                        <div class="px-25 py-10">Warning را اضافه کنید <code>.badge-Warning</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان روشن</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-light">Light</span></div>
                                        <div class="px-25 py-10">Light را اضافه کنید <code>.badge-Light</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>


                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-10 w-200">نشان تاریک</div>
                                        <div class="px-25 py-10 w-100"><span class="badge badge-dark">Dark</span></div>
                                        <div class="px-25 py-10">Dark را اضافه کنید <code>.badge-Dark</code> به کلاس اولیه <code>.badge</code> نشان ها</div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">پر شده</h4>
                                </div>
                                <div class="box-body">
                                    <span class="badge badge-pill badge-default">متن</span>
                                ...
                                <div class="box-footer">
                                    <code>.badge-pill</code> اضافه کنید به <em>.badge</em>.
                                </div>
                                <!-- /.box-footer-->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">رنگی</h4>
                                </div>
                                <div class="box-body">
                                    <span class="badge badge-dark">تاریک</span>
                                    <span class="badge badge-gray">خاکستری</span>
                                    <span class="badge badge-secondary">کم رنگ</span>
                                </div>
                                <!-- /.box-body -->
                                <div class="box-footer">
                                    <code>.badge-*</code> که <code>*</code> استفاده شود با یکی ار رنگ های زیر.
                                </div>
                                <!-- /.box-footer-->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اندازه</h4>
                                </div>
                                <div class="box-body">
                                    <span class="badge badge-xl badge-primary">بسیار بزرگ</span>
                                    <span class="badge badge-lg badge-info">بزرگ </span>
                                    <span class="badge badge-warning">متوسط</span>
                                    <span class="badge badge-sm badge-danger">کوچک</span>
                                ...
                                <!-- /.box-body -->
                                <div class="box-footer">
                                    سایزهای موجود: <code>sm</code>, <code>lg</code>, <code>xl</code>
                                </div>
                                <!-- /.box-footer-->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نشان های دات</h4>
                                </div>
                                <div class="box-body">
                                ...
                                <!-- /.box-body -->
                                <div class="box-footer">
                                    <code>.badge-dot</code> اضافه کنید به <em>.badge</em>.
                                </div>
                                <!-- /.box-footer-->
                            </div>
                            <!-- /.box -->
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نشان های رینگ</h4>
                                </div>
                                <div class="box-body">

                                    <p><code>.badge-ring</code> اضافه کنید به <em>.badge</em>.</p>
                                ...
                                <!-- /.box-body -->
                                <div class="box-footer"><code>.fill</code> میتوان اضافه کرد به <em>.badge-ring</em>
                                </div>
                                <!-- /.box-footer-->
                            </div>
                            <!-- /.box -->
