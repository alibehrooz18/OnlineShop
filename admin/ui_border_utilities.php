            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title"> بردر</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">بردر</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">جدول زیر کلاس های موجود برای حاشیه 1px را نشان می دهد.</h4>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex flex-row mb-3 bg-light">
                                        <div class="px-25 py-25 w-200"> نام کلاس</div>
                                        <div class="px-25 py-25"> توضیحات</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.bt-1</code></div>
                                        <div class="px-25 py-15">border-top: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.bb-1</code></div>
                                        <div class="px-25 py-15">border-bottom: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.bs-1</code></div>
                                        <div class="px-25 py-15">border-left: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.be-1</code></div>
                                        <div class="px-25 py-15">border-right: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.bx-1</code></div>
                                        <div class="px-25 py-15">border-left: 1px خط ممتد ...<br>border-right: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.by-1</code></div>
                                        <div class="px-25 py-15">border-top: 1px خط ممتد ...<br>border-bottom: 1px خط ممتد ...</div>
                                    </div>

                                    <div class="d-flex flex-row mb-3">
                                        <div class="px-25 py-15 w-200"><code>.b-1</code></div>
                                        <div class="px-25 py-15">border: 1px خط ممتد ...</div>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <p>با استفاده از کلاس های زیر می توانید مرزهای جامد را به یک عنصر اضافه کنید. شما می توانید رنگ حاشیه را با استفاده از آن تغییر دهید <a href="content/utilities-color.html">border color utility classes</a>.</p>
                                    <p>کلاس ها از فرمت b{side}-{size} پیروی می کنند، جایی که <code>{size}</code> is one of <code>0</code>, <code>1</code>, <code>2</code>, <code>3</code>, <code>4</code>, or <code>5</code> values. Also, <code>{side}</code> is one
                                        of:</p>
                                    <ul>
                                        <li><code>t</code>: نوار حاشیه بالا</li>
                                        <li><code>b</code>: نوار حاشیه پائین</li>
                                        <li><code>s</code>: نوار حاشیه چپ</li>
                                        <li><code>e</code>: نوار حاشیه راست</li>
                                        <li><code>x</code>: نوار حاشیه چپ و راست</li>
                                        <li><code>y</code>: نوار حاشیه بالا و پایین</li>
                                        <li><em>null</em>: تمام اطراف</li>
                                    </ul>
