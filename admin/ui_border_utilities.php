                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <p>با استفاده از کلاس های زیر می توانید مرزهای جامد را به یک عنصر اضافه کنید. شما می توانید رنگ حاشیه را با استفاده از آن تغییر دهید <a href="content/utilities-color.php">border color utility classes</a>.</p>
