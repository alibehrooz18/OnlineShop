            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">دکمه ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">تم</li>
                                        <li class="breadcrumb-item active" aria-current="page">دکمه ها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گرادیانت</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید <code>.btn</code> <code>.bg-gradient-</code></p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های کلی</h4>
                                    <p class="subtitle mb-20">از این کلاس پایه استفاده کنید <code>.btn</code> <code>.btn-</code></p>
                                    <div class="clearfix">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های روشن</h4>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های تو خالی</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید<code>.btn-outline</code></p>
                                    <div class="clearfix">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های روشن تو خالی</h4>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گرد</h4>
                                    <p class="subtitle mb-20">از این کلاس پایه استفاده کنید <code>.btn-rounded</code></p>
                                    <div class="clearfix">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گرد روشن</h4>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های توخالی گرد</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید <code>.btn-rounded</code><code>.btn-outline</code></p>
                                    <div class="clearfix">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های توخالی گرد روشن</h4>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">سایز دکمه ها</h4>
                                    <p class="subtitle mb-20">از این کلاس پایه استفاده کنید <code>.btn-lg</code><code>.btn-Primary</code></p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های فلت</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید <code>.btn</code> <code>.btn-flat</code></p>
                                    <div class="clearfix">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های فلت روشن</h4>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه با ایکون</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید <code>.btn</code> <code>i class ="fa fa-check</code></p>
                                    <div class="clearfix">
                                    ...
                                    <div class="clearfix">
                                        <div class="btn-group mb-5">
                                            ...
                                            <button type="button" class="waves-effect waves-light btn btn-default dropdown-toggle" data-bs-toggle="dropdown">
                                                ...
                                                <span class="sr-only">توگل دراپ داون</span>
                                            </button>
                                            <div class="dropdown-menu">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title">دکمه های دراپ داون</h4>
                                    <div class="clearfix">
                                        <div class="btn-group mb-5">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گرد</h4>
                                    <p class="subtitle mb-20">از این کلاس استفاده کنید<code>.btn</code> <code>.btn-circle</code> <code>.btn-</code></p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گروهی افقی</h4>
                                    <p class="subtitle mb-20">این دکمه در بوت استرپ به اسانی ایجاد میشوندفقط کنار هم قرار دهید. <code>&lt;div class="btn-group"&gt;&lt;/div&gt;</code></p>
                                    <div class="clearfix">
                                        <div class="btn-group">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های افقی عمودی</h4>
                                    <p class="subtitle mb-20">این دکمه در بوت استرپ به اسانی ایجاد میشوندفقط کنار هم قرار دهید. <code>&lt;div class="btn-group-vertical"&gt;&lt;/div&gt;</code></p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه با ایکون</h4>
                                    <p class="subtitle mb-20">بااین کلاس ها<code>waves-effect waves-light btn btn-social-icon btn-bitbucket</code>سریعا دکمه را ایجاد کنید</p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های گرد با ایکون</h4>
                                    <p class="subtitle mb-20">بااین کلاس ها <code>btn btn-social-icon btn-circle</code>سزیعا دکمه را ایجاد کنید</p>
                                    <div class="clearfix">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-body">
                                    <h4 class="box-title mb-5">دکمه های اپلیکیشن</h4>
                                    <p class="subtitle mb-20">بااین کلاس ها <code>.btn.btn-app</code> با یک <code>&lt;a&gt;</code> تگ استفاده کنید:</p>
                                    <div class="clearfix">
                                        ...
                                        <a class="btn btn-app btn-warning" href="#">
                                            ...
                                            <i class="fa fa-bullhorn"></i> اعلانات
                                        </a>
                                        <a class="btn btn-app btn-warning" href="#">
                                        ...
                                        <a class="btn btn-app btn-success" href="#">
                                            ...
                                            <i class="fa fa-envelope"></i> صندوق دریافت
                                        </a>
