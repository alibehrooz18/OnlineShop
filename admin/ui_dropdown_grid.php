            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title"> دراپ دان</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page"> رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">دراپ دان</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-12">
                            ...
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">آیکون ها</h4>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title"> ایکون و عنوان</h4>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                        <div class="dropdown-menu dropdown-grid">
                                            <a class="dropdown-item" href="#">
                                                <span class="icon fa fa-camera"></span>
                                                <span class="title">دوربین</span>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <span class="icon fa fa-image"></span>
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <span class="icon fa fa-play"></span>
                                                <span class="title">ویدئو</span>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <span class="icon fa fa-music"></span>
                                                <span class="title">موزیک</span>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <span class="icon fa fa-newspaper-o"></span>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">آیکون های رنگی</h4>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                        <div class="dropdown-menu dropdown-grid">
                                            <a class="dropdown-item" href="#">
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <img class="icon" src="assets\vendor_components\flat-color-icons\SVG\news.svg" alt="news.svg">
                                            </a>
                                            <a class="dropdown-item" href="#">
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">آیکون های رنگی وعنوان</h4>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                        <div class="dropdown-menu dropdown-grid">
                                            <a class="dropdown-item" href="#">
                                                <img class="icon" src="assets\vendor_components\flat-color-icons\SVG\compact_camera.svg" alt="compact_camera.svg">
                                                <span class="title">دوربین</span>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">2 ستون</h4>
                                    <p class="subtitle"><code>.cols-2</code> اعمال می شود <em>.dropdown-grid</em></p>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">4 ستون</h4>
                                    <p class="subtitle"><code>.cols-4</code> اعمال شود<em>.dropdown-grid</em></p>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">آیتم های دیسیبل</h4>
                                    <p class="subtitle"><code>.disabled</code> اعمال شود <em>.dropdown-item</em></p>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-outline btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
                                        <div class="dropdown-menu dropdown-grid">
                                            <a class="dropdown-item" href="#">
                                                <img class="icon" src="assets\vendor_components\flat-color-icons\SVG\compact_camera.svg" alt="compact_camera.svg">
                                                <span class="title">دوربین</span>
                        ...
                        <div class="col-xl-4 col-12">
                            <div class="box h-400">
                                <div class="box-header">
                                    <h4 class="box-title">آیتم های فعال</h4>
                                    <p class="subtitle"><code>.active</code> اعمال شود <em>.dropdown-item</em></p>
                                </div>
                                <div class="box-body">
                                    <div class="dropdown">
                                        <button class="btn btn-rounded btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown">دراپ دان</button>
