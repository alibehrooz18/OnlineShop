            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">نوارهای پیشرفت</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page"> نوارهای پیشرفت</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نوارهای پیشرفت در اندازه های مختلف</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نوارهای پیشرفت</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="progress">
                                    ...
                                    <p>
                                    <p>The striped gradient can also be animated. Add <code class="highlighter-rouge">.progress-bar-animated</code> to <code class="highlighter-rouge">.progress-bar</code> to animate the stripes right to left via CSS3
                                        animations.</p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">میله های پیشرفت عمودی در اندازه های مختلف</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body text-center">
                                    <p>با افزودن این کلاس <code>.vertical</code> and <code>.progress-sm</code>, <code>.progress-xs</code> یا
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">نوارهای پیشرفت عمودی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body text-center">
                                    <p>با افزودن این کلاس <code>.vertical</code> we achieve:</p>
                                    <div>
