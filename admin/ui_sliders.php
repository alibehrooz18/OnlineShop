            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">اسلایدر ها</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">تم </li>
                                        <li class="breadcrumb-item active" aria-current="page">اسلایدر</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسلایدر نمایشی</h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسلایدر با کنترل</h4>
                                </div>
                                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسلایدر با ایندیکیتور </h4>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">اسلایدر با کپشن</h4>
                                </div>
                                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">اسلایدر تصاویر</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">اسلایدر تصاویر کوچک</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <!-- Place somewhere in the <body> of your page -->
