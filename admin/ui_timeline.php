            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title"> تایم لاین</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">تایم لاین</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">نمونه اول</h4>
                        </div>
                        <div class="box-body">
                            <div class="timeline timeline-line-dotted">
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">1402/01/24</span>
                                </span>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">عنوان و معرفی موضوع</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>توضیحات را درباره موضوع به کاربر نمایش دهید</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/01/25 10:00</p>
                                        </div>
                                    </div>
                                </div>
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">1402/01/26</span>
                                </span>
                                <div class="timeline-item">
                                    <div class="timeline-point timeline-point-success">
                                        <i class="fa fa-money"></i>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/01/27 09:00</p>
                                        </div>
                                    </div>
                                </div>
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">1402/01/28</span>
                                </span>
                                <div class="timeline-item">
                                    <div class="timeline-point timeline-point-success">
                                        <i class="fa fa-money"></i>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/01/29 08:00</p>
                                        </div>
                                    </div>
                                </div>
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">1402/01/30</span>
                                </span>
                                <div class="timeline-item">
                                    <div class="timeline-point timeline-point-success">
                                        <i class="fa fa-money"></i>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/01/31 14:00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/01 12:00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/02 11:30</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/03 11:00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/04 10:00</p>
                                        </div>
                                    </div>
                                </div>
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">1402/02/05</span>
                                </span>
                                <div class="timeline-item">
                                    <div class="timeline-point timeline-point-success">
                                        <i class="fa fa-money"></i>
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/06 15:00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/07 10:00</p>
                                        </div>
                                    </div>
                                </div>
                                <span class="timeline-label">
                                    <a href="#" class="btn btn-info" title="بیشتر...">
                            ...
                            <div class="timeline">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event timeline-event-default">
                                        ...
                                        <div class="timeline-body">
                                            <p>برای سفارشی کردن کادر تایم لاین کلاس بالا را اضافه کنید</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/08</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event timeline-event-primary">
                                        ...
                                        <div class="timeline-body">
                                            <p>برای سفارشی کردن تایم لاین کلاس بالا را اضافه کنید</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/09</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event timeline-event-info">
                                        ...
                                        <div class="timeline-body">
                                            <p>برای سفارشی کردن کلاس بالا را اضافه کنید.</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/10</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="timeline5">
                                <div class="timeline__group">
                                    ...
                                    <div class="timeline__box">
                                        <div class="timeline__date">
                                            ...
                                            <span class="timeline__month">مرحله</span>
                                        </div>
                                        <div class="timeline__post">
                                            <div class="timeline__content">
                                                <p>طراحان سایت هنگام طراحی قالب سایت م عمولا با این موضوع رو برو هستند که محتوای اصلی صفحات آماده نیست. در نتیجه طرح کلی دید درستی به کار فرما نمیدهد. اگر طراح بخواهد دنبال متن های مرتبط بگردد تمرکزش ا ز روی کار اصلی برداشته میشود و اینکار زمان بر خواهد بود</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="timeline__group">
                                    ...
                                    <div class="timeline__box">
                                        ...
                                        <div class="timeline__post">
                                            <div class="timeline__content">
                                                <p>همچنین طراح به دنبال این است که پ س از ارایه کار نظر دیگران را در مورد طراحی جویا شود و نمی‌خواهد افراد روی متن های موجود تمرکز کنند.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="timeline timeline-single-column timeline-single-full-column">
                                    ...
                                    <div class="timeline-event">
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"> کلاس ها را استفاده کنیدtimeline-event timeline-event-primary with panel panel-default</h3>
                                            </div>
                                ...
                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-primary badge-lg">برچسب</span>
                                </span>
                                    ...
                                    <div class="timeline-event timeline-event-primary">
                                        <table class="table table-striped table-hover">
                                            <tr>
                                                ...
                                                <th>جدول با کلاس های table-stripped table-hover</th>
                                            </tr>
                                            <tr>
                                                <td>ستون</td>
                                                <td>ستون</td>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">رخ دادها</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>برای سفارشی کردن کلاس بالا را اضافه کنید.</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/24</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event timeline-event-primary">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title">رخدادها</h4>
                                        </div>
                                        <div class="timeline-body">
                                            <p>برای سفارشی کردن کلاس بالا را اضافه کنید</p>
                                        </div>
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/25</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event timeline-event-success">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/26</p>
                                        </div>
                                    </div>
                                </div>

                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-info badge-lg">برچسب</span>
                                </span>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end">1402/02/27</p>
                                        </div>
                                    </div>
                                </div>

                                <span class="timeline-label">
                                    <span class="badge badge-pill badge-info badge-lg">تصاویر</span>
                                </span>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title"><a href="#">مختار مینائی</a><small> یک تصویر جدید آپلود کرد</small></h4>
                                        </div>
                                        <div class="timeline-body">
                                        ...
                                        <div class="timeline-footer">
                                            <p class="text-end"><i class="fa fa-clock-o"></i> 8 روزپیش</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title"><a href="#">مختار مینائی</a><small> برای پست شما کامنت گذاشت</small></h4>
                                        </div>
                                        <div class="timeline-body">
                                        ...
                                        <div class="timeline-footer">
                                            <a class="btn btn-success btn-sm" href="#">مشاهده کامنت ها</a>
                                            <p class="pull-right"><i class="fa fa-clock-o"></i> 8 روز پیش</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-event">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title"><a href="#">مختار مینائی</a><small> یک ویدئو منتشر کرد</small></h4>
                                        </div>
                                        <div class="timeline-body">
