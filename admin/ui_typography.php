            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">تایپو گرافی</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">رابط کاربری</li>
                                        <li class="breadcrumb-item active" aria-current="page">تایپو گرافی</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">سر تیتر با زیر عنوان</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title"> نمونه های متنی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <p class="lead">به تاکید بر اهمیت منجر شود</p>

                                    <p class="text-success">موفقیت متنی برای تاکید بر موفقیت</p>

                                    <p class="text-info">اطلاعات نوشتاری برای تاکید بر اطلاعات</p>

                                    <p class="text-primary">متن اصلی برای تاکید بر اصلی</p>

                                    <p class="text-secondary">متن ثانویه برای تأکید بر ثانویه</p>

                                    <p class="text-danger">نوشتن خطر برای تاکید بر خطر</p>

                                    <p class="text-warning">هشدار نوشتاری برای تاکید بر هشدار</p>

                                    <p class="text-muted">متن برای تاکید بر کلیات قطع شد</p>

                                    <p class="text-dark">متن تیره برای تاکید بر تاریکی</p>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">تراز کردن متن</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <p class="text-start">متن تراز چپ در همه اندازه‌های درگاه دید.</p>
                                    <p class="text-center">متن تراز شده در مرکز را در همه اندازه‌های درگاه دید قرار دهید.</p>
                                    <p class="text-end">متن تراز شده سمت راست در همه اندازه‌های درگاه دید.</p>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">فونت ایتالیک</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <p class="fw-bold">متن پررنگ.</p>
                                    <p class="fw-bolder">متن با وزن پررنگ تر (نسبت به عنصر والد).</p>
                                    <p class="fw-normal">متن با وزن معمولی.</p>
                                    <p class="fw-light">متن سبک.</p>
                                    <p class="fw-lighter">متن سبک تر (نسبت به عنصر والد).</p>
                                    <p class="fst-italic">متن ایتالیک.</p>
                                    <p class="fst-normal">متن با سبک فونت معمولی</p>
                                </div>
                                <!-- /.box-body -->
                            </div>
                            <!-- /.box -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">بلوک نقل قول ها</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <blockquote class="blockquote">
                                        <p>توضیحات تست در این قسمت ارائه خواهد شد</p>
                                        <footer class="blockquote-footer">شخصی مشهور در <cite title="Source Title">عنوان منبع</cite></footer>
                                    </blockquote>
                                </div>
                                <!-- /.box-body -->
                            </div>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">بلوک نقل قول به راست کشیده شد</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body clearfix">
                                    <blockquote class="blockquote blockquote-reverse">
                                        <p>توضیحات تست در این قسمت ارائه خواهد شد</p>
                                        <footer class="blockquote-footer">شخصی مشهور در <cite title="Source Title">منبع متن</cite></footer>
                                    </blockquote>
                                </div>
                                <!-- /.box-body -->
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">لیست نامرتب</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <ul>
                                        <li>متن های تست برای این بخش</li>
                                        <li>متن های تست برای این بخش</li>
                                        <li>متن های تست برای این بخش</li>
                                        <li>متن های تست برای این بخش</li>
                                        <ul>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">لیست مرتب</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <ol>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">متن های بدون استایل</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">توضیحات افقی</h4>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
