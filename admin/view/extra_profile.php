                        ...
                        <div class="col-12 col-lg-7 col-xl-8">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li><a href="#usertimeline" data-bs-toggle="tab">تایم لاین</a></li>
                                    <li><a class="active" href="#activity" data-bs-toggle="tab">فعال</a></li>
                                    <li><a href="#settings" data-bs-toggle="tab">تنظیمات</a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="usertimeline">
                                        <div class="publisher publisher-multi bg-white b-1 mb-30">
                                            <textarea class="publisher-input auto-expand" rows="4" placeholder="نظرتان را بنویسید.."></textarea>
                                            <div class="flexbox">
                                                <div class="gap-items">
                                                ...
                                                <button class="btn btn-sm btn-bold btn-primary">پست</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box b-1 no-shadow">
                                            <div class="media bb-1 border-fade">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p><small>طراح وب</small></p>
                                                </div>
                                            </div>

                                            <div class="box-body bb-1 border-fade">
                                                <p class="lead">کلیه مسائل را بصورت کامل بررسی کنید و سپس تصمیمات لازم را اتخاذ کنید</p>
                                            ...
                                            <form class="publisher bt-1 border-fade">
                                                ...
                                                <input class="publisher-input" type="text" placeholder="نظرتان را بنویسید...">
                                                <a class="publisher-btn" href="#"><i class="fa fa-smile-o"></i></a>
                                                <span class="publisher-btn file-group">
                                        ...
                                        <div class="box p-15">
                                            <div class="timeline timeline-single-column timeline-single-full-column">
                                                ...
                                                <span class="timeline-label">
                                                    <span class="badge badge-info badge-pill">تصاویر</span>
                                                </span>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-event">
                                                        <div class="timeline-heading">
                                                            <h4 class="timeline-title"><a href="#">مختار مینائی</a><small> پست جدید آپلود کنید</small></h4>
                                                        </div>
                                                        ...
                                                        <div class="timeline-footer">
                                                            <p class="text-end"><i class="fa fa-clock-o"></i> 8 روز پیش</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-event">
                                                        <div class="timeline-heading">
                                                            <h4 class="timeline-title"><a href="#">آریان همتی</a><small> برای پست شما کامنت گذاشت</small></h4>
                                                        </div>
                                                        <div class="timeline-body">
                                                            <p>توضیحات مربوطه را عنوان کنید.</p>
                                                        </div>
                                                        <div class="timeline-footer">
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-event">
                                                        <div class="timeline-heading">
                                                            <h4 class="timeline-title"><a href="#">آبتین محمودی</a><small> یک ویدئو به اشتراک گذاشت</small></h4>
                                                        </div>
                                                        <div class="timeline-body">
                                                        ...
                                                        <div class="timeline-footer">
                                                            <a class="btn btn-success btn-sm" href="#">مشاهده کامنت</a>
                                                            <p class="pull-right"><i class="fa fa-clock-o"></i> 8 روز پیش</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box no-shadow">
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    ...
                                                    <span class="description">5 دقیقه پیش</span>
                                                </div>
                                                <!-- /.user-block -->
                                                <div class="activitytimeline">
                                                    <p>
                                                        توضیحات مربوطه را عنوان کنید تا کاربران جزئیات را بدانند
                                                    </p>
                                                    <ul class="list-inline">
                                                        ...
                                                        <li class="pull-right">
                                                            <a href="#" class="link-black text-sm"><i class="fa fa-comments-o margin-r-5"></i> کامنت ها
                                                                (5)</a>
                                                        </li>
                                                    </ul>
                                                    <form class="form-element">
                                                        <input class="form-control input-sm" type="text" placeholder="یک کامنت بنویسید...">
                                                    </form>
                                                </div>
                                            </div>
                                            <!-- /.post -->
                                                ...
                                                <div class="activitytimeline">
                                                    ...
                                                    <form class="form-horizontal form-element">
                                                        <div class="form-group row g-0">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <button type="submit" class="btn btn-danger pull-right w-p100">ارسال</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="box no-shadow">
                                            <form class="form-horizontal form-element col-12">
                                                <div class="form-group row">
                                                    <label for="inputName" class="col-sm-2 form-label">نام</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-2 form-label">ایمیل</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-sm-2 form-label">تلفن</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputExperience" class="col-sm-2 form-label">تجربیات</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputSkills" class="col-sm-2 form-label">مهارت ها</label>
                                                ...
                                                <div class="form-group row">
                                                    <div class="ms-auto col-sm-10">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="basic_checkbox_1"> من قبول دارم</label> &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="col-12 col-lg-5 col-xl-4">
                            <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-header bg-img bbsr-0 bber-0" style="background: url('images/gallery/full/10.jpg') center center;" data-overlay="5">
                                    <h3 class="widget-user-username text-white">نازنین سعادت</h3>
                                    <h6 class="widget-user-desc text-white">طراح وب</h6>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 be-1 bs-1">
                                            <div class="description-block">
                                                ...
                                                <span class="description-text">فالوشده</span>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-4">
                                            <div class="description-block">
                                                ...
                                                <span class="description-text">توییت</span>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                            ...
                            <div class="box">
                                <div class="box-body box-profile">
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <p>ایمیل :<span class="text-gray ps-10">David@yahoo.com</span> </p>
                                                <p>تلفن :<span class="text-gray ps-10">+11 123 456 7890</span></p>
                                                <p>آدرس :<span class="text-gray ps-10">تهران - سعادت آباد</span></p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="pb-15">
                                                <p class="mb-10">شبکه های اجتماعی</p>
                                        ...
                                        <div class="col-12">
                                            <div>
                                                <div class="map-box">
                                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2805244.1745767146!2d-86.32675167439648!3d29.383165774894163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c1766591562abf%3A0xf72e13d35bc74ed0!2sFlorida%2C+USA!5e0!3m2!1sen!2sin!4v1501665415329" style="border:0; width:100%; height:100px;" allowfullscreen=""></iframe>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="flexbox align-items-baseline mb-20">
                                        <h6 class="text-uppercase ls-2">دوستان</h6>
                                        <small>20</small>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <a class="text-uppercase d-blockls-1 text-fade" href="#">دعوت ز افراد</a>
                                </div>
                            </div>
                            <div class="box box-inverse" style="background-color: #3b5998">
                                ...
                                <blockquote class="blockquote blockquote-inverse no-border m-0 py-15">
                                    <p>توضیحات لازم در این قسمت ارائه شود.</p>
                                    <div class="flexbox">
                                        <time class="text-white" datetime="2017-11-21 20:00">فروردین 1402</time>
