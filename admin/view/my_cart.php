...
<head>
    ...
    <?php include "../controllers/cart_controller.php"; ?>
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">خریدهای من</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item active" aria-current="page">خریدها</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        ...
                        $cart_items = $cartController->getCartItem($cart_id);

                        if (!empty($cart_items)) {
                            while ($row = mysqli_fetch_assoc($cart_items)) {
                                $cart_shop_id = $row['cart_shop_id'];

                                $shop_items = $cartController->getShopItem($cart_shop_id);

                                while ($row = mysqli_fetch_assoc($shop_items)) {
                                    $shop_id = $row['item_id'];
                                    $shop_title = $row['item_title'];
                                    $shop_image = $row['item_image'];
                                        ...
                                        <div class="box">
                                            <div class="box-body">
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <img src="../../public/img/shop/<?php echo $shop_image; ?>" class="align-self-center" alt="">
                                                ...
                                                <div class="mt-20">
                                                    ...
                                                    <div class="mt-10 d-flex justify-content-between align-items-center">
                                                        <a href="./course-details.php?c_id=<?php echo $course_id; ?>" class="waves-effect waves-light btn btn-primary mb-5">مشاهده سفارش</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
