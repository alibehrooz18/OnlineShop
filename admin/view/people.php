...
<head>
    ...
    <?php include "../controllers/people_controller.php"; ?>
                                    ...
                                    <div>
                                        <ul class="nav nav-pills nav-fill">
                                            <li class="nav-item b-1">
                                                <a class="nav-link active text-center" href="#"><?php echo $all_user; ?><br>کل کاربران</a>
                                            </li>
                                            <li class="nav-item b-1">
                                                <a class="nav-link text-center" href="#"><?php echo $admin_user; ?><br>اساتید</a>
                                            </li>
                                            <li class="nav-item b-1">
                                                <a class="nav-link text-center" href="#"><?php echo $sub_user; ?><br>مشترک</a>
                                            </li>
                                            <li class="nav-item b-1">
                                        ...
                                        <table id="example2" class="table mb-0 w-p100">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>ایمیل</th>
                                                    <th>کد کاربری</th>
                                                    <th><i class="fa fa-lock me-5"></i>تغییر به ادمین؟</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tbody>
