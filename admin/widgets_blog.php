            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">ویجت </h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">ویجت ها </li>
                                        <li class="breadcrumb-item active" aria-current="page">ویجت بلاگ</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header no-border">
                                    <h4 class="box-title">بلاگ با اسلایدر</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="news-slider owl-carousel">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="text-center">
                                            <h4 class="box-title">عنوان پست</h4>
                                            <p class="box-text">توضیحات لازم برای بلاگ را عنوان کنید تا کاربران از مطالب شما لذت ببرند</p>
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header no-border">
                                    <h4 class="box-title">پست بدون تصویر با اسلایدر</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <div class="text-start">
                                            ...
                                            <p class="my-10">
                                                <small>
                                                    <i class="fa fa-user"></i> توسط <a href="#">مختار</a>
                                                    <span class="px-10">| </span><i class="fa fa-calendar"></i> 1402/02/11
                                                </small>
                                            </p>
                                            <p class="box-text">توضیحات لازم برای بلاگ را عنوان کنید تا کاربران از مطالب شما لذت ببرند</p>
                                            <a href="#" class="btn btn-flat btn-primary btn-sm">مشاهده بیشتر</a>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="text-start">
                                            ...
                                            <p class="my-10">
                                                <small>
                                                    <i class="fa fa-user"></i> توسط <a href="#">مختار</a>
                                                    <span class="px-10">| </span><i class="fa fa-calendar"></i> 1402/02/22
                                                </small>
                                            </p>
                                            <p class="box-text">توضیحات لازم برای بلاگ را عنوان کنید تا کاربران از مطالب شما لذت ببرند</p>
                                            <a href="#" class="btn btn-flat btn-primary btn-sm">مشاهده بیشتر</a>
                                    ...
                                    <div class="box-body">
                                        <div class="text-start">
                                            ...
                                            <p class="my-10">
                                                <small>
                                                    <i class="fa fa-user"></i> توسط <a href="#">مختار</a>
                                                    <span class="px-10">| </span><i class="fa fa-calendar"></i> 1402/02/23
                                                </small>
                                            </p>
                                            <p class="box-text">توضیحات لازم برای بلاگ را عنوان کنید تا کاربران از مطالب شما لذت ببرند</p>
                                            <a href="#" class="btn btn-flat btn-primary btn-sm">مشاهده بیشتر</a>
                                    ...
                                    <div class="box-body">
                                        <div class="text-start">
                                            ...
                                            <p class="my-10">
                                                <small>
                                                    <i class="fa fa-user"></i> توسط <a href="#">مختار</a>
                                                    <span class="px-10">| </span><i class="fa fa-calendar"></i> 1402/02/24
                                                </small>
                                            </p>
                                            <p class="box-text">توضیحات لازم برای بلاگ را عنوان کنید تا کاربران از مطالب شما لذت ببرند</p>
                                            <a href="#" class="btn btn-flat btn-primary btn-sm">مشاهده بیشتر</a>
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-12 h-p100">
                            <div class="box card-inverse bg-img text-center py-80" style="background-image: url(images/gallery/thumb/12.jpg)" data-overlay="5">
                                <div class="card-body">
                                    <span class="bb-1 opacity-80 pb-2">1402/02/12</span>
                                    <br><br>
                                    <h3>عنوان پست.</h3>
                                    <br><br>
                                    <a class="btn btn-primary-light" href="#">مشاهده بیشتر</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="flexbox align-items-center mt-3">
                                                <a class="text-gray" href="#">
                                                    ...
                                                    <span class="ms-2">مختار مینائی</span>
                                                </a>
                                                <a href="#">
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                <figure class="img-hov-zoomin mb-0">
                                    <img src="images\gallery\thumb\1.jpg" alt="...">
                                </figure>
                                <div class="box-body">
                                    <p class="text-success text-uppercase">سوال</p>
                                    <h4><a href="#">معرفی موضوع پست.</a></h4>
                                    <hr class="my-0">
                                    <div class="flexbox align-items-center mt-15">
                                        <small>25 دقیقه پیش</small>
                                        <a class="text-muted" href="#">
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                <figure class="img-hov-zoomin mb-0">
                                    <img src="images\gallery\thumb\8.jpg" alt="...">
                                </figure>
                                <div class="box-body">
                                    <p class="text-primary text-uppercase">سوال</p>
                                    <h4><a href="#">معرفی موضوع پست.</a></h4>
                                    <p>لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی در صنعت چاپ، صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان عنصری از ترکیب بندی برای پر کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید، تا از نظر گرافیکی نشانگر چگونگی نوع و اندازه فونت و ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا صرفا به مشتری یا صاحب کار خود نشان دهند که صفحه طراحی یا صفحه بندی شده بعد از اینکه متن در آن قرار گیرد چگونه به نظر می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر گرفته شده‌است. از آنجایی که طراحان عموما نویسنده متن نیستند</p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                ...
                                <div class="box-body">
                                    ...
                                    <p>لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی در صنعت چاپ، صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان عنصری از ترکیب بندی برای پر کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید، تا از نظر گرافیکی نشانگر چگونگی نوع و اندازه فونت و ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا صرفا به مشتری یا صاحب کار خود نشان دهند که صفحه طراحی یا صفحه بندی شده بعد از اینکه متن در آن قرار گیرد چگونه به نظر می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر گرفته شده‌است. از آنجایی که طراحان عموما نویسنده متن نیستند</p>
                                    <div class="flexbox align-items-center mt-3">
                                        <a class="btn btn-sm btn-bold btn-primary" href="#">مشاهده بیشتر</a>
                                        <div class="gap-items-4">
                                            <a class="text-muted" href="#">
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                ...
                                <div class="box-body">
                                    <h4><a class="hover-primary" href="#">معرفی موضوع پست.</a></h4>
                                    <p>1402/02/12</p>
                                ...
                                <div id="blog-slide1" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="images\gallery\thumb\8.jpg" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="images\gallery\thumb\1.jpg" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="images\gallery\thumb\6.jpg" alt="Third slide">
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                <div class="ratio ratio-16x9">
                                    <iframe class="w-p100" height="450" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/5203969&auto_play=false&hide_related=false&show_کامنت=true&show_user=true&show_reposts=false&visual=true"></iframe>
                                </div>
                                <div class="box-body">
                                    <h4><a href="#">معرفی موضوع پست.</a></h4>
                                    <p>1402/02/12</p>
                                ...
                                <div class="box-body bt-1 btsr-0 bter-0">
                                    <div class="flexbox align-items-center">
                                        <a class="text-primary fs-15" href="#">ادامه مطلب...</a>
                                        <ul class="flexbox">
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header no-border">
                                    <h4 class="box-title">استایل پست ها</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-body p-0">
                                    <h4 class="media-heading mt-15 px-30"><a href="#">عنوان پست.</a></h4>
                                    <p class="mt-0 mb-5 px-30 py-10 bg-lightest">
                                        <i class="fa fa-user"></i> توسط <a href="#">مختار</a> | <i class="fa fa-calendar"></i> 1402/02/ | <i class="fa fa-comment"></i> <a href="#">3 کامنت</a> | <i class="fa fa-share"></i> <a href="#">39 اشتراک گذاشته</a>
                                    </p>
                                    <div class="media">
                                        <img class="align-self-start w-160" src="images\gallery\thumb-sm\1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                            <p>لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی در صنعت چاپ، صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان عنصری از ترکیب بندی برای پر کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید، تا از نظر گرافیکی نشانگر چگونگی نوع و اندازه فونت و ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا صرفا به مشتری یا صاحب کار خود نشان دهند که صفحه طراحی یا صفحه بندی شده بعد از اینکه متن در آن قرار گیرد چگونه به نظر می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر گرفته شده‌است. از آنجایی که طراحان عموما نویسنده متن نیستند.</p>
                                            <a class="btn btn-sm btn-bold btn-primary mt-15" href="#">مشاهده بیشتر</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                <div class="box-body p-0">
                                    <h4 class="media-heading mt-15 mb-0 px-30"><a href="#">عنوان پست.</a></h4>
                                    <div class="media">
                                        <img class="align-self-start w-160" src="images\gallery\thumb-sm\1.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                            <p>لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی در صنعت چاپ، صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان عنصری از ترکیب بندی برای پر کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید، تا از نظر گرافیکی نشانگر چگونگی نوع و اندازه فونت و ظاهر متن باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا صرفا به مشتری یا صاحب کار خود نشان دهند که صفحه طراحی یا صفحه بندی شده بعد از اینکه متن در آن قرار گیرد چگونه به نظر می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر گرفته شده‌است. از آنجایی که طراحان عموما نویسنده متن نیستند.</p>
                        ...
                        <div class="col-md-6">
                            <div class="box overflow-hidden">
                                <div class="box-body p-0">
                                    <h4 class="media-heading mt-15 mb-0 px-30"><a href="#">عنوان پست.</a></h4>
                                    <p class="mt-10 mb-0 px-30 توسط-1 py-10">
                                        <i class="fa fa-user"></i> توسط <a href="#">مختار</a> | <i class="fa fa-calendar"></i> 1402/02/ | <i class="fa fa-comment"></i> <a href="#">3 کامنت</a> | <i class="fa fa-share"></i> <a href="#">39 اشتراک گذاشته</a>
                                    </p>
                                    <div class="media">
                                        <div class="media-body">
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="flexbox align-items-center mt-3">
                                        <div class="btn-group">
                                            <a class="btn btn-xs btn-facebook" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک گذاری در فیس بوک"><i class="fa fa-facebook"></i></a>
                                            <a class="btn btn-xs btn-twitter" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک در تویتر"><i class="fa fa-twitter"></i></a>
                                            <a class="btn btn-xs btn-google" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک در گوگل"><i class="fa fa-google"></i></a>
                                        </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="flexbox align-items-center mt-3">
                                        <div class="btn-group">
                                            <a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک گذاری در فیس بوک"><i class="fa fa-facebook"></i></a>
                                            <a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک در تویتر"><i class="fa fa-twitter"></i></a>
                                            <a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="اشتراک در گوگل"><i class="fa fa-google"></i></a>
                                        </div>

                                        <a class="btn btn-sm btn-bold btn-outline" href="#">مشاهده بیشتر</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box">
                                <div class="card-body bg-img py-70" style="background-image: url(images/gallery/thumb/5.jpg)" data-overlay="5">
                                    <blockquote class="blockquote blockquote-inverse no-border no-margin">
                                        <p class="fs-22">توضیحات تست .</p>
                                        <footer>بعضی افراد مشهور در.. <cite title="Source Title">منبع مطلب</cite></footer>
                                    </blockquote>
                                </div>
