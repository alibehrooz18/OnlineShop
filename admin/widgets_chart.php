            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">ویجت های نموداری</h4>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                        <li class="breadcrumb-item" aria-current="page">ویجت ها</li>
                                        <li class="breadcrumb-item active" aria-current="page">ویجت های نموداری</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">گزارش سفارشات</h4>
                                    <div class="box-controls pull-right">
                                        <ul class="nav nav-pills nav-pills-sm" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link py-2 px-4 b-0" data-bs-toggle="tab" href="#">
                                                    <span class="nav-text base-font">ماهیانه</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link py-2 px-4 b-0" data-bs-toggle="tab" href="#">
                                                    <span class="nav-text base-font">هفتگی</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link py-2 px-4 b-0 active" data-bs-toggle="tab" href="#">
                                                    <span class="nav-text base-font">روزانه</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-12 d-flex flex-column">
                                            <div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 70%; background-image: url(images/svg-icon/color-svg/custom-3.svg)">
                                                <h4 class="ont-weight-500">اعتماد کاربران</h4>
                                                <p class="my-10">
                                                    فروش و بازار<br>برپایه اعتماد مشتریان
                                                </p>
                                                <a href="#" class="btn btn-warning-light py-2 px-6">یادگیری</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="bg-warning-light p-30">
                                                <div class="d-flex align-items-center mb-30">
                                                    ...
                                                    <div class="d-flex flex-column fw-500">
                                                        ...
                                                        <span class="text-muted">داده تست</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex align-items-center mb-30">
                                                    <div class="me-15 bg-white h-40 w-40 l-h-50 rounded text-center">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div>
                                        کاربران آنلاین
                                        <div class="text-muted fs-16">845 میانگین</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div>
                                        سفارش ماهیانه
                                        <div class="text-muted fs-16">9,758 میانگین</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="list-icons ms-auto">
                                            <div class="list-icons-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="#" class="dropdown-item">آپدیت داده ها</a>
                                                    <a href="#" class="dropdown-item">حذفی ها</a>
                                                    <a href="#" class="dropdown-item">ثابت ها</a>
                                                    <a href="#" class="dropdown-item">پاک کردن لیست</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        بارگذاری از سرور
                                        <div class="text-muted fs-16">24.6% میانگین</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="box bg-info">
                                <div class="box-body">
                                    ...
                                    <div>
                                        کاربران آنلاین
                                        <div class="fs-16">854 میانگین</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="box bg-warning">
                                <div class="box-body">
                                    ...
                                    <div>
                                        سفارش ماهیانه
                                        <div class="fs-16">6,854 میانگین</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <div class="box bg-primary">
                                <div class="box-body">
                                    ...
                                    <div>
                                        بارگذاری از سرور
                                        <div class="fs-16">85.6% میانگین</div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="box bg-success-light">
                                <div class="box-body">
                                    <div class="media align-items-center p-0">
                                        <h3 class="mx-0 mb-5 fw-500">گزارشات مهم</h3>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="box bg-primary-light">
                                <div class="box-body">
                                    <div class="media align-items-center p-0">
                                        <h3 class="mx-0 mb-5 fw-500">سفارشات</h3>
                                    </div>
                                    <div class="flexbox align-items-center mt-5">
                                        <div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-body">
                                    <div class="media align-items-center p-0">
                                        <h3 class="mx-0 mb-5 fw-500">فروش روزانه</h3>
                                    </div>
                                    <div class="flexbox align-items-center mt-5">
                                        <div>
                        ...
                        <div class="col-md-6">
                            <div class="box">
                                <div class="box-body">
                                    <div class="media align-items-center p-0">
                                        <h3 class="mx-0 mb-5 fw-500">سود اعضا</h3>
                                    </div>
                                    <div class="flexbox align-items-center mt-5">
                                        <div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box box-body">
                                <div class="flexbox">
                                    <h6 class="text-uppercase">آنالیز</h6>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box bg-img" style="background-image: url(images/gallery/thumb/9.jpg);" data-overlay="5">
                                <div class="box-body text-white">
                                    ...
                                    <p>بازدید صفحه را افزایش دهید</p>
                                </div>
                            ...
                            <div class="box">
                                <div class="box-body bg-img" style="background-image: url(images/gallery/thumb/5.jpg);" data-overlay="5">
                                    <div class="flexbox mb-20">
                                        <h6 class="text-uppercase text-white">امروز</h6>
                                        <h6 class="text-white"><i class="ion-android-arrow-dropup"></i> %20</h6>
                                    </div>
                                    <div id="lineامروز"></div>
                                </div>
                                ...
                                <div class="box-body">
                                    <ul class="flexbox flex-justified align-items-center">
                                        <li class="text-end">
                                            ...
                                            <small class="text-uppercase">فروش مستقیم</small>
                                        </li>
                                        ...
                                        <li class="text-start">
                                            ...
                                            <small class="text-uppercase">فروش حراجی</small>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box">
                                <div class="box-body bg-primary">
                                    <div class="flexbox mb-20">
                                        <h6 class="text-uppercase text-white">آنالیز</h6>
                                        <h6 class="text-white"><i class="ion-android-arrow-dropup"></i> %20</h6>
                                    </div>
                                ...
                                <div class="box-body">
                                    <div class="flexbox align-items-center">
                                        <div>
                                            <small class="text-uppercase">حداکثر</small>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box">
                                <div class="box-body bg-info">
                                    <div class="flexbox mb-20">
                                        <div class="dropdown">
                                            <h6 class="text-uppercase text-white dropdown-toggle" data-bs-toggle="dropdown">امروز</h6>
                                            <div class="dropdown-menu">
                                ...
                                <div class="box-body">
                                    <h6 class="text-uppercase text-center mb-30">بهترین موقعیت</h6>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h5 class="box-title">بهترین تبلیغ</h5>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h5 class="box-title">بهترین موقعیت</h5>
                                    <div class="box-tools pull-right">
                                        <ul class="card-controls">
                                            <li class="dropdown">
                                                <a data-bs-toggle="dropdown" href="#"><i class="ion-android-more-vertical"></i></a>
                                ...
                                <div class="box-body">
                                    <div class="flexbox mt-20">
                                        ...
                                        <ul class="list-inline align-self-end text-muted text-end mb-0">
                                            <li>اصفهان <span class="badge badge-ring badge-primary ms-2"></span></li>
                                            <li>شیراز <span class="badge badge-ring badge-success ms-2"></span></li>
                                            <li>تهران <span class="badge badge-ring badge-warning ms-2"></span></li>
                                        </ul>
                                    </div>
                                    <p class="mt-20">توضیحات در مورد مهارت ها .</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-0">زمان در دسترس</p>
                                        <p class="text-fade"><small>51% میانگین</small></p>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-0">اهداف</p>
                                        <p class="text-fade"><small>43% میانگین</small></p>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-0">مقایسه</p>
                                        <p class="text-fade"><small>32% میانگین</small></p>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-0">گزارش فروش</p>
                                        <p class="text-fade"><small>47% میانگین</small></p>
                                ...
                                <div class="box-body">
                                    <div class="flexbox">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-fade"><small>امروز'فروش</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
