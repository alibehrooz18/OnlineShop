...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed rtl">
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h4 class="page-title">تم هواشناسی</h4>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-5">
                                            <div class="row">
                                                <div class="col-4">
                                                    <div>
                                                        <h1><i class="wi wi-solar-eclipse"></i></h1>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <span class="fs-40">20°
                                                    ...
                                                    <p class="fs-14 mb-0">دوشنبه 11.11.2017</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-md-7">
                                            <div class="row g-0 text-center">
                                                <div class="col-2">
                                                    <div class="weather-day vertical-align">
                                                        <div class="vertical-align-middle fs-16">
                                                            <div class="mb-10">سه شنبه</div>
                                                            <i class="wi wi-day-sunny fs-24 mb-10"></i>
                                                ...
                                                <div class="col-2">
                                                    <div class="weather-day vertical-align">
                                                        <div class="vertical-align-middle fs-16">
                                                            <div class="mb-10">چهارشنبه</div>
                                                            <i class="wi wi-cloudy-windy fs-24 mb-10"></i>
                                                ...
                                                <div class="col-2">
                                                    <div class="weather-day vertical-align">
                                                        <div class="vertical-align-middle fs-16">
                                                            <div class="mb-10">جمعه</div>
                                                            <i class="wi wi-day-cloudy fs-24 mb-10"></i>
                                                ...
                                                <div class="col-2">
                                                    <div class="weather-day vertical-align">
                                                        <div class="vertical-align-middle fs-16">
                                                            <div class="mb-10">شنبه</div>
                                                            <i class=" wi wi-solar-eclipse fs-24 mb-10"></i>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box bg-img box-inverse" style="background-image: url(images/gallery/thumb/4.jpg);" data-overlay="5">
                                <div class="box-body">
                                    <div class="p-5">
                                        <h3 class="white">
                                            <span class="fs-30">شهر, </span>کشور
                                        </h3>
                                        <p class="weather-day-date mb-30">
                                            <span class="me-5">دوشنبه</span> May 11, 2017
                                        </p>
                                        ...
                                        <div class="row no-space">
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">سه شنبه</div>
                                                    <i class=" wi wi-day-sunny-overcast fs-30 mb-10"></i>
                                                    <div>24°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">چهارشنبه</div>
                                                    <i class="wi wi-day-sleet-storm fs-30 mb-10"></i>
                                                    <div>21°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">پنج شنبه</div>
                                                    <i class="wi wi-day-sunny fs-30 mb-10"></i>
                                                    <div>25°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">جمعه</div>
                                                    <i class=" wi wi-day-rain-wind fs-30 mb-10"></i>
                                                    <div>20°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">شنبه</div>
                                                    <i class="wi wi-day-rain-mix fs-30 mb-10"></i>
                                                    <div>18°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-2">
                                                <div>
                                                    <div class="mb-10">یکشنبه</div>
                                                    <i class=" wi wi-day-cloudy fs-30 mb-10"></i>
                                                    <div>14°
                                                        <span class="fs-12">C</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box text-center bg-img box-inverse" style="background-image: url(images/gallery/thumb/4.jpg);" data-overlay="5">
                                ...
                                <div class="box-footer bg-primary">
                                    <div class="p-15">
                                        <span class="fs-20">شهر, </span>
                                        <span class="fs-18">کشور</span>
                                        <div>
                                            <span class="me-5">امروز,</span> 05:12 PM
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border bg-primary">
                                    <h3 class="box-title"><i class="ion-location"></i> شهر</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="fs-14">جمعه 20/5</div>
                                            <div class="fs-40">
                                                27°
                                                <span class="fs-30">C</span>
                                            </div>
                                        ...
                                        <div class="col-6 text-end">
                                            <i class="wi wi-day-snow fs-50"></i>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <i class=" wi wi-solar-eclipse fs-40"></i>
                                        </div>
                                        <div class="col-6 text-end">
                                ...
                                <div class="box-footer bg-success">
                                    <h4 class="m-0"><i class="ion-location"></i> شهر</h4>
                                </div>
                            </div>
                            <!-- /.box -->
                        </div>
                            ...
                            <div class="box bg-img box-inverse" style="background-image: url(images/gallery/thumb/9.jpg);" data-overlay="5">
                                <div class="box-body">
                                    <div class="row py-30">
                                        ...
                                        <div class="col-6 text-end">
                                            <i class=" wi wi-day-storm-showers fs-40"></i>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                            ...
                            <div class="box box-inverse bg-img" style="background-image: url(images/gallery/thumb/7.jpg);" data-overlay="5">
                                <div class="box-body">
                                    <div class="p-5">
                                        ...
                                        <p class="fs-20">شهر, کشور</p>
                                        <p class="fs-20">
                                            <i class="wi wi-day-snow me-15 fs-40"></i>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box box-inverse bg-img" style="background-image: url(images/gallery/thumb/19.jpg);" data-overlay="5">
                                <div class="box-body py-50">
                                    <div class="text-center">
                                        <div class="p-10">
                                            <i class="wi wi-day-storm-showers vertical-align-middle fs-50"></i>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-6">
                                                <i class="wi wi-solar-eclipse me-5"></i> 8 Kmph
                                            </div>
                                            <div class="col-6">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="box text-center bg-info">
                                ...
                                <div class="box-footer with-border bg-info">
                                    <div class="row no-space">
                                        <div class="col-6">
                                            <i class="wi wi-day-sprinkle me-10"></i>
                                            <span class="fw-bold">8</span>Kmph
                                        </div>
                                        <div class="col-6">
                                            <i class="wi wi-moonset me-10"></i>
    ...
    <script src="src\js\pages\weather.js"></script>
