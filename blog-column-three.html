                        ...
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-column-three.html" class="nav-link active">Blog Column Three</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news">
                        ...
                        <div class="news-content">
                            ...
                            <ul class="lessons">
                                <li>By: <a href="single-blog.html">Admin</a></li>
                                <li class="float">Posted aon 07/07/2020</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-news">
                        <a href="single-blog.html">
                            <img src="assets\img\news-img\news-img-15.jpg" alt="Image">
                        </a>
                        <div class="news-content">
                            <span class="tag">Career Advice</span>
                            <a href="single-blog.html">
                                <h3>HR and payroll administrator course</h3>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                labore dolore magna aliqua</p>
                            <ul class="lessons">
                                <li>By: <a href="single-blog.html">Admin</a></li>
                                <li class="float">Posted aon 06/07/2020</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                    <div class="single-news">
                        ...
                        <div class="news-content">
                            ...
                            <ul class="lessons">
                                <li>By: <a href="single-blog.html">Admin</a></li>
                                <li class="float">Posted aon 05/07/2020</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area">
                        ...
                        <a href="blog-column-three.html" class="page-numbers">2</a>
                        <a href="blog-column-three.html" class="page-numbers">3</a>
                        <a href="blog-column-three.html" class="page-numbers">4</a>
                        <a href="blog-column-three.html" class="next page-numbers">
                            <i class="bx bx-chevron-right"></i>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="address">
                            ...
                            <li>
                                ...
                                <a href="/cdn-cgi/l/email-protection#127a777e7e7d527776677d7c3c717d7f"><span
                                        class="__cf_email__"
                                        data-cfemail="86eee3eaeae9c6e3e2f3e9e8a8e5e9eb">[email&#160;protected]</span></a>
                                <a href="/cdn-cgi/l/email-protection#1e6e6b7c72777d5e7b7a6b7170307d7173"><span
                                        class="__cf_email__"
                                        data-cfemail="176762757b7e745772736278793974787a">[email&#160;protected]</span></a>
                            </li>
                            <li>
