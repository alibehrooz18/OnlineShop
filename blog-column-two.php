                        ...
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-column-two.php" class="nav-link active">Blog Column Two</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
            <div class="page-title-content">
                ...
                <ul>
                    ...
                    <li class="active">Blog column two</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="single-news">
                                    ...
                                    <div class="news-content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor incididunt labore dolore magna aliqua</p>
                                        <ul class="lessons">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="pagination-area">
                                    ...
                                    <a href="blog-column-two.php" class="page-numbers">2</a>
                                    <a href="blog-column-two.php" class="page-numbers">3</a>
                                    <a href="blog-column-two.php" class="page-numbers">4</a>
                                    <a href="blog-column-two.php" class="next page-numbers">
                                        <i class="bx bx-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="address">
                            ...
                            <li>
                                ...
                                <a href="/cdn-cgi/l/email-protection#167e737a7a795673726379783875797b"><span
                                        class="__cf_email__"
                                        data-cfemail="86eee3eaeae9c6e3e2f3e9e8a8e5e9eb">[email&#160;protected]</span></a>
                                <a href="/cdn-cgi/l/email-protection#a4d4d1c6c8cdc7e4c1c0d1cbca8ac7cbc9"><span
                                        class="__cf_email__"
                                        data-cfemail="d7a7a2b5bbbeb497b2b3a2b8b9f9b4b8ba">[email&#160;protected]</span></a>
                            </li>
                            <li>
