                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.html">Your heart is the sea</a>
                                            </td>
                                            <td class="product-price">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.html">Hardcober mockup</a>
                                            </td>
                                            <td class="product-price">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.html">Dior</a>
                                            </td>
                                            <td class="product-price">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-sm-7">
                                        <div class="form-group mb-0">
                                            ...
                                            <a href="cart.html" class="default-btn">Apply coupon</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-5 text-right">
                                        <a href="cart.html" class="default-btn update">
                                            Update cart
                                        </a>
                                    </div>
                                </div>
