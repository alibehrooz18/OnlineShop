                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="single-event.html" class="nav-link active">Single Event</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row">
                    ...
                    <div class="single-event-content">
                        ...
                        <ul class="post-details">
                            <li>
                                ...
                                By <a href="single-event.html">Admin</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="events.html">2 Comments</a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4">
                    <div class="account-wrap">
                        ...
                        <p>You must <a href="log-in.html">login</a> before register event.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="address">
                            ...
                            <li>
                                ...
                                <a href="/cdn-cgi/l/email-protection#355d5059595a755051405a5b1b565a58"><span
                                        class="__cf_email__"
                                        data-cfemail="9df5f8f1f1f2ddf8f9e8f2f3b3fef2f0">[email&#160;protected]</span></a>
                                <a href="/cdn-cgi/l/email-protection#0e7e7b6c62676d4e6b6a7b6160206d6163"><span
                                        class="__cf_email__"
                                        data-cfemail="b3c3c6d1dfdad0f3d6d7c6dcdd9dd0dcde">[email&#160;protected]</span></a>
                            </li>
                            <li>
